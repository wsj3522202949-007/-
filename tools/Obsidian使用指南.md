...
1. **三件事别混**：找单一工具用**搜索**，找一类工具用 **Dataview 查询**，找关系用**反向链接**。全局图谱只在「探索未知关联」时开，平时关着——3574 节点全开图谱是噪音。
...
5. **模板 + 单章作战卡是写作主循环**：开写前翻 `../methods/模板/00_开写启动器.md`，每章填 `01_单章作战卡.md`，前 3 章跑 `02_前3章签约体检表.md`——情报网（本库）只负责「找外部武器」，写作主循环在方法论里。
...
仓库笔记共 **3574** 篇，加上素材/方法论约 4000+ 节点。图谱全开会比较密：
...
- 真实落盘 README：**3574** 篇（来自 GitHub 上真实存在的仓库）。
