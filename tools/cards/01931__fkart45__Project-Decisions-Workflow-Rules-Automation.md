...
title: Project-Decisions-Workflow-Rules-Automation
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/fkart45/project-decisions-workflow-rules-automation
created: 2026-07-18
updated: 2026-07-18
no: 1931
category: 二、网文 / 长篇 AI 写作系统 库
repo: fkart45/Project-Decisions-Workflow-Rules-Automation
stars: 0
url: https://github.com/fkart45/project-decisions-workflow-rules-automation
tier: "C"
...
# fkart45/Project-Decisions-Workflow-Rules-Automation

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/fkart45/project-decisions-workflow-rules-automation
- **Stars**：0
- **语言**：Python
- **License**：None
- **Topics**：api-integrations, automation, business-rules, decisions, no-code, process-automation, rules-engine, workflow
- **GitHub 描述**：A collection of projects built using the Decisions.com platform, leveraging its no-code workflow, automation, and rules engine to solve various business challenges. These projects highlight how to automate processes, manage data, and streamline operations without writing code.
- **本地描述**：A collection of projects built using the Decisions.com platform, leveraging its no-code workflow, automation, and rules engine to solve various business challenges. These projects highlight how to automate processes, manage data, and streamline operations without writing code.
- **拉取时间**：2026-07-23 23:35:16
...
1. **[Project 1 - Party Planning Approval Workflow -v9](https://github.com/fkart45/Project-Decisions-Workflow-Rules-Automation/blob/main//project1-folder)**
...
2. **[Project 2 - Rules - Create Excel - QR Code Workflow -v9](https://github.com/fkart45/Project-Decisions-Workflow-Rules-Automation/blob/main//project1-folder)**
...
3. **[Project 3 - CRUD-Create_Text-Dashboards-SFTP Workflow -v9](https://github.com/fkart45/Project-Decisions-Workflow-Rules-Automation/blob/main//project1-folder)**
...
4. **[Project 4 - AWS-S3-Lambda-APIGateway Workflow -v9](https://github.com/fkart45/Project-Decisions-Workflow-Rules-Automation/blob/main//project1-folder)**
