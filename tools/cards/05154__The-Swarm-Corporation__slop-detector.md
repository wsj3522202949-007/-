...
![slop detector](https://github.com/The-Swarm-Corporation/slop-detector/blob/main/logo.png)
...
> **Full documentation:** [DOCS.md](https://github.com/The-Swarm-Corporation/slop-detector/blob/main/DOCS.md) — covers architecture, local testing, threshold tuning, troubleshooting, security considerations, and complete configuration reference.
...
See [DOCS.md](https://github.com/The-Swarm-Corporation/slop-detector/blob/main/DOCS.md) for the complete documentation including architecture deep dive, local testing instructions, threshold tuning guide, troubleshooting, and security considerations.
