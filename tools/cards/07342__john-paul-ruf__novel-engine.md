...
![Your manuscript, front and center](https://github.com/john-paul-ruf/novel-engine/blob/main/screenshots/Screenshot%202026-07-08%20at%203.21.28%E2%80%AFAM.png)
...
That Terminal step is the most technical thing you'll ever have to do — the app handles everything else. (More backends — llama-server and any OpenAI-compatible endpoint — are covered in the [technical guide](https://github.com/john-paul-ruf/novel-engine/blob/main/TECHNICAL.md).)
...
You'll need [Node.js](https://nodejs.org) 18+ installed first. Full build and packaging instructions are in the [technical guide](https://github.com/john-paul-ruf/novel-engine/blob/main/TECHNICAL.md).
...
*(The full feature reference, with all the machinery underneath, lives in the [technical guide](https://github.com/john-paul-ruf/novel-engine/blob/main/TECHNICAL.md).)*
...
| | |
|---|---|
| ![Library](https://github.com/john-paul-ruf/novel-engine/blob/main/screenshots/Screenshot%202026-07-08%20at%203.20.46%E2%80%AFAM.png) | ![The Workspace](https://github.com/john-paul-ruf/novel-engine/blob/main/screenshots/Screenshot%202026-07-08%20at%203.20.55%E2%80%AFAM.png) |
| *Library — your bookshelf, with progress per book* | *Workspace — the pipeline on the left, your editor in chat* |
| ![Manuscript Editor](https://github.com/john-paul-ruf/novel-engine/blob/main/screenshots/Screenshot%202026-07-08%20at%203.21.31%E2%80%AFAM.png) | ![Command Palette](https://github.com/john-paul-ruf/novel-engine/blob/main/screenshots/Screenshot%202026-07-08%20at%203.21.12%E2%80%AFAM.png) |
| *Editing Verity's draft yourself — every change tracked* | *Command palette — jump anywhere with ⌘K* |
| ![Providers](https://github.com/john-paul-ruf/novel-engine/blob/main/screenshots/Screenshot%202026-07-08%20at%203.21.58%E2%80%AFAM.png) | ![Model Selection](https://github.com/john-paul-ruf/novel-engine/blob/main/screenshots/Screenshot%202026-07-08%20at%203.22.03%E2%80%AFAM.png) |
...
- **[TECHNICAL.md](https://github.com/john-paul-ruf/novel-engine/blob/main/TECHNICAL.md)** — architecture, tech stack, project structure, AI backend internals, database schema, building installers
- **[docs/architecture/](https://github.com/john-paul-ruf/novel-engine/blob/main/docs/architecture/ARCHITECTURE.md)** — layer-by-layer architecture documentation
- **[CHANGELOG.md](https://github.com/john-paul-ruf/novel-engine/blob/main/CHANGELOG.md)** and **[RELEASE_NOTES.md](https://github.com/john-paul-ruf/novel-engine/blob/main/RELEASE_NOTES.md)** — what's changed

Novel Engine is built with Electron, React, and TypeScript in a clean five-layer architecture, and it's open source under [AGPL-3.0](https://github.com/john-paul-ruf/novel-engine/blob/main/LICENSE) — contributions and bug reports welcome.

---

## License

The application code is licensed under [AGPL-3.0-only](https://github.com/john-paul-ruf/novel-engine/blob/main/LICENSE).
