...
area: 库
status: active
tags: [校对, Swift, 协议传染, 需API密钥, 英文文档, 改稿润色]
title: WritingTools
summary: 错别字/语法/风格校对
...
- **链接**：https://github.com/thejaytea/writingtools
- **Stars**：2369
- **语言**：Swift
- **License**：GPL-3.0
- **Topics**：ai, artificial-intelligence, gemini, grammar-checker, largelanguagemodel, llm, writing-tool
- **GitHub 描述**：The world's smartest system-wide grammar assistant; a better version of the Apple Intelligence Writing Tools. Works on Windows, Linux, & macOS, with the free Gemini API, local LLMs, & more.
- **本地描述**：The world's smartest system-wide grammar assistant; a better version of the Apple Intelligence Writing Tools. Works on Windows, Linux, & macOS, with the free Gemini API, local LLMs, & more.
- **拉取时间**：2026-07-23 23:18:46
