...
source: https://github.com/karthik-unni/cognicore
created: 2026-07-18
updated: 2026-07-18
no: 4351
category: 四、长篇一致性 / RAG / 故事圣经 库
repo: Karthik-Unni/CogniCore
stars: 0
url: https://github.com/karthik-unni/cognicore
tier: "C"
...
content_hash: 4a546953bc90c795
  - methods/模板库.md
---

# Karthik-Unni/CogniCore

- **分类**：四、长篇一致性 / RAG / 故事圣经 库
- **链接**：https://github.com/karthik-unni/cognicore
- **Stars**：0
- **语言**：Python
- **License**：None
- **Topics**：agentic-ai, ai-framework, autonomous-agents, memory, multi-agent, rag
- **GitHub 描述**：CogniCore is a multi-agent character intelligence framework for building persistent AI characters with memory, emotions, relationships, planning, and autonomous behavior. Powered by LLMs, RAG, and social simulation systems, CogniCore enables developers to create believable virtual characters that evolve through interaction rather than script.
- **本地描述**：CogniCore is a multi-agent character intelligence framework for building persistent AI characters with memory, emotions, relationships, planning, and autonomous behavior. Powered by LLMs, RAG, and social simulation systems, CogniCore enables developers to create believable virtual characters that evolve through interaction rather than script.
- **拉取时间**：2026-07-25 17:43:54
