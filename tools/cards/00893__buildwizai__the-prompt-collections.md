...
title: the-prompt-collections
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/buildwizai/the-prompt-collections
created: 2026-07-18
updated: 2026-07-18
no: 893
category: 二、网文 / 长篇 AI 写作系统 库
repo: buildwizai/the-prompt-collections
stars: 8
url: https://github.com/buildwizai/the-prompt-collections
tier: "B"
...
# buildwizai/the-prompt-collections

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/buildwizai/the-prompt-collections
- **Stars**：8
- **语言**：JavaScript
- **License**：MIT
- **Topics**：ai, prompt-enginer, prompts
- **GitHub 描述**：The Prompt Collection is a curated repository of diverse prompts designed for various purposes, such as writing, interviews, and more. Each category and subcategory includes a set of prompts along with corresponding system prompts to provide context and enhance relevance
- **本地描述**：The Prompt Collection is a curated repository of diverse prompts designed for various purposes, such as writing, interviews, and more. Each category and subcategory includes a set of prompts along with corresponding system prompts to provide context and enhance relevance
- **拉取时间**：2026-07-23 23:05:05
