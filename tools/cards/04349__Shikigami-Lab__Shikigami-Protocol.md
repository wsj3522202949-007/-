...
[Quick start](#quick-start) · [Example personas](#example-personas) · [Features](#features) · [Discussions](https://github.com/Shikigami-Lab/Shikigami-Protocol/discussions) · [License](#license-community) · [Documentation](#documentation) · [Changelog](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/CHANGELOG.md)
...
![Shikigami Protocol UI: Multiple themes — light, dark, and more](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/assets/readme/ui-themes.png)
...
> For complex issues see the [full setup guide](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/docs/SETUP_FIRST_RUN.en.md).
...
![Shikigami Protocol Core Architecture (Whiteboard Style)](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/assets/readme/shikigami_architecture_excalidraw.png)
...
![Shikigami Protocol Emotion & Affinity: energy, emotion layers, and relationship tiers](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/assets/readme/emotion-affinity.png)
...
To author your own persona, use `profiles/example_luna.json` or `profiles/example_mochi.json` as a template. Full field reference: [profile_prompts.en.md](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/docs/profile_prompts.en.md).
...
| Doc | Purpose |
|---|---|
| [GETTING_STARTED.en.md](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/docs/GETTING_STARTED.en.md) / [.zh.md](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/docs/GETTING_STARTED.zh.md) | **Start here** |
| [ARCHITECTURE_REFERENCE.en.md](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/docs/ARCHITECTURE_REFERENCE.en.md) / [.zh.md](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/docs/ARCHITECTURE_REFERENCE.zh.md) | Architecture & module boundaries |
| [SETUP_FIRST_RUN.en.md](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/docs/SETUP_FIRST_RUN.en.md) / [.zh.md](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/docs/SETUP_FIRST_RUN.zh.md) | Install, init, Docker, troubleshooting |
| [profile_prompts.en.md](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/docs/profile_prompts.en.md) / [.zh.md](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/docs/profile_prompts.zh.md) | Persona JSON field reference |
...
This repository is licensed under [**AGPL-3.0**](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/LICENSE).
...
- **Contributing**: PRs welcome — demo GIFs/screenshots, translations, bug reports (OS + Python version + logs). Read [CONTRIBUTING.md](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/CONTRIBUTING.md) first and sign off each commit with `git commit -s` per [DCO 1.1](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/DCO.md).
- **Security**: Report vulnerabilities privately; see [SECURITY.md](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/SECURITY.md).

*This section is a summary, not legal advice; the [LICENSE](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/LICENSE) and [DCO](https://github.com/Shikigami-Lab/Shikigami-Protocol/blob/main/DCO.md) texts prevail.*
