...
Deterministic AST analysis, a transparent scoring formula, and a hard line on false positives. The full write-up (architecture, every detector's heuristics, the drift engine, the score math, and how it was calibrated against real repos) is in [docs/TECHNICAL.md](https://github.com/Aaryan-9/ai-slop-remover/blob/main/docs/TECHNICAL.md).

## License

[MIT](https://github.com/Aaryan-9/ai-slop-remover/blob/main/LICENSE)
