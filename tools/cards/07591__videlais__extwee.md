...
source: https://github.com/videlais/extwee
created: 2026-07-18
updated: 2026-07-18
no: 7591
category: 画龙补充 / 扩容入库 — 补充源
repo: videlais/extwee
stars: 42
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/videlais/extwee
- **Stars**：42
- **语言**：HTML
- **License**：MIT
- **Topics**：html, json, twee, twine, twine-1, twine-2, tws
- **GitHub 描述**：Extwee is a collection of parsing and compilation functionality supporting historic and current Twine formats
- **本地描述**：extwee
- **拉取时间**：2026-07-25 19:26:35
...
|----------------------------------------------------------------------------------------------------------------------------------|-------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------related:
  - methods/QUICK_START.md
---|
| [Twine 1 HTML (2006 - 2015)](https://github.com/videlais/extwee/blob/master/https://github.com/iftechfoundation/twine-specs/blob/master/twine-1-htmloutput-doc.md)          | Yes   | Partial support. Twine 1 HTML can be produced, but the  `StorySettings`  optional passage introduced in Twine 1.4.0 requires external libraries like jQuery not included with Extwee. |
| [Twine 1 TWS (2009 - 2015)](https://github.com/videlais/extwee/blob/master/https://github.com/iftechfoundation/twine-specs/blob/master/twine-1-twsoutput.md)                | Yes   | Extwee does not support TWS (Python pickle) output because no current version of Twine or other story compilation tool produces this historical format.                                                |
| [Twine 2 HTML (2015 - Present)](https://github.com/videlais/extwee/blob/master/https://github.com/iftechfoundation/twine-specs/blob/master/twine-2-htmloutput-spec.md)      | Yes   | Yes                                                                                                                                                                                   |
| [Twine 2 Archive HTML (2015 - Present)](https://github.com/videlais/extwee/blob/master/https://github.com/iftechfoundation/twine-specs/blob/master/twine-2-archive-spec.md) | Yes   | Yes                                                                                                                                                                                   |
| [Twee 3 (2021 - Present)](https://github.com/videlais/extwee/blob/master/https://github.com/iftechfoundation/twine-specs/blob/master/twee-3-specification.md)               | Yes   | Yes                                                                                                                                                                                   |
| [Twine 2 JSON (2023 - Present)](https://github.com/videlais/extwee/blob/master/https://github.com/iftechfoundation/twine-specs/blob/master/twine-2-jsonoutput-doc.md)       | Yes   | Yes                                                                                                                                                                                   |
| [Twine 2 Story Format (2015 - Present)](https://github.com/videlais/extwee/blob/master/https://github.com/iftechfoundation/twine-specs/blob/master/twine-2-storyformats-spec.md)       | Yes   | Yes                                                                                                                                                                                   |
...
Consult the possible options in its [dedicated file](https://github.com/videlais/extwee/blob/master/extwee.config.md).
...
Contributions are welcome! Please read our [Contributing Guide](https://github.com/videlais/extwee/blob/master/CONTRIBUTING.md) for details on:
...
See also:
- [Code of Conduct](https://github.com/videlais/extwee/blob/master/CODE_OF_CONDUCT.md)
- [Changelog](https://github.com/videlais/extwee/blob/master/CHANGELOG.md)
- [Security Policy](https://github.com/videlais/extwee/blob/master/SECURITY.md)
