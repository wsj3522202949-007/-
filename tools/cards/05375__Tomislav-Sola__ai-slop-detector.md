...
![Example slop comment as posted on a smoke-test PR](https://github.com/Tomislav-Sola/ai-slop-detector/blob/main/docs/images/slop_comment.png)
...
See [CONTRIBUTING.md](https://github.com/Tomislav-Sola/ai-slop-detector/blob/main/CONTRIBUTING.md) for local setup, how to run the eval, how to propose a new golden-set fixture, and the conventional-commit style this repo uses.

## License

MIT — see [LICENSE](https://github.com/Tomislav-Sola/ai-slop-detector/blob/main/LICENSE).
