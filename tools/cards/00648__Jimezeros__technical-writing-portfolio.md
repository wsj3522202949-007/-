...
summary: 提示词/写作工作流
source: https://github.com/jimezeros/technical-writing-portfolio
created: 2026-07-18
updated: 2026-07-18
no: 648
category: 二、网文 / 长篇 AI 写作系统 库
repo: Jimezeros/technical-writing-portfolio
stars: 0
url: https://github.com/jimezeros/technical-writing-portfolio
tier: "C"
use_case: "提示词/写作工作流"
pitfalls:
...
# Jimezeros/technical-writing-portfolio

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/jimezeros/technical-writing-portfolio
- **Stars**：0
- **语言**：None
- **License**：None
- **Topics**：—
- **GitHub 描述**：Selected samples of Technical Writing, AI Prompt Engineering (RLHF), and Healthcare Content Strategy. Includes patient education guides and technical documentation.
- **本地描述**：Selected samples of Technical Writing, AI Prompt Engineering (RLHF), and Healthcare Content Strategy. Includes patient education guides and technical documentation.
- **拉取时间**：2026-07-23 22:57:57
...
| **📘 Patient Protocol: Metformin Guide**<br>*(Health Literacy / Helpfulness)*<br>Translating complex SPCs into safe, accessible language. Demonstrates the "Helpfulness" metric in RLHF training for patient-facing chatbots. | **Health Literacy**<br>Simplification<br>Regulatory Compliance | [📄 View PDF](https://github.com/Jimezeros/technical-writing-portfolio/blob/main/patient-education-metformin.pdf) |
| **microscope: Mechanism of Action (Statins)**<br>*(Ground Truth Verification)*<br>Deep-dive into biochemical pathways to explain side effects. Shows the ability to research and verify "Ground Truth" data for training models. | **Fact-Checking**<br>Research<br>Biochemistry SME | [📄 View PDF](https://github.com/Jimezeros/technical-writing-portfolio/blob/main/biochemical-mechanism-statins.pdf) |
