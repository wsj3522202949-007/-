...
area: 库
status: active
tags: [提示词, 大纲规划, Python, 协议传染, 需API密钥, 中文友好]
title: llmai-writer
summary: 搭大纲/分卷/节拍
source: https://github.com/whatruhuh/llmai-writer
created: 2026-07-18
updated: 2026-07-18
no: 7605
category: 画龙补充 / 扩容入库 — 补充源
repo: whatruhuh/llmai-writer
stars: 208
url: https://github.com/whatruhuh/llmai-writer
tier: "S"
use_case: "搭大纲/分卷/节拍"
pitfalls:
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/whatruhuh/llmai-writer
- **Stars**：208
- **语言**：Python
- **License**：AGPL-3.0
- **Topics**：—
...
[MIT License](https://github.com/whatruhuh/llmai-writer/blob/main/LICENSE)
...
**⚠️ 重要提示：** 本项目的 [`LICENSE`](https://github.com/whatruhuh/llmai-writer/blob/main/LICENSE) 文件中包含了在 AGPL-3.0 基础之上附加的 **补充条款**。这些补充条款对代码的商业使用等方面做出了额外约定。请务必在复制、使用、修改或分发本项目代码前，仔细阅读并理解 [`LICENSE`](https://github.com/whatruhuh/llmai-writer/blob/main/LICENSE) 文件中的全部内容，特别是补充条款部分，以确保您的行为符合所有授权要求。
