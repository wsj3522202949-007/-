...
area: 库
status: active
tags: [校对, Python, 协议传染, 本地优先, 英文文档, 改稿润色, 本地写作]
title: TypePerfect
summary: 错别字/语法/风格校对
source: https://github.com/clauderobbincr/typeperfect
created: 2026-07-18
updated: 2026-07-18
no: 152
category: 二、网文 / 长篇 AI 写作系统 库
repo: ClaudeRobbinCR/TypePerfect
stars: 1
url: https://github.com/clauderobbincr/typeperfect
tier: "B"
...
content_hash: 7a5066f1da1c157b
  - methods/最强写作方法论_全球最强综合版.md
---

# ClaudeRobbinCR/TypePerfect

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/clauderobbincr/typeperfect
- **Stars**：1
- **语言**：Python
- **License**：GPL-3.0
- **Topics**：—
- **GitHub 描述**：TYPERFECT is a free, open-source, and completely offline writing assistant that helps you craft clear, error-free text with absolute confidence in your privacy.  In an age where every keystroke can be logged and analyzed, TYPERFECT offers a powerful alternative to cloud-based grammar checkers like Grammarly and ProWritingAid. 
- **本地描述**：TYPERFECT is a free, open-source, and completely offline writing assistant that helps you craft clear, error-free text with absolute confidence in your privacy.  In an age where every keystroke can be logged and analyzed, TYPERFECT offers a powerful alternative to cloud-based grammar checkers like Grammarly and ProWritingAid.
- **拉取时间**：2026-07-23 22:43:26

---

# TYPERFECT: Your Private, Offline Grammar and Style Checker

![TYPERFECT Logo](https://github.com/ClaudeRobbinCR/TypePerfect/blob/main/static/logo.svg) <!-- Placeholder for the new logo -->
