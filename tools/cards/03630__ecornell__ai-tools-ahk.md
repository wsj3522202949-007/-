...
area: 库
status: active
tags: [AutoHotkey, 协议宽松, 需API密钥, 英文文档, 多Agent]
title: ai-tools-ahk
summary: 提示词/工作流模板
source: https://github.com/ecornell/ai-tools-ahk
created: 2026-07-18
updated: 2026-07-18
no: 3630
category: 十六、提示词库 / 写作 Agent 工作流 库
repo: ecornell/ai-tools-ahk
stars: 90
url: https://github.com/ecornell/ai-tools-ahk
tier: "A"
use_case: "提示词/工作流模板"
pitfalls:
...
- **分类**：十六、提示词库 / 写作 Agent 工作流 库
- **链接**：https://github.com/ecornell/ai-tools-ahk
- **Stars**：90
- **语言**：AutoHotkey
- **License**：MIT
- **Topics**：ai, autohotkey, autohotkey-v2, azure-openai, azure-openai-api, chatgpt, gemini, gemini-ai, gemini-api, gpt, gpt-4, gpt4, gpt4o, openai, script, spicy-autocomplete, windows, writing
- **GitHub 描述**：AI Tools - AutoHotkey - Enable global hotkeys to run custom OpenAI and Gemini prompts on text in any window.
- **本地描述**：AI Tools - AutoHotkey - Enable global hotkeys to run custom OpenAI and Gemini prompts on text in any window.
- **拉取时间**：2026-07-23 23:57:03
