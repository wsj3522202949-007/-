...
See the [Maintainer Guide](https://github.com/wolffcatskyy/ai-ready-issues/blob/main/guide/MAINTAINER_GUIDE.md) for detailed guidance on when to use (and not use) this standard.
...
related:
  ...
  - methods/最强写作方法论_全球最强综合版.md
---|
| [templates/CONTRIBUTING.md](https://github.com/wolffcatskyy/ai-ready-issues/blob/main/templates/CONTRIBUTING.md) | Drop-in CONTRIBUTING.md with AI contribution guidelines |
| [.github/ISSUE_TEMPLATE/ai-ready-bug.md](https://github.com/wolffcatskyy/ai-ready-issues/blob/main/.github/ISSUE_TEMPLATE/ai-ready-bug.md) | Bug report formatted for AI consumption |
| [.github/ISSUE_TEMPLATE/ai-ready-feature.md](https://github.com/wolffcatskyy/ai-ready-issues/blob/main/.github/ISSUE_TEMPLATE/ai-ready-feature.md) | Feature request formatted for AI consumption |
| [templates/PR_TEMPLATE.md](https://github.com/wolffcatskyy/ai-ready-issues/blob/main/templates/PR_TEMPLATE.md) | Pull request template with AI disclosure section |
| [guide/MAINTAINER_GUIDE.md](https://github.com/wolffcatskyy/ai-ready-issues/blob/main/guide/MAINTAINER_GUIDE.md) | How to write effective AI-ready issues |
| [guide/CONTRIBUTOR_GUIDE.md](https://github.com/wolffcatskyy/ai-ready-issues/blob/main/guide/CONTRIBUTOR_GUIDE.md) | How to use AI responsibly for contributions |
