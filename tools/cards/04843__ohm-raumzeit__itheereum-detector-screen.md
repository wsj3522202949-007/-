...
title: itheereum-detector-screen
summary: 投稿前给正文降 AI 检测痕迹、改自然语气
source: https://github.com/ohm-raumzeit/itheereum-detector-screen
created: 2026-07-18
updated: 2026-07-18
no: 4843
category: 一、去 AI 味 / Humanizer 库
repo: ohm-raumzeit/itheereum-detector-screen
stars: 0
url: https://github.com/ohm-raumzeit/itheereum-detector-screen
tier: "C"
...
# ohm-raumzeit/itheereum-detector-screen

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/ohm-raumzeit/itheereum-detector-screen
- **Stars**：0
- **语言**：JavaScript
- **License**：None
- **Topics**：ai, archaeology, art, artefacts, detection, image, pdf, screen, screenshot, text
- **GitHub 描述**：AI Image, Screenshot, PDF, anything Detector Open Source Project (vormals KI-Bild-Detektor)
- **本地描述**：AI Image, Screenshot, PDF, anything Detector Open Source Project (vormals KI-Bild-Detektor)
- **拉取时间**：2026-07-25 17:56:30
