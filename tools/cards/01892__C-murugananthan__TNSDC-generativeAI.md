...
title: TNSDC-generativeAI
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/c-murugananthan/tnsdc-generativeai
created: 2026-07-18
updated: 2026-07-18
no: 1892
category: 二、网文 / 长篇 AI 写作系统 库
repo: C-murugananthan/TNSDC-generativeAI
stars: 0
url: https://github.com/c-murugananthan/tnsdc-generativeai
tier: "C"
...
content_hash: 67e4672c0b07f5d3
  - methods/最强写作方法论_全球最强综合版.md
---

# C-murugananthan/TNSDC-generativeAI

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/c-murugananthan/tnsdc-generativeai
- **Stars**：0
- **语言**：Jupyter Notebook
- **License**：None
- **Topics**：—
- **GitHub 描述**：Story Craft: AI-Powered Text-to-Story Generator
- **本地描述**：Story Craft: AI-Powered Text-to-Story Generator
- **拉取时间**：2026-07-23 23:34:08
