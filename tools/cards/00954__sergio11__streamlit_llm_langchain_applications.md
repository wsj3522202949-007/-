...
area: 库
status: active
tags: [多Agent, Python, 协议传染, 本地优先, 英文文档, 本地写作]
title: streamlit_llm_langchain_applications
summary: 多 Agent 协作自动产文
source: https://github.com/sergio11/streamlit_llm_langchain_applications
created: 2026-07-18
updated: 2026-07-18
no: 954
category: 二、网文 / 长篇 AI 写作系统 库
repo: sergio11/streamlit_llm_langchain_applications
stars: 3
url: https://github.com/sergio11/streamlit_llm_langchain_applications
tier: "B"
...
content_hash: 9c09938379f49dfc
  - methods/最强写作方法论_全球最强综合版.md
---

# sergio11/streamlit_llm_langchain_applications

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/sergio11/streamlit_llm_langchain_applications
- **Stars**：3
- **语言**：Python
- **License**：GPL-3.0
- **Topics**：chromadb, faiss, faiss-vector-database, groq-ai, groq-api, langchain, langchain-python, llama3, llm, llm-framework, llm-inference, llms, mistral-7b, streamlit, tavily
- **GitHub 描述**：Explore innovative Language Model applications (LLMs) with Streamlit-based Proof of Concepts (POCs) 🚀. These demos showcase open-source models using Groq for cloud-based inference and LangChain for efficient orchestration 🌐. From writing assistants to blog post generators, experience AI-driven tools enhancing productivity and creativity 📚💡.
- **本地描述**：Explore innovative Language Model applications (LLMs) with Streamlit-based Proof of Concepts (POCs) 🚀. These demos showcase open-source models using Groq for cloud-based inference and LangChain for efficient orchestration 🌐. From writing assistants to blog post generators, experience AI-driven tools enhancing productivity and creativity 📚💡.
- **拉取时间**：2026-07-23 23:06:53
