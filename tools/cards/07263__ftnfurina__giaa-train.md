...
通过 `nvitop` 查看 CUDA 版本, 将 [pyproject.toml](https://github.com/ftnfurina/giaa-train/blob/main/pyproject.toml) 中的 `paddlepaddle-gpu` `url` 改为对应版本的链接。
