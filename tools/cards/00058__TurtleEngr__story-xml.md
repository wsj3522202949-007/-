...
source: https://github.com/turtleengr/story-xml
created: 2026-07-18
updated: 2026-07-18
no: 58
category: 二、网文 / 长篇 AI 写作系统 库
repo: TurtleEngr/story-xml
stars: 0
url: https://github.com/turtleengr/story-xml
tier: "C"
...
- **链接**：https://github.com/turtleengr/story-xml
- **Stars**：0
- **语言**：HTML
- **License**：GPL-2.0
- **Topics**：—
- **GitHub 描述**：story-xml is an xml based tool for authors writing fiction. It supports structured writing and formatting from beginning to end.
- **本地描述**：story-xml is an xml based tool for authors writing fiction. It supports structured writing and formatting from beginning to end.
- **拉取时间**：2026-07-23 22:40:33
