...
> See [Docs/LLM_Evaluation_Report.md](https://github.com/Theltn/AICreativityJudge/blob/main/Docs/LLM_Evaluation_Report.md) for the full analysis.
...
See [Docs/Colab_Training_Instructions.md](https://github.com/Theltn/AICreativityJudge/blob/main/Docs/Colab_Training_Instructions.md) for step-by-step instructions. Upload the notebooks from `notebooks/` to Colab and run them there.
...
|---|---|
| [LLM_Evaluation_Report.md](https://github.com/Theltn/AICreativityJudge/blob/main/Docs/LLM_Evaluation_Report.md) | Full analysis of 5 LLMs vs human baseline |
| [Project_Plan.md](https://github.com/Theltn/AICreativityJudge/blob/main/Docs/Project_Plan.md) | Original project roadmap and milestones |
| [Colab_Training_Instructions.md](https://github.com/Theltn/AICreativityJudge/blob/main/Docs/Colab_Training_Instructions.md) | How to train on Google Colab |
| [PC_Training_Setup.md](https://github.com/Theltn/AICreativityJudge/blob/main/Docs/PC_Training_Setup.md) | Windows/NVIDIA setup guide |
