...
area: 库
status: active
tags: [校对, 协议传染, 本地优先, 英文文档, 改稿润色, 本地写作]
title: nima0011
summary: 错别字/语法/风格校对
source: https://github.com/nima0011/nima0011
created: 2026-07-18
updated: 2026-07-18
no: 899
category: 二、网文 / 长篇 AI 写作系统 库
repo: nima0011/nima0011
stars: 24
...
Before you begin:
- This site is powered by Node.js. Check to see if you're on the [version of node we support](https://github.com/nima0011/nima0011/blob/main/contributing/development.md).
- Have you read the [code of conduct](https://github.com/nima0011/nima0011/blob/main/CODE_OF_CONDUCT.md)?
...
![](https://github.com/nima0011/nima0011/blob/main/assets/images/make-contribution.gif)
...
Make your changes to the file(s) you'd like to update. Here are some tips and tricks for [using the docs codebase](#working-in-the-githubdocs-repository).
  - Are you making changes to the application code? You'll need **Node.js v14** to run the site locally. See [contributing/development.md](https://github.com/nima0011/nima0011/blob/main/contributing/development.md).
  - Are you contributing to markdown? We use [GitHub Markdown](https://github.com/nima0011/nima0011/blob/main/contributing/content-markup-reference.md).
...
- [Development](https://github.com/nima0011/nima0011/blob/main//contributing/development.md) - This short guide describes how to get this app running on your local machine.

- [Content markup reference](https://github.com/nima0011/nima0011/blob/main//contributing/content-markup-reference.md) - All of our content is written in GitHub-flavored Markdown, with some additional enhancements.

- [Content style guide for GitHub Docs](https://github.com/nima0011/nima0011/blob/main//contributing/content-style-guide.md) - This guide covers GitHub-specific information about how we style our content and images. It also links to the resources we use for general style guidelines.

- [Reusables](https://github.com/nima0011/nima0011/blob/main//data/reusables/README.md) - We use reusables to help us keep content up to date. Instead of writing the same long string of information in several articles, we create a reusable, then call it from the individual articles.

- [Variables](https://github.com/nima0011/nima0011/blob/main//data/variables/README.md) - We use variables the same way we use reusables. Variables are for short strings of reusable text.

- [Liquid](https://github.com/nima0011/nima0011/blob/main//contributing/liquid-helpers.md) - We use liquid helpers to create different versions of our content.

- [Scripts](https://github.com/nima0011/nima0011/blob/main//script/README.md) - The scripts directory is the home for all of the scripts you can run locally.

- [Tests](https://github.com/nima0011/nima0011/blob/main//tests/README.md) - We use tests to ensure content will render correctly on the site. Tests run automatically in your PR, and sometimes it's also helpful to run them locally.
...
- [ ] Review the entire pull request using the [localization checklist](https://github.com/nima0011/nima0011/blob/main/contributing/localization-checklist.md).
...
1. Bash: Not every Windows developer has a terminal that fully supports Bash, so it's generally preferred to write [scripts](https://github.com/nima0011/nima0011/blob/main//script) in JavaScript instead of Bash.
