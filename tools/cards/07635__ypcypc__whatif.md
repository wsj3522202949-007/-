...
source: https://github.com/ypcypc/whatif
created: 2026-07-18
updated: 2026-07-18
no: 7635
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/ypcypc/whatif
- **Stars**：191
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：输入一本中文小说，提取结构化世界数据，然后以玩家身份进入同一世界。你的每个选择都会改写剧情走向。
- **本地描述**：whatif
- **拉取时间**：2026-07-25 19:28:25
...
欢迎提交 Issue 和 PR，详见 [docs/CONTRIBUTING.md](https://github.com/ypcypc/whatif/blob/main/docs/CONTRIBUTING.md)。  
Issues and pull requests are welcome. See [docs/CONTRIBUTING.md](https://github.com/ypcypc/whatif/blob/main/docs/CONTRIBUTING.md) for details.
...
[MIT License](https://github.com/ypcypc/whatif/blob/main/LICENSE)
