...
title: textshine.ai
summary: 提示词/写作工作流
source: https://github.com/dhavalcode/textshine.ai
created: 2026-07-18
updated: 2026-07-18
no: 756
category: 二、网文 / 长篇 AI 写作系统 库
repo: dhavalCode/textshine.ai
stars: 11
url: https://github.com/dhavalcode/textshine.ai
tier: "B"
use_case: "提示词/写作工作流"
pitfalls:
...
- **链接**：https://github.com/dhavalcode/textshine.ai
- **Stars**：11
- **语言**：TypeScript
- **License**：None
- **Topics**：ai, ai-tools, artificial-intelligence, gemini-api, gemini-pro, genai, genai-usecase, genrative-ai, llm, llm-framework, nextjs, prompt, prompt-engineering, tools, writting
- **GitHub 描述**：AI Powered Writing Tool
- **本地描述**：AI Powered Writing Tool
- **拉取时间**：2026-07-23 23:01:05
...
## TextShine AI - AI Support for your writing 📝
