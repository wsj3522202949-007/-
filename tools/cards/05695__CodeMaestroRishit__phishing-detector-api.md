...
source: https://github.com/codemaestrorishit/phishing-detector-api
created: 2026-07-18
updated: 2026-07-18
no: 5695
category: 一、去 AI 味 / Humanizer 库
repo: CodeMaestroRishit/phishing-detector-api
stars: 1
url: https://github.com/codemaestrorishit/phishing-detector-api
tier: "B"
...
# CodeMaestroRishit/phishing-detector-api

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/codemaestrorishit/phishing-detector-api
- **Stars**：1
- **语言**：Python
- **License**：None
- **Topics**：chrome, cybersec, email, fast, machine-learning, phishing, url
- **GitHub 描述**：Dual-model AI phishing detector that analyzes both email text and URLs using FastAPI, Streamlit, and a Chrome Extension.  Trained on 400K+ samples with 99.35% email and 100% URL accuracy. Dockerized and production-ready.
- **本地描述**：Dual-model AI phishing detector that analyzes both email text and URLs using FastAPI, Streamlit, and a Chrome Extension.  Trained on 400K+ samples with 99.35% email and 100% URL accuracy. Dockerized and production-ready.
- **拉取时间**：2026-07-25 18:28:11
