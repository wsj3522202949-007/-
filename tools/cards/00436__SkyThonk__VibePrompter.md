...
Contributions are welcome! Please read [CONTRIBUTING.md](https://github.com/SkyThonk/VibePrompter/blob/main/CONTRIBUTING.md) before submitting a pull request.

To report a bug, open an issue using the [bug report template](https://github.com/SkyThonk/VibePrompter/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).

By participating you agree to abide by the [Code of Conduct](https://github.com/SkyThonk/VibePrompter/blob/main/CODE_OF_CONDUCT.md).

## Security

To report a security vulnerability, please follow the [Security Policy](https://github.com/SkyThonk/VibePrompter/blob/main/SECURITY.md) — **do not open a public issue**.

## Privacy

VibePrompter is fully local. No telemetry, no accounts, no data leaves your machine except the text you send to whichever AI provider you configured. See [PRIVACY.md](https://github.com/SkyThonk/VibePrompter/blob/main/PRIVACY.md) for full details.

## License

GPL v3 — see [LICENSE](https://github.com/SkyThonk/VibePrompter/blob/main/LICENSE) for details.
