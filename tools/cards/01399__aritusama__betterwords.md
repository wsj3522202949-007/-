...
![betterwords 2.0.0 overview](https://github.com/aritusama/betterwords/blob/main/.github/assets/betterwords-2.0.0.png)
...
- Claude supports the same skill and a namespaced Claude Code plugin. See [Claude setup](https://github.com/aritusama/betterwords/blob/main/.github/platforms/claude.md).
- Gemini CLI supports extension and standalone-skill installation; Antigravity supports the plugin folder. See [Gemini and Antigravity setup](https://github.com/aritusama/betterwords/blob/main/.github/platforms/gemini.md).
- GitHub Copilot can use repository instructions. See [GitHub Copilot setup](https://github.com/aritusama/betterwords/blob/main/.github/platforms/github-copilot.md).
- Hosts without skill support can use `betterwords.md` with the [short instruction adapter](https://github.com/aritusama/betterwords/blob/main/.github/platforms/common-instructions.md). See [ChatGPT setup](https://github.com/aritusama/betterwords/blob/main/.github/platforms/chatgpt.md) for custom GPT and Project use.
