...
area: 库
status: active
tags: [Claude插件, 互动叙事, TypeScript, 协议宽松, 本地优先, 英文文档, 本地写作]
title: web-story
summary: 互动叙事/聊天写故事
source: https://github.com/ninthdesertdude/web-story
created: 2026-07-18
updated: 2026-07-18
no: 45
category: 二、网文 / 长篇 AI 写作系统 库
repo: NinthDesertDude/web-story
stars: 0
url: https://github.com/ninthdesertdude/web-story
tier: "C"
use_case: "互动叙事/聊天写故事"
pitfalls:
...
content_hash: 43b4f5dca79f2c30
  - methods/最强写作方法论_全球最强综合版.md
---

# NinthDesertDude/web-story

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/ninthdesertdude/web-story
- **Stars**：0
- **语言**：TypeScript
- **License**：MIT
- **Topics**：interactive-fiction, interactive-fiction-engine, text-adventure, text-adventure-engine
- **GitHub 描述**：An online fiction authoring tool for hyperlink and parser-based games
- **本地描述**：An online fiction authoring tool for hyperlink and parser-based games
- **拉取时间**：2026-07-23 22:40:11
...
Web Story is an open source tool for authoring and playing works of interactive fiction directly in the browser.  
