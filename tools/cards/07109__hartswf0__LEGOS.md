...
source: https://github.com/hartswf0/LEGOS
created: 2026-07-18
updated: 2026-07-18
no: 7109
...
repo: hartswf0/LEGOS
stars: 0
url: https://github.com/hartswf0/LEGOS
tier: "C"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/hartswf0/LEGOS
- **Stars**：0
- **语言**：HTML
- **License**：None
- **Topics**：—
- **GitHub 描述**：LEGOS (Location, Entity, Goal, Obstacle, Shift, Solution) is a framework for narrative generation. Each element plays a specific role in creating compelling stories.
- **本地描述**：LEGOS (Location, Entity, Goal, Obstacle, Shift, Solution) is a framework for narrative generation. Each element plays a specific role in creating compelling stories.
- **拉取时间**：2026-07-25 19:11:08
