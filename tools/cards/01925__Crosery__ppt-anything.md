...
**其他 CLI**：见 [`AGENT.md`](https://github.com/Crosery/ppt-anything/blob/main/AGENT.md)，里面写了 Claude / Gemini CLI / Codex CLI / Cursor 怎么各自接入这个项目。
...
详见 [`docs/library-management.md`](https://github.com/Crosery/ppt-anything/blob/main/docs/library-management.md)。
