...
title: storystudio-app
summary: 小说转语音/有声书
source: https://github.com/eiigen/storystudio-app
created: 2026-07-18
updated: 2026-07-18
no: 1653
category: 二、网文 / 长篇 AI 写作系统 库
repo: eiigen/storystudio-app
stars: 0
url: https://github.com/eiigen/storystudio-app
tier: "C"
use_case: "小说转语音/有声书"
pitfalls:
...
# eiigen/storystudio-app

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/eiigen/storystudio-app
- **Stars**：0
- **语言**：JavaScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：AI StoryStudio - AI Storybook Generator
- **本地描述**：AI StoryStudio - AI Storybook Generator
- **拉取时间**：2026-07-23 23:27:15
