...
title: ada-wm-evasion
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/nilslukas/ada-wm-evasion
created: 2026-07-18
updated: 2026-07-18
no: 7464
category: 画龙补充 / 扩容入库 — 补充源
repo: nilslukas/ada-wm-evasion
stars: 3
url: https://github.com/nilslukas/ada-wm-evasion
tier: "B"
...
content_hash: 8eb28355b0a1e1ec
  - methods/QUICK_START.md
---

# nilslukas/ada-wm-evasion

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/nilslukas/ada-wm-evasion
- **Stars**：3
- **语言**：None
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：Adaptive Watermark Evasion 
- **本地描述**：ada-wm-evasion
- **拉取时间**：2026-07-25 19:22:42
