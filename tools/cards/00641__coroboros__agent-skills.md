...
Stdlib only. See [`.agents/rules/skill-authoring.md`](https://github.com/coroboros/agent-skills/blob/master/.agents/rules/skill-authoring.md) for the testing requirement.
...
Repo guidance is cross-agent: [`AGENTS.md`](https://github.com/coroboros/agent-skills/blob/master/AGENTS.md) is the agent-facing index (Codex and every `AGENTS.md`-reading harness), [`CLAUDE.md`](https://github.com/coroboros/agent-skills/blob/master/CLAUDE.md) imports it for Claude Code. Authoring conventions live in [`.agents/rules/`](https://github.com/coroboros/agent-skills/tree/master/.agents/rules/):

- [`agentskills-spec.md`](https://github.com/coroboros/agent-skills/blob/master/.agents/rules/agentskills-spec.md) — canonical frontmatter, folder anatomy, size budget
- [`claude-code-skills.md`](https://github.com/coroboros/agent-skills/blob/master/.agents/rules/claude-code-skills.md) — Claude Code extensions and string substitutions
- [`skill-authoring.md`](https://github.com/coroboros/agent-skills/blob/master/.agents/rules/skill-authoring.md) — mandatory use of Anthropic's official `skill-creator`, and the testing requirement that ships with any script change
- [`repo-conventions.md`](https://github.com/coroboros/agent-skills/blob/master/.agents/rules/repo-conventions.md) — flag model, output paths, install, plugin marketplace, test placement
- [`skill-prose-rules.md`](https://github.com/coroboros/agent-skills/blob/master/.agents/rules/skill-prose-rules.md) — canonical writing-rules block embedded in every prose-emitting skill
- [`skill-label-hygiene-rules.md`](https://github.com/coroboros/agent-skills/blob/master/.agents/rules/skill-label-hygiene-rules.md) — canonical label-hygiene block embedded in skills that ship code, commits, PR bodies, and review prose
- [`skill-execution-discipline-rules.md`](https://github.com/coroboros/agent-skills/blob/master/.agents/rules/skill-execution-discipline-rules.md) — canonical execution-discipline block embedded in code-producing skills
- [`skill-adversarial-verification-rules.md`](https://github.com/coroboros/agent-skills/blob/master/.agents/rules/skill-adversarial-verification-rules.md) — canonical adversarial-verification block embedded in skills whose output is a finding or decision
...
[MIT](https://github.com/coroboros/agent-skills/blob/master/LICENSE.md)
