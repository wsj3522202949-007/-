...
title: plottwist
summary: 互动叙事/聊天写故事
source: https://github.com/neofoxxo/plottwist
created: 2026-07-18
updated: 2026-07-18
no: 633
category: 二、网文 / 长篇 AI 写作系统 库
repo: NeoFoxxo/plottwist
stars: 18
url: https://github.com/neofoxxo/plottwist
tier: "B"
use_case: "互动叙事/聊天写故事"
pitfalls:
...
- **链接**：https://github.com/neofoxxo/plottwist
- **Stars**：18
- **语言**：TypeScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：Choose your own adventure story generator powered by AI
- **本地描述**：Choose your own adventure story generator powered by AI
- **拉取时间**：2026-07-23 22:57:31
...
This project is licensed under the [GPL 3 License](https://github.com/NeoFoxxo/plottwist/blob/main/LICENSE). Feel free to use, modify, and distribute the code as per the terms of the license.
