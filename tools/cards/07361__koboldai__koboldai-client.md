...
area: 库
status: active
tags: [互动叙事, Python, 协议传染, 本地优先, 英文文档, 本地写作]
title: koboldai-client
summary: 互动叙事/聊天写故事
source: https://github.com/koboldai/koboldai-client
created: 2026-07-18
updated: 2026-07-18
no: 7361
category: 画龙补充 / 扩容入库 — 补充源
repo: koboldai/koboldai-client
stars: 3925
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/koboldai/koboldai-client
- **Stars**：3925
- **语言**：Python
- **License**：AGPL-3.0
- **Topics**：—
- **GitHub 描述**：For GGUF support, see KoboldCPP: https://github.com/LostRuins/koboldcpp
- **本地描述**：koboldai-client
- **拉取时间**：2026-07-25 19:19:32
