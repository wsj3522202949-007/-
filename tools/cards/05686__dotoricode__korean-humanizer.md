...
[한국어](https://github.com/dotoricode/korean-humanizer/blob/main/README.ko.md) · [中文](https://github.com/dotoricode/korean-humanizer/blob/main/README.zh-CN.md)
...
**Other LLMs:** paste [`PROMPT.short.md`](https://github.com/dotoricode/korean-humanizer/blob/main/PROMPT.short.md) as a system prompt, or use the full [`PROMPT.md`](https://github.com/dotoricode/korean-humanizer/blob/main/PROMPT.md).
...
Full catalog: [`references/ko-ai-signals.md`](https://github.com/dotoricode/korean-humanizer/blob/main/references/ko-ai-signals.md) · Quick reference: [`CHEATSHEET.md`](https://github.com/dotoricode/korean-humanizer/blob/main/CHEATSHEET.md)
...
Contributions welcome — [`CONTRIBUTING.md`](https://github.com/dotoricode/korean-humanizer/blob/main/CONTRIBUTING.md) · [Pattern addition](https://github.com/dotoricode/korean-humanizer/blob/main/.github/ISSUE_TEMPLATE/pattern_addition.md) · [Bug report](https://github.com/dotoricode/korean-humanizer/blob/main/.github/ISSUE_TEMPLATE/bug_report.md)
