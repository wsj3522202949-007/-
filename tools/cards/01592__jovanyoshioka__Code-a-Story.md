...
source: https://github.com/jovanyoshioka/code-a-story
created: 2026-07-18
updated: 2026-07-18
no: 1592
category: 二、网文 / 长篇 AI 写作系统 库
repo: jovanyoshioka/Code-a-Story
stars: 0
url: https://github.com/jovanyoshioka/code-a-story
tier: "C"
...
- **链接**：https://github.com/jovanyoshioka/code-a-story
- **Stars**：0
- **语言**：JavaScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：A tool that generates mazes based on stories' plots to be traversed using block-based coding (UTK Research).
- **本地描述**：A tool that generates mazes based on stories' plots to be traversed using block-based coding (UTK Research).
- **拉取时间**：2026-07-23 23:25:29
...
![Code a Story App Interface](https://github.com/jovanyoshioka/Code-a-Story/blob/master/assets/thumbnail.PNG)
