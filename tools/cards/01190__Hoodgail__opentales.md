...
For a full walkthrough see **[docs/getting-started.md](https://github.com/Hoodgail/opentales/blob/main/docs/getting-started.md)**.
...
| **[Getting started](https://github.com/Hoodgail/opentales/blob/main/docs/getting-started.md)** | Local setup walkthrough — your first project in five minutes. |
| **[Architecture](https://github.com/Hoodgail/opentales/blob/main/docs/architecture.md)** | High-level system design, package layout, data model, and conventions. |
| **[AI system](https://github.com/Hoodgail/opentales/blob/main/docs/ai-system.md)** | How project AI settings, agent sessions, streaming, tool calls, and approval-gated edits work. |
| **[AI assistive features](https://github.com/Hoodgail/opentales/blob/main/docs/ai-assistive-features.md)** | SDK and endpoint notes for AI settings, docs, one-shot features, and agent tools. |
| **[Future directions](https://github.com/Hoodgail/opentales/blob/main/docs/future-directions.md)** | Roadmap, refactor opportunities, and brainstormed features for novel writing. |
| **[Contributing](https://github.com/Hoodgail/opentales/blob/main/CONTRIBUTING.md)** | How to set up a working copy and submit your first PR. |

| **[Backend README](https://github.com/Hoodgail/opentales/blob/main/packages/backend/README.md)** | Backend-specific notes. |

| **[SDK README](https://github.com/Hoodgail/opentales/blob/main/packages/sdk/README.md)** | SDK usage and shape. |
...
A few of the things we're thinking about next. Full list lives in [`docs/future-directions.md`](https://github.com/Hoodgail/opentales/blob/main/docs/future-directions.md).
...
Issues, PRs, design feedback, and prose-tested feature ideas are all welcome. Start with **[CONTRIBUTING.md](https://github.com/Hoodgail/opentales/blob/main/CONTRIBUTING.md)** for setup steps and the development workflow, then pick something from **[docs/future-directions.md](https://github.com/Hoodgail/opentales/blob/main/docs/future-directions.md)** that excites you.
...
License TBD — see [`docs/future-directions.md`](https://github.com/Hoodgail/opentales/blob/main/docs/future-directions.md) for the roadmap. Build the writing tool you wish you had.
