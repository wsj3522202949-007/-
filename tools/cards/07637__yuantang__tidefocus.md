...
area: 库
status: active
tags: [TypeScript, 协议宽松, 本地优先, 中文友好, 本地写作]
title: tidefocus
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/yuantang/tidefocus
created: 2026-07-18
updated: 2026-07-18
no: 7637
category: 画龙补充 / 扩容入库 — 补充源
repo: yuantang/tidefocus
stars: 0
url: https://github.com/yuantang/tidefocus
tier: "C"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/yuantang/tidefocus
- **Stars**：0
- **语言**：TypeScript
- **License**：MIT
- **Topics**：—
...
MIT License - 详见 [LICENSE](https://github.com/yuantang/tidefocus/blob/main/LICENSE) 文件
...
MIT License - see [LICENSE](https://github.com/yuantang/tidefocus/blob/main/LICENSE) file
