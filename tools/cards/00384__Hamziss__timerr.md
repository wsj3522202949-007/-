...
source: https://github.com/hamziss/timerr
created: 2026-07-18
updated: 2026-07-18
no: 384
...
repo: Hamziss/timerr
stars: 2
url: https://github.com/hamziss/timerr
tier: "B"
...
- **链接**：https://github.com/hamziss/timerr
- **Stars**：2
- **语言**：TypeScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：timerr is an open source productivity web app. The goal of this app is to help you to be productive and focus on any task you are working on it can be anything , for example studying, writing, or coding.
- **本地描述**：timerr is an open source productivity web app. The goal of this app is to help you to be productive and focus on any task you are working on it can be anything , for example studying, writing, or coding.
- **拉取时间**：2026-07-23 22:50:19
