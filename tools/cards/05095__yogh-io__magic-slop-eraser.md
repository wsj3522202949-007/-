...
area: 库
status: active
tags: [多Agent, TypeScript, 协议未明, 本地优先, 英文文档, 本地写作]
title: magic-slop-eraser
summary: 多 Agent 协作自动产文
source: https://github.com/yogh-io/magic-slop-eraser
created: 2026-07-18
updated: 2026-07-18
no: 5095
category: 一、去 AI 味 / Humanizer 库
repo: yogh-io/magic-slop-eraser
stars: 0
url: https://github.com/yogh-io/magic-slop-eraser
tier: "C"
...
content_hash: 7c676625f16cebd8
  - methods/改稿润色指令库.md
---

# yogh-io/magic-slop-eraser

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/yogh-io/magic-slop-eraser
- **Stars**：0
- **语言**：TypeScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：A hosted online AI-slop detector and guided fixer.
- **本地描述**：A hosted online AI-slop detector and guided fixer.
- **拉取时间**：2026-07-25 18:05:54
...
concave dents where it's below. See [docs/density-rail.md](https://github.com/yogh-io/magic-slop-eraser/blob/main/docs/density-rail.md).
...
[`.claude/skills/slopmop/SKILL.md`](https://github.com/yogh-io/magic-slop-eraser/blob/main/.claude/skills/slopmop/SKILL.md);
the framework definition lives at [`CLAUDE.md`](https://github.com/yogh-io/magic-slop-eraser/blob/main/CLAUDE.md).
...
[`.do/app.yaml`](https://github.com/yogh-io/magic-slop-eraser/blob/main/.do/app.yaml). The deployed instance persists session
