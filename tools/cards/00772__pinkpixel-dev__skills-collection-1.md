...
This repo is organized for scale rather than a giant table of contents. Instead of listing every skill here, the repository keeps each skill in its own folder under [`SKILLS/`](https://github.com/pinkpixel-dev/skills-collection-1/blob/main//home/sizzlebop/PINKPIXEL/PROJECTS/CURRENT/skills-collection-1/SKILLS), where it can include its own instructions, references, scripts, and assets.
...
- `969` skill folders in [`SKILLS/`](https://github.com/pinkpixel-dev/skills-collection-1/blob/main//home/sizzlebop/PINKPIXEL/PROJECTS/CURRENT/skills-collection-1/SKILLS)
...
This repository is available under the MIT License. See [`LICENSE`](https://github.com/pinkpixel-dev/skills-collection-1/blob/main//home/sizzlebop/PINKPIXEL/PROJECTS/CURRENT/skills-collection-1/LICENSE).
