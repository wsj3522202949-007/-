...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/canopyai/orpheus-tts
- **Stars**：6260
- **语言**：Python
- **License**：Apache-2.0
- **Topics**：llm, realtime, tts
- **GitHub 描述**：Towards Human-Sounding Speech
- **本地描述**：orpheus-tts
- **拉取时间**：2026-07-25 19:13:14
...
#### Updates 🔥
- [5/2025] We've partnered with [Baseten](https://www.baseten.co/blog/canopy-labs-selects-baseten-as-preferred-inference-provider-for-orpheus-tts-model) to bring highly optimized inference to Orpheus at fp8 (more performant) and fp16 (full fidelity) inference. See code and docs [here](https://github.com/canopyai/orpheus-tts/blob/main//additional_inference_options/baseten_inference_example/README.md).
