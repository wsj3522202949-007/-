...
source: https://github.com/aprempeh-tech/humanizer-workbench
created: 2026-07-18
updated: 2026-07-18
no: 5493
category: 一、去 AI 味 / Humanizer 库
repo: aprempeh-tech/humanizer-workbench
stars: 2
url: https://github.com/aprempeh-tech/humanizer-workbench
tier: "B"
...
# aprempeh-tech/humanizer-workbench

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/aprempeh-tech/humanizer-workbench
- **Stars**：2
- **语言**：Python
- **License**：MIT
...
- **GitHub 描述**：Rewrite AI text into natural writing with a CLI and Claude Code skill that spot AI patterns, refine tone, and improve rhythm
- **本地描述**：Rewrite AI text into natural writing with a CLI and Claude Code skill that spot AI patterns, refine tone, and improve rhythm
- **拉取时间**：2026-07-25 18:20:45
