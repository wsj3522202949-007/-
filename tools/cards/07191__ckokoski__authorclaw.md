...
See [QUICKSTART.md](https://github.com/ckokoski/authorclaw/blob/main/QUICKSTART.md) for the full guide.
...
For VM/VPS/Docker deployment (recommended for always-on Telegram use), see [SECURITY.md](https://github.com/ckokoski/authorclaw/blob/main/SECURITY.md) and the `docker/` directory.
...
MIT. See [LICENSE](https://github.com/ckokoski/authorclaw/blob/main/LICENSE).
