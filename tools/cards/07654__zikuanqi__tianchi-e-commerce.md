...
title: tianchi-e-commerce
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/zikuanqi/tianchi-e-commerce
created: 2026-07-18
updated: 2026-07-18
no: 7654
category: 画龙补充 / 扩容入库 — 补充源
repo: zikuanqi/tianchi-e-commerce
stars: 27
url: https://github.com/zikuanqi/tianchi-e-commerce
tier: "B"
...
content_hash: 1c6884caf61bb206
  - methods/QUICK_START.md
---

# zikuanqi/tianchi-e-commerce

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/zikuanqi/tianchi-e-commerce
- **Stars**：27
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：移动推荐算法，以阿里巴巴移动电商平台的真实用户-商品行为数据为基础，同时提供移动时代特有的位置信息，希望你能够挖掘数据背后丰富的内涵，为移动用户在合适的时间、合适的地点精准推荐合适的内容。
- **本地描述**：tianchi-e-commerce
- **拉取时间**：2026-07-25 19:29:01
...
**许可证**：[MIT License](https://github.com/zikuanqi/tianchi-e-commerce/blob/main/LICENSE)
