...
- **Source:** Kaggle [Product Sales and Returns Dataset](https://github.com/HamidrezaGholamrezaei/customer-commerce-analytics/blob/main/<https://www.kaggle.com/datasets/yaminh/product-sales-and-returns-dataset>) (see `data/README.md`)  
