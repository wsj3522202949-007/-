...
source: https://github.com/avgjs/avg-core
created: 2026-07-18
updated: 2026-07-18
no: 7151
...
repo: avgjs/avg-core
stars: 862
url: https://github.com/avgjs/avg-core
tier: "S"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/avgjs/avg-core
- **Stars**：862
- **语言**：JavaScript
- **License**：Apache-2.0
- **Topics**：adventure-game-engine, avg, galgame, game, game-development, game-engine, game-frameworks, gamemaker, react, visual-novel, visual-novel-engine, webgl
- **GitHub 描述**：A Future-oriented Adventure Game Framework based on React & Pixi.js. Docs: https://avgjs.github.io/docs/
- **本地描述**：avg-core
- **拉取时间**：2026-07-25 19:12:24
