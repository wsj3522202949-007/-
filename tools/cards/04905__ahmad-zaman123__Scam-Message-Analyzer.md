...
![The browser app: paste a message or upload a screenshot, then get a plain-language verdict](https://github.com/ahmad-zaman123/Scam-Message-Analyzer/blob/main/docs/screenshot.png)
