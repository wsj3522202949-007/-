...
source: https://github.com/shevtsev/toolboxbot
created: 2026-07-18
updated: 2026-07-18
no: 406
category: 二、网文 / 长篇 AI 写作系统 库
repo: shevtsev/ToolBoxbot
stars: 3
url: https://github.com/shevtsev/toolboxbot
tier: "B"
...
- **链接**：https://github.com/shevtsev/toolboxbot
- **Stars**：3
- **语言**：Python
- **License**：MIT
- **Topics**：assistant, flux, gpt4o-mini, image-generation, image-processing, neural-networks, python3, telegram-bot, text-writer, toolbox
- **GitHub 描述**：ToolBox - an assistant for writing texts, generating images and transcribing audio
- **本地描述**：ToolBox - an assistant for writing texts, generating images and transcribing audio
- **拉取时间**：2026-07-23 22:50:57
