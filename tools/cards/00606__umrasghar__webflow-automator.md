...
![WebFlow Automator Logo](https://github.com/umrasghar/webflow-automator/blob/main/docs/images/logo.png)
...
![Main UI](https://github.com/umrasghar/webflow-automator/blob/main/docs/images/main-ui.png)

*WebFlow Automator main interface*

![Workflow Builder](https://github.com/umrasghar/webflow-automator/blob/main/docs/images/workflow-builder.png)
...
For detailed installation instructions, see the [Installation Guide](https://github.com/umrasghar/webflow-automator/blob/main/docs/installation.md).
...
For a more comprehensive guide, see the [Getting Started Guide](https://github.com/umrasghar/webflow-automator/blob/main/docs/getting-started.md).
...
Contributions are welcome! Please read our [Contributing Guidelines](https://github.com/umrasghar/webflow-automator/blob/main/CONTRIBUTING.md) before submitting a pull request.

## License

This project is licensed under the MIT License - see the [LICENSE](https://github.com/umrasghar/webflow-automator/blob/main/LICENSE) file for details.
