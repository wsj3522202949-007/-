...
source: https://github.com/xiuqiang1995/wechat-ai-publisher
created: 2026-07-18
updated: 2026-07-18
no: 1161
category: 二、网文 / 长篇 AI 写作系统 库
repo: xiuqiang1995/wechat-ai-publisher
stars: 7
url: https://github.com/xiuqiang1995/wechat-ai-publisher
tier: "B"
...
content_hash: 02a0ce11eea6d564
  - methods/最强写作方法论_全球最强综合版.md
---

# xiuqiang1995/wechat-ai-publisher

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/xiuqiang1995/wechat-ai-publisher
- **Stars**：7
- **语言**：Python
- **License**：MIT
- **Topics**：ai, article-generation, automation, content-creation, illustration, publishing, python, wechat
- **GitHub 描述**：🤖 Complete WeChat article automation: AI writing + illustration + publishing. Streamline your content creation workflow with intelligent article generation, automatic illustration planning, and one-click publishing to WeChat.
- **本地描述**：🤖 Complete WeChat article automation: AI writing + illustration + publishing. Streamline your content creation workflow with intelligent article generation, automatic illustration planning, and one-click publishing to WeChat.
- **拉取时间**：2026-07-23 23:12:54
...
本项目采用 MIT 许可证 - 查看 [LICENSE](https://github.com/xiuqiang1995/wechat-ai-publisher/blob/main/LICENSE) 文件了解详情。
