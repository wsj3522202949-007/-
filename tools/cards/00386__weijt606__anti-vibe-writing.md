...
area: 库
status: active
tags: [大纲规划, Claude插件, 协议宽松, 本地优先, 中文友好, 本地写作]
title: anti-vibe-writing
summary: 搭大纲/分卷/节拍
source: https://github.com/weijt606/anti-vibe-writing
created: 2026-07-18
updated: 2026-07-18
no: 386
category: 二、网文 / 长篇 AI 写作系统 库
repo: weijt606/anti-vibe-writing
stars: 98
url: https://github.com/weijt606/anti-vibe-writing
tier: "A"
use_case: "搭大纲/分卷/节拍"
pitfalls: []
related:
...
- **链接**：https://github.com/weijt606/anti-vibe-writing
- **Stars**：98
- **语言**：None
- **License**：MIT
- **Topics**：claude-code, codex, human-in-the-loop, llm, skills
- **GitHub 描述**：An AI writing skill that turns agent-generated drafts into clearer, warmer, more human documents by removing templated phrasing, markdown clutter, and generic AI tone.
- **本地描述**：An AI writing skill that turns agent-generated drafts into clearer, warmer, more human documents by removing templated phrasing, markdown clutter, and generic AI tone.
- **拉取时间**：2026-07-23 22:50:24

---

# anti-vibe-writing

![anti-vibe-writing：黑白漫画风 banner，四格讲述 AI 写作如何从满屏破折号、emoji 被平台删帖，到人工去味、最终"倍地道"过审](https://github.com/weijt606/anti-vibe-writing/blob/main/anti-vibe-writing-banner-cn.png)
...
> This README comes in two languages: **中文** (this page, the default) and **[English](https://github.com/weijt606/anti-vibe-writing/blob/main/README.en.md)**. Use the badges above to switch.
...
新增 pattern、benchmark、场景预设的规则见 [CONTRIBUTING.md](https://github.com/weijt606/anti-vibe-writing/blob/main/CONTRIBUTING.md)。
...
完整版本历史见 [CHANGELOG.md](https://github.com/weijt606/anti-vibe-writing/blob/main/CHANGELOG.md)。
