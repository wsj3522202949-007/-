...
area: 库
status: active
tags: [去AI味, 互动叙事, JavaScript, 协议宽松, 本地优先, 英文文档, 本地写作]
title: humanize-ai-writing
summary: 投稿前文本降 AI 痕、过检测
source: https://github.com/hewieextracellular787/humanize-ai-writing
created: 2026-07-18
updated: 2026-07-18
no: 5623
category: 一、去 AI 味 / Humanizer 库
repo: hewieextracellular787/humanize-ai-writing
stars: 1
url: https://github.com/hewieextracellular787/humanize-ai-writing
tier: "B"
...
content_hash: 8a13e8dd4daa55ad
  - methods/改稿润色指令库.md
---

# hewieextracellular787/humanize-ai-writing

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/hewieextracellular787/humanize-ai-writing
- **Stars**：1
- **语言**：JavaScript
- **License**：MIT
- **Topics**：agent-skills, ai, ai-humanizer, ai-writing, claude-code-plugin, codex-skill, dify, german, humanize-ai, humanize-text, humanizer, humanizer-de, korean-nlp, openclaw, stylometry, text-processing, writing-tools
- **GitHub 描述**：Use this system prompt to strip AI-generated style patterns and force chatbots to write natural, human-like text across all major LLMs.
- **本地描述**：Use this system prompt to strip AI-generated style patterns and force chatbots to write natural, human-like text across all major LLMs.
- **拉取时间**：2026-07-25 18:25:34
