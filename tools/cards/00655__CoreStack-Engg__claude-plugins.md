...
area: 库
status: active
tags: [多Agent, Claude插件, Python, 协议未明, 需API密钥, 英文文档]
title: claude-plugins
summary: 多 Agent 协作自动产文
source: https://github.com/corestack-engg/claude-plugins
created: 2026-07-18
updated: 2026-07-18
no: 655
category: 二、网文 / 长篇 AI 写作系统 库
repo: CoreStack-Engg/claude-plugins
stars: 0
url: https://github.com/corestack-engg/claude-plugins
tier: "C"
...
content_hash: 1c55fcd85817d026
  - methods/最强写作方法论_全球最强综合版.md
---

# CoreStack-Engg/claude-plugins

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/corestack-engg/claude-plugins
- **Stars**：0
- **语言**：Python
- **License**：None
- **Topics**：—
...
| Doc | Contents |
|-----|----------|
| [docs/agents.md](https://github.com/CoreStack-Engg/claude-plugins/blob/main/docs/agents.md) | Usage guide for all 26 agents with real-world examples |
| [docs/commands.md](https://github.com/CoreStack-Engg/claude-plugins/blob/main/docs/commands.md) | Reference for all 12 slash commands with scenarios |
| [docs/orchestrators.md](https://github.com/CoreStack-Engg/claude-plugins/blob/main/docs/orchestrators.md) | Multi-agent workflow guide with end-to-end examples |
| [INSTRUCTIONS.MD](https://github.com/CoreStack-Engg/claude-plugins/blob/main/INSTRUCTIONS.MD) | Installation, setup, and configuration guide |
...
- [Anthropic Claude Plugins](https://github.com/anthropics/claude-plugins-official) — Official plugin examples (included as `references/claude-plugins-official/`); `code-review` plugin's confidence-scoring and multi-agent PR workflow patterns are incorporated into the engineering plugin
