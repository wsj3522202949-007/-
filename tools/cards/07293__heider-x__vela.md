...
area: 库
status: active
tags: [RAG, 大纲规划, TypeScript, 协议传染, 需API密钥, 中文友好, 人物设定]
title: vela
...
- **语言**：TypeScript
- **License**：GPL-3.0
- **Topics**：ai-tool, ai-writing, creative-writing, desktop-app, electron, local-llm, novel-writing, rag, react, typescript
- **GitHub 描述**：AI-powered IDE for novel writing — local LLM + RAG, privacy-first, BYOK. For web fiction authors and creative writers.
- **本地描述**：vela
- **拉取时间**：2026-07-25 19:16:53
...
本项目采用 [GPL-3.0 License](https://github.com/heider-x/vela/blob/main/LICENSE) 开源。您可以自由地运行、研究、分享和修改代码，但基于此修改分发的新软件**必须同样遵循 GPL-3.0 协议开源**。
...
**Crafted with 💡 by [heider-x](https://github.com/heider-x/vela/blob/main/[https://github.com/heider](https://github.com/heider-x))**
