...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/yale-lily/qmsum
- **Stars**：152
- **语言**：Jupyter Notebook
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：Dataset for NAACL 2021 paper: "QMSum: A New Benchmark for Query-based Multi-domain Meeting Summarization"
- **本地描述**：qmsum
- **拉取时间**：2026-07-25 19:28:03
