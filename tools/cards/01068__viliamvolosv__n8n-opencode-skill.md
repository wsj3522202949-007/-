...
title: n8n-opencode-skill
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/viliamvolosv/n8n-opencode-skill
created: 2026-07-18
updated: 2026-07-18
no: 1068
category: 二、网文 / 长篇 AI 写作系统 库
repo: viliamvolosv/n8n-opencode-skill
stars: 18
url: https://github.com/viliamvolosv/n8n-opencode-skill
tier: "B"
...
content_hash: a643efe099824c83
  - methods/最强写作方法论_全球最强综合版.md
---

# viliamvolosv/n8n-opencode-skill

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/viliamvolosv/n8n-opencode-skill
- **Stars**：18
- **语言**：None
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：Repository containing n8n OpenCode skills that extend OpenCode's capabilities with domain-specific tools and workflows for n8n workflow automation, including expert guidance on MCP tools, validation, expression syntax, code writing in Python/JavaScript, workflow patterns, and node configuration.
- **本地描述**：Repository containing n8n OpenCode skills that extend OpenCode's capabilities with domain-specific tools and workflows for n8n workflow automation, including expert guidance on MCP tools, validation, expression syntax, code writing in Python/JavaScript, workflow patterns, and node configuration.
- **拉取时间**：2026-07-23 23:10:07
...
Want to create a skill for a different service? See our [Creating Skills Guide](https://github.com/viliamvolosv/n8n-opencode-skill/blob/main/docs/creating-skills.md).
...
MIT License - see [LICENSE](https://github.com/viliamvolosv/n8n-opencode-skill/blob/main/LICENSE) for details.
