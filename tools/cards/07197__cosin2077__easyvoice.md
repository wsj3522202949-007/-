...
title: easyvoice
summary: 小说转语音/有声书
source: https://github.com/cosin2077/easyvoice
created: 2026-07-18
updated: 2026-07-18
no: 7197
category: 画龙补充 / 扩容入库 — 补充源
repo: cosin2077/easyvoice
stars: 2241
url: https://github.com/cosin2077/easyvoice
tier: "S"
use_case: "小说转语音/有声书"
pitfalls:
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/cosin2077/easyvoice
- **Stars**：2241
- **语言**：TypeScript
- **License**：None
- **Topics**：edge-tts, tts, tts-engines
- **GitHub 描述**：开源文本转语音工具，支持超长文本，多角色配音
- **本地描述**：easyvoice
- **拉取时间**：2026-07-25 19:13:50
...
![Home](https://github.com/cosin2077/easyvoice/blob/main/images/readme.home.jpg)
![Generate](https://github.com/cosin2077/easyvoice/blob/main/images/readme.generate.jpg)
...
- text: 你需要转语音的文字。
- voice: 你需要用到的声音，参考：[支持的声音列表](https://github.com/cosin2077/easyvoice/blob/main/packages/backend/src/llm/prompt/voiceList.json)
