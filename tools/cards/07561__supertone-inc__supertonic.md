...
area: 库
status: active
tags: [TTS, Swift, 协议宽松, 本地优先, 英文文档, 本地写作]
title: supertonic
summary: 小说转语音/有声书
...
- **GitHub 描述**：Lightning-Fast, On-Device, Multilingual TTS — running natively via ONNX.
- **本地描述**：supertonic
- **拉取时间**：2026-07-25 19:25:40
...
**Node.js Example** ([Details](https://github.com/supertone-inc/supertonic/tree/main/nodejs/))
```bash
cd nodejs
npm install
npm start
...
**Browser Example** ([Details](https://github.com/supertone-inc/supertonic/tree/main/web/))
```bash
cd web
npm install
npm run dev
...
**Java Example** ([Details](https://github.com/supertone-inc/supertonic/tree/main/java/))
```bash
cd java
mvn clean install
mvn exec:java
...
**C++ Example** ([Details](https://github.com/supertone-inc/supertonic/tree/main/cpp/))
```bash
cd cpp
...
**C# Example** ([Details](https://github.com/supertone-inc/supertonic/tree/main/csharp/))
```bash
cd csharp
dotnet restore
dotnet run
...
**Go Example** ([Details](https://github.com/supertone-inc/supertonic/tree/main/go/))
```bash
cd go
go mod download
...
**Swift Example** ([Details](https://github.com/supertone-inc/supertonic/tree/main/swift/))
```bash
cd swift
...
**Rust Example** ([Details](https://github.com/supertone-inc/supertonic/tree/main/rust/))
```bash
cd rust
cargo build --release
...
**iOS Example** ([Details](https://github.com/supertone-inc/supertonic/tree/main/ios/))
```bash
...
|-------------------|------|-------------|
| [**Python**](https://github.com/supertone-inc/supertonic/tree/main/py/) | `py/` | ONNX Runtime inference |
| [**Node.js**](https://github.com/supertone-inc/supertonic/tree/main/nodejs/) | `nodejs/` | Server-side JavaScript |
| [**Browser**](https://github.com/supertone-inc/supertonic/tree/main/web/) | `web/` | WebGPU/WASM inference |
| [**Java**](https://github.com/supertone-inc/supertonic/tree/main/java/) | `java/` | Cross-platform JVM |
| [**C++**](https://github.com/supertone-inc/supertonic/tree/main/cpp/) | `cpp/` | High-performance C++ |
| [**C#**](https://github.com/supertone-inc/supertonic/tree/main/csharp/) | `csharp/` | .NET ecosystem |
| [**Go**](https://github.com/supertone-inc/supertonic/tree/main/go/) | `go/` | Go implementation |
| [**Swift**](https://github.com/supertone-inc/supertonic/tree/main/swift/) | `swift/` | macOS applications |
| [**iOS**](https://github.com/supertone-inc/supertonic/tree/main/ios/) | `ios/` | Native iOS apps |
| [**Rust**](https://github.com/supertone-inc/supertonic/tree/main/rust/) | `rust/` | Memory-safe systems |
| [**Flutter**](https://github.com/supertone-inc/supertonic/tree/main/flutter/) | `flutter/` | Cross-platform apps |
