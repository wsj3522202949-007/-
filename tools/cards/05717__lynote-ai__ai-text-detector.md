...
source: https://github.com/lynote-ai/ai-text-detector
created: 2026-07-18
updated: 2026-07-18
no: 5717
category: 一、去 AI 味 / Humanizer 库
repo: lynote-ai/ai-text-detector
stars: 361
url: https://github.com/lynote-ai/ai-text-detector
tier: "S"
...
- **链接**：https://github.com/lynote-ai/ai-text-detector
- **Stars**：361
- **语言**：Python
- **License**：MIT
- **Topics**：ai-agents, ai-content-detection, ai-content-detector, ai-detection, ai-detector, ai-text-detection, ai-text-detector, ai-tools, awesome-list, detection, detector, detectors, student-tools, writing-tools
- **GitHub 描述**： A free detector capable of identifying content generated by all advanced AI models.
- **本地描述**：A free detector capable of identifying content generated by all advanced AI models.
- **拉取时间**：2026-07-25 18:29:00
