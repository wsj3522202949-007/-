...
source: https://github.com/robertogalan/videotron
created: 2026-07-18
updated: 2026-07-18
no: 4585
category: 五、写作 IDE / 本地优先工作台 库
repo: robertogalan/Videotron
stars: 2
url: https://github.com/robertogalan/videotron
tier: "B"
...
content_hash: e6b84d2ba56fbc0b
  - methods/QUICK_START.md
---

# robertogalan/Videotron

- **分类**：五、写作 IDE / 本地优先工作台 库
- **链接**：https://github.com/robertogalan/videotron
- **Stars**：2
- **语言**：Python
- **License**：Unlicense
- **Topics**：—
- **GitHub 描述**：AI video generator using ChatGPT for short stories, fed into Dall-e for images, with gTTS narrator.
- **本地描述**：AI video generator using ChatGPT for short stories, fed into Dall-e for images, with gTTS narrator.
- **拉取时间**：2026-07-25 17:49:22
