...
A full **STRIDE** threat model is published at [`docs/security/threat-model.md`](https://github.com/rcrock1978/QueryPilot/blob/main/docs/security/threat-model.md).
...
> For a deeper walkthrough see [`specs/001-nl2sql-copilot/quickstart.md`](https://github.com/rcrock1978/QueryPilot/blob/main/specs/001-nl2sql-copilot/quickstart.md).
...
The full validation suite has 10 scenarios — register, end-to-end, disambiguation, row policies, column redaction, validation, saved queries, drift, explanation, PII. See [`specs/001-nl2sql-copilot/quickstart.md`](https://github.com/rcrock1978/QueryPilot/blob/main/specs/001-nl2sql-copilot/quickstart.md).
