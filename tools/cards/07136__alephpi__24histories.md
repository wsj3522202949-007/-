...
source: https://github.com/alephpi/24histories
created: 2026-07-18
updated: 2026-07-18
no: 7136
category: 画龙补充 / 扩容入库 — 补充源
repo: alephpi/24histories
stars: 4
url: https://github.com/alephpi/24histories
tier: "B"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/alephpi/24histories
- **Stars**：4
- **语言**：Python
- **License**：None
- **Topics**：ocr, python, self-study
- **GitHub 描述**：从头自学OCR：以《二十四史全本全译》为例
- **本地描述**：24histories
- **拉取时间**：2026-07-25 19:11:57
...
3. 文字识别
    ...
    1. 数据生成
        ...
        2. 确定字体：通过 [相当粗糙的识别](https://www.likefont.com/)，原书使用字体应为：
            ...
            ![./img.png](https://github.com/alephpi/24histories/blob/master/img.png)
