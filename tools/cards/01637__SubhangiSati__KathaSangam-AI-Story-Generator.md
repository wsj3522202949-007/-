...
title: KathaSangam-AI-Story-Generator
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/subhangisati/kathasangam-ai-story-generator
created: 2026-07-18
updated: 2026-07-18
no: 1637
category: 二、网文 / 长篇 AI 写作系统 库
repo: SubhangiSati/KathaSangam-AI-Story-Generator
stars: 5
url: https://github.com/subhangisati/kathasangam-ai-story-generator
tier: "B"
...
- **链接**：https://github.com/subhangisati/kathasangam-ai-story-generator
- **Stars**：5
- **语言**：Python
- **License**：None
- **Topics**：ai-story-generation, artificial-intelligence, generative-ai, image-to-text, machine-learning, mistral-7b, story-generator, text-to-speech
- **GitHub 描述**：It is an ultimate platform for creating and exploring imaginative stories. Whether you're an aspiring author, a creative enthusiast, or someone looking for a fun escape, KathaSangam is here to help you craft unique narratives and immerse yourself in a world of limitless possibilities.
- **本地描述**：It is an ultimate platform for creating and exploring imaginative stories. Whether you're an aspiring author, a creative enthusiast, or someone looking for a fun escape, KathaSangam is here to help you craft unique narratives and immerse yourself in a world of limitless possibilities.
- **拉取时间**：2026-07-23 23:26:46
...
![KathaSangam Architecture](https://github.com/SubhangiSati/KathaSangam-AI-Story-Generator/blob/main/Archi.png)
![KathaSangam WorkFlow](https://github.com/SubhangiSati/KathaSangam-AI-Story-Generator/blob/main/Flow.jpg)
...
![Screenshot 1](https://github.com/SubhangiSati/KathaSangam-AI-Story-Generator/blob/main/S1.png)
![Screenshot 2](https://github.com/SubhangiSati/KathaSangam-AI-Story-Generator/blob/main/S2.png)
![Screenshot 3](https://github.com/SubhangiSati/KathaSangam-AI-Story-Generator/blob/main/S3.png)
![Screenshot 3](https://github.com/SubhangiSati/KathaSangam-AI-Story-Generator/blob/main/S4.png)
