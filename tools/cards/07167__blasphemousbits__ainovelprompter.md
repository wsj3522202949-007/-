...
title: ainovelprompter
summary: 小说转语音/有声书
source: https://github.com/blasphemousbits/ainovelprompter
created: 2026-07-18
updated: 2026-07-18
no: 7167
category: 画龙补充 / 扩容入库 — 补充源
repo: blasphemousbits/ainovelprompter
stars: 0
url: https://github.com/blasphemousbits/ainovelprompter
tier: "C"
use_case: "小说转语音/有声书"
pitfalls:
...
content_hash: 4302dda6f5f14c32
  - methods/QUICK_START.md
---

# blasphemousbits/ainovelprompter

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/blasphemousbits/ainovelprompter
- **Stars**：0
- **语言**：None
- **License**：NOASSERTION
- **Topics**：—
- **GitHub 描述**：Create the prompts you need to write your Novel using AI
- **本地描述**：ainovelprompter
- **拉取时间**：2026-07-25 19:12:53
