...
title: VoiceCraft
summary: 小说转语音/有声书
source: https://github.com/parthgupta1208/voicecraft
created: 2026-07-18
updated: 2026-07-18
no: 1328
category: 二、网文 / 长篇 AI 写作系统 库
repo: parthgupta1208/VoiceCraft
stars: 18
url: https://github.com/parthgupta1208/voicecraft
tier: "B"
use_case: "小说转语音/有声书"
pitfalls: []
related:
...
- **链接**：https://github.com/parthgupta1208/voicecraft
- **Stars**：18
- **语言**：Python
- **License**：MIT
- **Topics**：ai, assistant, code-generator, desktop-assistant, friday-ai, gpt, gpt-35-turbo, jarvis-ai, voice-assistant
- **GitHub 描述**：Voice Craft is a desktop AI assistance tool designed to help people with disabilities operate a computer using their voice. This tool can also be used by anyone to automate their daily chores such as writing basic codes in any language or typing lengthy content.
- **本地描述**：Voice Craft is a desktop AI assistance tool designed to help people with disabilities operate a computer using their voice. This tool can also be used by anyone to automate their daily chores such as writing basic codes in any language or typing lengthy content.
- **拉取时间**：2026-07-23 23:17:50
