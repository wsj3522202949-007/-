...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/ahans30/binoculars
- **Stars**：396
- **语言**：Python
- **License**：BSD-3-Clause
- **Topics**：—
- **GitHub 描述**：[ICML 2024] Binoculars: Zero-Shot Detection of LLM-Generated Text
- **本地描述**：binoculars
- **拉取时间**：2026-07-25 19:11:42
