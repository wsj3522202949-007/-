...
source: https://github.com/jpope6/ai-text-detector
created: 2026-07-18
updated: 2026-07-18
no: 5194
category: 一、去 AI 味 / Humanizer 库
repo: jpope6/AI-Text-Detector
stars: 0
url: https://github.com/jpope6/ai-text-detector
tier: "C"
...
content_hash: 69097211e0f57043
  - methods/改稿润色指令库.md
---

# jpope6/AI-Text-Detector

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/jpope6/ai-text-detector
- **Stars**：0
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：A Logistic Regression machine learning model capable of distinguishing between human-written and AI-generated texts.
- **本地描述**：A Logistic Regression machine learning model capable of distinguishing between human-written and AI-generated texts.
- **拉取时间**：2026-07-25 18:09:35
...
![Correlation of Features](https://github.com/jpope6/AI-Text-Detector/blob/main/images/correlation_plot.png)
...
- **Confusion Matrix:**
  ...
  ![Confusion Matrix](https://github.com/jpope6/AI-Text-Detector/blob/main/images/confusion_matrix.png)
...
- **Precision-Recall Curve:**
  ...
  ![Precision-Recall Curve](https://github.com/jpope6/AI-Text-Detector/blob/main/images/precision_recall_curve.png)
...
- **ROC Curve:**
  ...
  ![ROC Curve](https://github.com/jpope6/AI-Text-Detector/blob/main/images/roc_curve.png)
