...
title: NGEP-eventplan
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/tangg555/ngep-eventplan
created: 2026-07-18
updated: 2026-07-18
no: 451
category: 二、网文 / 长篇 AI 写作系统 库
repo: tangg555/NGEP-eventplan
stars: 7
url: https://github.com/tangg555/ngep-eventplan
tier: "B"
...
content_hash: 5f44476c1bc7d811
  - methods/最强写作方法论_全球最强综合版.md
---

# tangg555/NGEP-eventplan

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/tangg555/ngep-eventplan
- **Stars**：7
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：The code for paper: "NGEP: A Graph-based Event Planning Framework for Story Generation"
- **本地描述**：The code for paper: "NGEP: A Graph-based Event Planning Framework for Story Generation"
- **拉取时间**：2026-07-23 22:52:15
