...
title: recsysdatasets
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/rucaibox/recsysdatasets
created: 2026-07-18
updated: 2026-07-18
no: 7523
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/rucaibox/recsysdatasets
- **Stars**：1258
- **语言**：Python
- **License**：None
- **Topics**：atomic-files, dataset, recbole, recommendation-datasets, recommendations, recommender-system
- **GitHub 描述**：This is a repository of public data sources for Recommender Systems (RS).
- **本地描述**：recsysdatasets
- **拉取时间**：2026-07-25 19:24:31
