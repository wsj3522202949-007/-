...
source: https://github.com/sydiepus/mangadex-py
created: 2026-07-18
updated: 2026-07-18
no: 7563
category: 画龙补充 / 扩容入库 — 补充源
repo: sydiepus/mangadex-py
stars: 2
url: https://github.com/sydiepus/mangadex-py
tier: "B"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/sydiepus/mangadex-py
- **Stars**：2
- **语言**：Python
- **License**：MIT
- **Topics**：manga, manga-dl, mangadex, mangadex-api, mangadex-downloader, mangadex-py, python
- **GitHub 描述**：MangaDexv5 manga downloader.
- **本地描述**：mangadex-py
- **拉取时间**：2026-07-25 19:25:44
