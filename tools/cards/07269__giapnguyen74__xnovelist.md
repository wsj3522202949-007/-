...
![Your local novel library](https://github.com/giapnguyen74/xnovelist/blob/main/assets/01-novel-list-page.png)
...
![The writing canvas with Story Bible entities highlighted in the prose](https://github.com/giapnguyen74/xnovelist/blob/main/assets/03-character-highlight.png)
...
![The AI level dial and provider setup in Settings](https://github.com/giapnguyen74/xnovelist/blob/main/assets/02-ai-levels-setting.png)

Every AI result is a proposal in the Agent panel — you Accept or Reject; nothing touches your manuscript until you do:

![The Agent panel proposing a change](https://github.com/giapnguyen74/xnovelist/blob/main/assets/04-agent-panel.png)

![Reviewing the AI suggestion against your own text](https://github.com/giapnguyen74/xnovelist/blob/main/assets/05-agent-panel2.png)

With Level 3 (Co-writer) active, you can outline beats in-place and generate prose directly in the editor:

![Outlining and writing beats in the editor](https://github.com/giapnguyen74/xnovelist/blob/main/assets/06-beat-writting.png)
...
If you want a chat-based ghostwriter, a cloud collaboration suite, or a screenplay tool, xnovelist is the wrong product. See [`docs/NON_GOALS.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/NON_GOALS.md).
...
Next.js 15 (static export, `output: "export"`) · React 19 · Tiptap 3 · Tailwind 4 · IndexedDB via `idb` · zod for schema validation · `docx` for export. Build output is a folder of static files — that is the entire deployment artefact. See [`docs/ARCHITECTURE.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/ARCHITECTURE.md).
...
1. [`docs/VISION.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/VISION.md) — what xnovelist is, who it's for, what it isn't
2. [`docs/PRINCIPLES.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/PRINCIPLES.md) — the design invariants
3. [`docs/ARCHITECTURE.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/ARCHITECTURE.md) — tech stack, folder structure, module boundaries, i18n
4. [`docs/STORAGE.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/STORAGE.md) — IndexedDB, schemas, migration, export
5. [`docs/EDITOR.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/EDITOR.md) — the writing experience without AI
6. [`docs/STORY_BIBLE.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/STORY_BIBLE.md) — characters, locations, style, continuity
7. [`docs/AI.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/AI.md) — the general AI design: the level model, BYOAI matrix, the proposer/harness split, prompt architecture, guardrails, privacy
8. [`docs/AI_LEVELS.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/AI_LEVELS.md) — the per-level tool catalogue (levels 0–5)
9. [`docs/ROADMAP.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/ROADMAP.md) — milestones and gates
10. [`docs/NON_GOALS.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/NON_GOALS.md) — explicit cuts, including the no-proxy commitment
...
![Thư viện tiểu thuyết cục bộ của bạn](https://github.com/giapnguyen74/xnovelist/blob/main/assets/01-novel-list-page.png)
...
![Khung soạn thảo với các thực thể Story Bible được tô sáng trong văn bản](https://github.com/giapnguyen74/xnovelist/blob/main/assets/03-character-highlight.png)
...
![Núm xoay cấp độ AI và thiết lập nhà cung cấp trong Cài đặt](https://github.com/giapnguyen74/xnovelist/blob/main/assets/02-ai-levels-setting.png)
...
![Bảng Agent đề xuất một thay đổi](https://github.com/giapnguyen74/xnovelist/blob/main/assets/04-agent-panel.png)

![Đối chiếu đề xuất của AI với văn của chính bạn](https://github.com/giapnguyen74/xnovelist/blob/main/assets/05-agent-panel2.png)
...
![Phác thảo và viết beat trực tiếp trong trình soạn thảo](https://github.com/giapnguyen74/xnovelist/blob/main/assets/06-beat-writting.png)
...
Nếu bạn muốn một "người viết thuê" dạng chat, một bộ cộng tác trên đám mây, hay công cụ viết kịch bản, thì xnovelist không phải sản phẩm dành cho bạn. Xem [`docs/NON_GOALS.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/NON_GOALS.md).
...
Next.js 15 (xuất tĩnh, `output: "export"`) · React 19 · Tiptap 3 · Tailwind 4 · IndexedDB qua `idb` · zod để kiểm tra schema · `docx` để xuất. Kết quả build là một thư mục tệp tĩnh — đó là toàn bộ sản phẩm triển khai. Xem [`docs/ARCHITECTURE.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/ARCHITECTURE.md).
...
1. [`docs/VISION.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/VISION.md) — xnovelist là gì, dành cho ai, không phải là gì
2. [`docs/PRINCIPLES.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/PRINCIPLES.md) — các nguyên tắc bất biến trong thiết kế
3. [`docs/ARCHITECTURE.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/ARCHITECTURE.md) — công nghệ, cấu trúc thư mục, ranh giới mô-đun, i18n
4. [`docs/STORAGE.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/STORAGE.md) — IndexedDB, schema, di trú, xuất
5. [`docs/EDITOR.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/EDITOR.md) — trải nghiệm viết khi không có AI
6. [`docs/STORY_BIBLE.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/STORY_BIBLE.md) — nhân vật, địa điểm, phong cách, mạch liên tục
7. [`docs/AI.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/AI.md) — thiết kế AI tổng quát: mô hình cấp độ, ma trận BYOAI, phân tách "đề xuất/khung điều phối", kiến trúc prompt, lan can an toàn, quyền riêng tư
8. [`docs/AI_LEVELS.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/AI_LEVELS.md) — danh mục công cụ theo từng cấp (cấp 0–5)
9. [`docs/ROADMAP.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/ROADMAP.md) — cột mốc và điều kiện
10. [`docs/NON_GOALS.md`](https://github.com/giapnguyen74/xnovelist/blob/main/docs/NON_GOALS.md) — những gì chủ động không làm, gồm cam kết không-proxy
