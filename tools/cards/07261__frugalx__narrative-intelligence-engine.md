...
area: 库
status: active
tags: [多Agent, 协议未明, 本地优先, 英文文档, 本地写作]
title: narrative-intelligence-engine
summary: 多 Agent 协作自动产文
source: https://github.com/frugalx/narrative-intelligence-engine
created: 2026-07-18
updated: 2026-07-18
no: 7261
category: 画龙补充 / 扩容入库 — 补充源
repo: frugalx/narrative-intelligence-engine
stars: 3
url: https://github.com/frugalx/narrative-intelligence-engine
tier: "B"
...
# frugalx/narrative-intelligence-engine

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/frugalx/narrative-intelligence-engine
- **Stars**：3
- **语言**：None
- **License**：None
- **Topics**：—
- **GitHub 描述**：A multi-agent, memory-driven AI system capable of planning and writing full-length books with human-level narrative coherence
- **本地描述**：narrative-intelligence-engine
- **拉取时间**：2026-07-25 19:15:54
