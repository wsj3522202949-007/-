...
source: https://github.com/jacqle331/copilot-prompts
created: 2026-07-18
updated: 2026-07-18
no: 499
category: 二、网文 / 长篇 AI 写作系统 库
repo: jacqle331/copilot-prompts
stars: 3
url: https://github.com/jacqle331/copilot-prompts
tier: "B"
...
content_hash: 2c6cd2dd255549bc
  - methods/最强写作方法论_全球最强综合版.md
---

# jacqle331/copilot-prompts

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/jacqle331/copilot-prompts
- **Stars**：3
- **语言**：None
- **License**：MIT
- **Topics**：ai, copilot, productivity, prompt-engineering, prompts
- **GitHub 描述**：✨ A community library of helpful, reusable AI prompts — for productivity, writing, research, and career growth. No coding required.
- **本地描述**：✨ A community library of helpful, reusable AI prompts — for productivity, writing, research, and career growth. No coding required.
- **拉取时间**：2026-07-23 22:53:37
...
![Prompts](https://img.shields.io/badge/prompts-35-blueviolet?style=for-the-badge)
...
1. Find a prompt in the categories below (or browse the [`prompts/`](https://github.com/jacqle331/copilot-prompts/blob/main/prompts) folder).
...
- [**Delegate a Task Cleanly**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/delegate-a-task-cleanly.md) — hand off work with clear context, expectations, deadline, and check-in points so it lands the first time

### ✍️ Writing & Communication
*Emails, posts, messaging, and presentations.*
- [**Write a LinkedIn Post**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/write-linkedin-post.md) — turn an idea or win into an engaging post in your voice
- [**Draft an Executive Summary or Status Recap**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/draft-exec-summary-recap.md) — turn details into a crisp, executive-ready update
- [**Write a Professional Email**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/write-professional-email.md) — draft clear, well-toned emails for any work situation
- [**Turn Notes into a Presentation Outline**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/notes-to-presentation-outline.md) — go from rough thoughts to a structured slide flow
- [**Rewrite for Tone & Clarity**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/rewrite-for-tone-clarity.md) — polish any message to be clearer, warmer, or more concise
- [**Difficult Message, Said Well**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/difficult-message-said-well.md) — draft sensitive or tough messages with empathy and tact
- [**Write a Persuasive Business Case**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/write-persuasive-business-case.md) — turn an idea or ask into a decision-ready, one-page case
- [**Say No Gracefully**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/say-no-gracefully.md) — decline a request or invite professionally while keeping the relationship warm
...
- [**Build a SWOT Analysis**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/build-swot-analysis.md) — turn a situation into strengths, weaknesses, opportunities, and threats with a clear recommendation
...
- [**Give Constructive Feedback That Lands**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/give-constructive-feedback.md) — prep specific, kind, actionable feedback using the Situation-Behavior-Impact structure

### 🎨 Creativity & Fun
*Lighter prompts for work and life — team building, celebration, and creative spark.*
- [**Plan a Team Icebreaker or Energizer**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/plan-team-icebreaker.md) — get inclusive, tailored icebreakers for any meeting or offsite
- [**Write a Team Celebration or Shout-Out**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/write-team-celebration-shoutout.md) — craft warm, specific recognition that doesn't sound generic
- [**Brainstorm Names for a Project or Program**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/brainstorm-project-names.md) — generate creative, on-theme name ideas with a top-3 pick
- [**Plan a Themed Team Event or Offsite**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/plan-themed-team-event.md) — design a fun, inclusive event with a theme, run-of-show, and activities
- [**Run a Team Retrospective (Fun Format)**](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/run-team-retrospective.md) — design an engaging retro with a theme, reflection prompts, and owned action items

## 🙌 Contributing

Got a prompt that works well? **Please share it!** 🎉

See [CONTRIBUTING.md](https://github.com/jacqle331/copilot-prompts/blob/main/CONTRIBUTING.md) for the quick steps, and use [`prompts/_TEMPLATE.md`](https://github.com/jacqle331/copilot-prompts/blob/main/prompts/_TEMPLATE.md) as your starting point. Every great prompt makes this library more useful for everyone.

## 📄 License

Released under the [MIT License](https://github.com/jacqle331/copilot-prompts/blob/main/LICENSE) — use these prompts freely.
