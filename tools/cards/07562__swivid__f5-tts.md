...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/swivid/f5-tts
- **Stars**：15001
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：Official code for "F5-TTS: A Fairytaler that Fakes Fluent and Faithful Speech with Flow Matching"
- **本地描述**：f5-tts
- **拉取时间**：2026-07-25 19:25:42
...
See [detailed instructions](https://github.com/swivid/f5-tts/blob/main/src/f5_tts/runtime/triton_trtllm/README.md) for more information.


## Inference

- In order to achieve desired performance, take a moment to read [detailed guidance](https://github.com/swivid/f5-tts/blob/main/src/f5_tts/infer).
...
Refer to [training & finetuning guidance](https://github.com/swivid/f5-tts/blob/main/src/f5_tts/train) for best practice.
...
Read [training & finetuning guidance](https://github.com/swivid/f5-tts/blob/main/src/f5_tts/train) for more instructions.


## [Evaluation](https://github.com/swivid/f5-tts/blob/main/src/f5_tts/eval)
