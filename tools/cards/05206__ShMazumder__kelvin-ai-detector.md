...
3. **Train model:**
   Run [export_model.py](https://github.com/ShMazumder/kelvin-ai-detector/blob/main/file:///Applications/XAMPP/xamppfiles/htdocs/kelvin-ai-detector/api/export_model.py):
