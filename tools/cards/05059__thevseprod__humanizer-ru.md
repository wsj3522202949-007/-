...
![humanizer-ru - убираем «запах ИИ» из текста, заточен под русский](https://github.com/thevseprod/humanizer-ru/blob/main/assets/banner.png)
...
![До и после humanizer-ru - один смысл без «запаха нейросети»](https://github.com/thevseprod/humanizer-ru/blob/main/assets/before-after.png)
...
- **Отдать файл агенту** - дай [`humanizer.ru.md`](https://github.com/thevseprod/humanizer-ru/blob/main/humanizer.ru.md) своему AI (Cursor, кастомный GPT и т.п.), он сам прочитает правила.
- **Скопировать в чат** - открой [`humanizer.ru.md`](https://github.com/thevseprod/humanizer-ru/blob/main/humanizer.ru.md) и вставь часть от `ЗАДАЧА` до конца первым сообщением.
...
| Файл | Что это |
|---|---|
| [`SKILL.md`](https://github.com/thevseprod/humanizer-ru/blob/main/SKILL.md) | Скилл для Claude Code и других агентов |
| [`humanizer.ru.md`](https://github.com/thevseprod/humanizer-ru/blob/main/humanizer.ru.md) | Правила для **русского** текста |
| [`humanizer.en.md`](https://github.com/thevseprod/humanizer-ru/blob/main/humanizer.en.md) | Правила для **английского** текста |
| `LICENSE` | MIT |
...
- **Hand the file to your agent** - give [`humanizer.en.md`](https://github.com/thevseprod/humanizer-ru/blob/main/humanizer.en.md) to your AI (Cursor, a custom GPT, etc.) and it reads the rules itself.
- **Copy into the chat** - open [`humanizer.en.md`](https://github.com/thevseprod/humanizer-ru/blob/main/humanizer.en.md) and paste the part from `TASK` to the end as your first message.
...
MIT, see [`LICENSE`](https://github.com/thevseprod/humanizer-ru/blob/main/LICENSE). Use it, fork it, ship it.
