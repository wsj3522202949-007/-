...
title: Plagiarism-Detector-AI
summary: 投稿前给正文降 AI 检测痕迹、改自然语气
source: https://github.com/lorem-ipsum-hackoverflow/plagiarism-detector-ai
created: 2026-07-18
updated: 2026-07-18
no: 5482
category: 一、去 AI 味 / Humanizer 库
repo: Lorem-Ipsum-hackoverflow/Plagiarism-Detector-AI
stars: 1
url: https://github.com/lorem-ipsum-hackoverflow/plagiarism-detector-ai
tier: "B"
...
content_hash: f59d049d45790616
  - methods/改稿润色指令库.md
---

# Lorem-Ipsum-hackoverflow/Plagiarism-Detector-AI

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/lorem-ipsum-hackoverflow/plagiarism-detector-ai
- **Stars**：1
- **语言**：HTML
- **License**：None
- **Topics**：—
- **GitHub 描述**：An AI tool which detects Plagiarism between two text files and displays the similarity between them(made exclusively for Hackoverflow 1.0)
- **本地描述**：An AI tool which detects Plagiarism between two text files and displays the similarity between them(made exclusively for Hackoverflow 1.0)
- **拉取时间**：2026-07-25 18:20:20
