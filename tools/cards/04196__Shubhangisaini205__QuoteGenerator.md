...
area: 库
status: active
tags: [JavaScript, 协议未明, 本地优先, 英文文档, 改稿润色, 本地写作]
title: QuoteGenerator
summary: 润色/改写/扩写等通用文本处理
source: https://github.com/shubhangisaini205/quotegenerator
created: 2026-07-18
updated: 2026-07-18
no: 4196
category: 十、其他 AI 写作 / 文本工具 库
repo: Shubhangisaini205/QuoteGenerator
stars: 3
url: https://github.com/shubhangisaini205/quotegenerator
tier: "B"
...
content_hash: 0002c2409fc7b8ed
  - methods/QUICK_START.md
---

# Shubhangisaini205/QuoteGenerator

- **分类**：十、其他 AI 写作 / 文本工具 库
- **链接**：https://github.com/shubhangisaini205/quotegenerator
- **Stars**：3
- **语言**：JavaScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：This  project, integrated with ChatGPT, utilizes advanced AI to generate personalized quotes, shayari, jokes, and stories based on user input and topic preferences.
- **本地描述**：This  project, integrated with ChatGPT, utilizes advanced AI to generate personalized quotes, shayari, jokes, and stories based on user input and topic preferences.
- **拉取时间**：2026-07-24 00:04:38
