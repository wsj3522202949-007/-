...
title: promptdc-chrome
summary: 错别字/语法/风格校对
source: https://github.com/pvisilias/promptdc-chrome
created: 2026-07-18
updated: 2026-07-18
no: 1672
category: 二、网文 / 长篇 AI 写作系统 库
repo: Pvisilias/promptdc-chrome
stars: 0
url: https://github.com/pvisilias/promptdc-chrome
tier: "C"
...
content_hash: 0f0da00232f226de
  - methods/最强写作方法论_全球最强综合版.md
---

# Pvisilias/promptdc-chrome

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/pvisilias/promptdc-chrome
- **Stars**：0
- **语言**：None
- **License**：MIT
- **Topics**：ai, ai-writing, ai-writing-assistant, chatgpt, chrome-extension, claude, coding-assistant, developer-tools, gemini, grammar-checker, grammarly-alternative, llm, productivity, prompt-engineering, prompt-enhancer, prompt-rewriter, writing-assistant
- **GitHub 描述**：AI prompt & writing assistant for Chrome — a Grammarly alternative that fixes grammar, emails & posts in every text box, plus a platform-aware prompt rewriter for AI code generation on ChatGPT, Claude, Lovable & 40+ sites.
- **本地描述**：AI prompt & writing assistant for Chrome — a Grammarly alternative that fixes grammar, emails & posts in every text box, plus a platform-aware prompt rewriter for AI code generation on ChatGPT, Claude, Lovable & 40+ sites.
- **拉取时间**：2026-07-23 23:27:48
...
-------- Chrome Web Store Description -------related:
  - methods/网文写作最强SOP.md
  - methods/最强写作方法论_全球最强综合版.md
related:
  - methods/网文写作最强SOP.md
