...
The application uses Google's Gemini 2.5 Flash model by default, configured in [config/settings.py](https://github.com/SakethramSathish/AI_Movie_Script_Generator/blob/main/config/settings.py).
