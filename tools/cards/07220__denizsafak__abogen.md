...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/denizsafak/abogen
- **Stars**：5348
- **语言**：Python
- **License**：MIT
...
- **GitHub 描述**：Generate audiobooks from EPUBs, PDFs and text with synchronized captions.
- **本地描述**：abogen
- **拉取时间**：2026-07-25 19:14:33
