...
area: 库
status: active
tags: [JavaScript, 协议传染, 需API密钥, 英文文档]
title: indesign-scripts
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/civicsparkmedia/indesign-scripts
created: 2026-07-18
updated: 2026-07-18
no: 7190
category: 画龙补充 / 扩容入库 — 补充源
repo: civicsparkmedia/indesign-scripts
stars: 2
url: https://github.com/civicsparkmedia/indesign-scripts
tier: "B"
...
content_hash: c1f330c9de2ba494
  - methods/QUICK_START.md
---

# civicsparkmedia/indesign-scripts

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/civicsparkmedia/indesign-scripts
- **Stars**：2
- **语言**：JavaScript
- **License**：GPL-3.0
- **Topics**：—
- **GitHub 描述**：Adobe InDesign scripts to automate various things
- **本地描述**：indesign-scripts
- **拉取时间**：2026-07-25 19:13:35
