...
source: https://github.com/zhao-yangyang/autonovel
created: 2026-07-18
updated: 2026-07-18
no: 7650
category: 画龙补充 / 扩容入库 — 补充源
repo: zhao-yangyang/autonovel
stars: 0
url: https://github.com/zhao-yangyang/autonovel
tier: "C"
...
content_hash: 7a2a18b3a6228d97
  - methods/QUICK_START.md
---

# zhao-yangyang/autonovel

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/zhao-yangyang/autonovel
- **Stars**：0
- **语言**：None
- **License**：None
- **Topics**：—
- **GitHub 描述**：An autonomous novel writing pipeline, by Hermes Agent
- **本地描述**：autonovel
- **拉取时间**：2026-07-25 19:28:54
...
See [PIPELINE.md](https://github.com/zhao-yangyang/autonovel/blob/main/PIPELINE.md) for the full technical specification.
