...
area: 库
status: active
tags: [Jupyter Notebook, 协议宽松, 需API密钥, 英文文档, 大纲规划]
title: gptauthor
summary: 搭大纲/分卷/节拍
source: https://github.com/dylanhogg/gptauthor
created: 2026-07-18
updated: 2026-07-18
no: 1181
category: 二、网文 / 长篇 AI 写作系统 库
repo: dylanhogg/gptauthor
stars: 110
...
- **链接**：https://github.com/dylanhogg/gptauthor
- **Stars**：110
- **语言**：Jupyter Notebook
- **License**：MIT
- **Topics**：artificial-intelligence, author, chatgpt, fiction, fiction-book, llm, novel-writing, screenplay, spec-driven, storytelling, writer, writing-software
- **GitHub 描述**：GPTAuthor is an AI tool for writing long form, multi-chapter stories given a story prompt.
- **本地描述**：GPTAuthor is an AI tool for writing long form, multi-chapter stories given a story prompt.
- **拉取时间**：2026-07-23 23:13:28
