...
related:
  ...
  - methods/最强写作方法论_全球最强综合版.md
---|
| [ls-multi-collector](https://github.com/FrankL1u/liusir-skills/blob/main/skills/ls-multi-collector) | Collect Douyin, YouTube, WeChat, X, and generic web content into local bundles with video download, transcript, and article-fetch workflows |
| [ls-wechat-article](https://github.com/FrankL1u/liusir-skills/blob/main/skills/ls-wechat-article) | Write and publish WeChat Official Account articles end-to-end — topic intake, drafting, SEO polish, cover and inline images, theme preview, draft publish, stats backfill, and learning workflows |
| [ls-xhs-note](https://github.com/FrankL1u/liusir-skills/blob/main/skills/ls-xhs-note) | Create Xiaohongshu note assets end-to-end — topic intake, source article drafting, native note writing, visual planning, and image generation |
...
See the setup guides in [skills/ls-multi-collector/README.md](https://github.com/FrankL1u/liusir-skills/blob/main/skills/ls-multi-collector/README.md), [skills/ls-wechat-article/README.md](https://github.com/FrankL1u/liusir-skills/blob/main/skills/ls-wechat-article/README.md), and [skills/ls-xhs-note/README.md](https://github.com/FrankL1u/liusir-skills/blob/main/skills/ls-xhs-note/README.md).
