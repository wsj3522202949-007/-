...
source: https://github.com/dreamcobbler/fiction-dl
created: 2026-07-18
updated: 2026-07-18
no: 7229
category: 画龙补充 / 扩容入库 — 补充源
repo: dreamcobbler/fiction-dl
stars: 52
url: https://github.com/dreamcobbler/fiction-dl
tier: "A"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/dreamcobbler/fiction-dl
- **Stars**：52
- **语言**：Python
- **License**：GPL-3.0
- **Topics**：downloader, downloading-stories, ebook, ebook-downloader, epub, fanfiction, fiction, fiction-dl, formatter, mobi, odt, pdf, scraper, scrapper
- **GitHub 描述**：A content downloader, capable of retrieving works of (fan)fiction from the web and saving them in a few common file formats.
- **本地描述**：fiction-dl
- **拉取时间**：2026-07-25 19:14:52
