...
area: 库
status: active
tags: [Claude插件, JavaScript, 协议宽松, 本地优先, 中文友好, 本地写作]
title: opencli
...
- **GitHub 描述**：Make Any Website into CLI & Use your logged-in browser by AI agent. 
- **本地描述**：opencli
- **拉取时间**：2026-07-25 19:17:54
...
If you want to add your own commands, start with the [Extending OpenCLI guide](https://github.com/jackwener/opencli/blob/main/docs/guide/extending-opencli.md). README keeps this short; the guide covers the directory layout, source-control model, and install commands.
...
**Skill references:**
- [`skills/opencli-browser/SKILL.md`](https://github.com/jackwener/opencli/blob/main/skills/opencli-browser/SKILL.md) — drive Chrome ad-hoc (navigate, fill forms, click, extract)
- [`skills/opencli-browser-sitemap/SKILL.md`](https://github.com/jackwener/opencli/blob/main/skills/opencli-browser-sitemap/SKILL.md) — use sitemap context while driving a browser task
- [`skills/opencli-sitemap-author/SKILL.md`](https://github.com/jackwener/opencli/blob/main/skills/opencli-sitemap-author/SKILL.md) — create or update site sitemap knowledge
- [`skills/opencli-adapter-author/SKILL.md`](https://github.com/jackwener/opencli/blob/main/skills/opencli-adapter-author/SKILL.md) — write a new adapter end-to-end
- [`skills/opencli-autofix/SKILL.md`](https://github.com/jackwener/opencli/blob/main/skills/opencli-autofix/SKILL.md) — repair broken adapters
- [`skills/opencli-usage/SKILL.md`](https://github.com/jackwener/opencli/blob/main/skills/opencli-usage/SKILL.md) — command and site reference
...
Curated highlights — **[→ see all 100+ supported sites & commands](https://github.com/jackwener/opencli/blob/main/docs/adapters/index.md)** (douyin / weibo / spotify / 1688 / quark / nowcoder / google-scholar / hupu / xianyu / weread / weread-official / xiaoyuzhou / Chess.com / and more).
...
**Desktop app adapters** (Electron, via CDP): Cursor / Trae CN / Codex / Antigravity / ChatGPT App / ChatWise / Qoder / Discord / Doubao / Trae SOLO — see [`docs/adapters/desktop/`](https://github.com/jackwener/opencli/tree/main/docs/adapters/desktop/).
...
opencli follows Unix `sysexits.h` so CI / scripts can branch on failure mode: `0` success, `66` empty result, `69` Browser Bridge down, `75` timeout, `77` auth required, `78` config error, `130` Ctrl-C. Full reference: [docs/guide/exit-codes.md](https://github.com/jackwener/opencli/blob/main/docs/guide/exit-codes.md).
...
See [Plugins Guide](https://github.com/jackwener/opencli/blob/main/docs/guide/plugins.md) for creating your own plugin.

## Testing

See **[TESTING.md](https://github.com/jackwener/opencli/blob/main/TESTING.md)** for how to run and write tests.
...
[Apache-2.0](https://github.com/jackwener/opencli/blob/main/LICENSE)
