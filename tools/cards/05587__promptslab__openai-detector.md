...
source: https://github.com/promptslab/openai-detector
created: 2026-07-18
updated: 2026-07-18
no: 5587
category: 一、去 AI 味 / Humanizer 库
repo: promptslab/openai-detector
stars: 137
...
- **链接**：https://github.com/promptslab/openai-detector
- **Stars**：137
- **语言**：Python
- **License**：Apache-2.0
- **Topics**：chatgpt, chatgpt-detector, detector, gpt, gpt-2, gpt-3, gpt-detector, llm, openai, openai-api, prompt-engineering
- **GitHub 描述**：AI classifier for indicating AI-written text
- **本地描述**：AI classifier for indicating AI-written text
- **拉取时间**：2026-07-25 18:24:13
