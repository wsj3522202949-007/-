...
title: wuxiaworld-2-ebook
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/makeyourlifeeasier/wuxiaworld-2-ebook
created: 2026-07-18
updated: 2026-07-18
no: 7406
category: 画龙补充 / 扩容入库 — 补充源
repo: makeyourlifeeasier/wuxiaworld-2-ebook
stars: 92
url: https://github.com/makeyourlifeeasier/wuxiaworld-2-ebook
tier: "A"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/makeyourlifeeasier/wuxiaworld-2-ebook
- **Stars**：92
- **语言**：Python
- **License**：MIT
- **Topics**：ebook, ebook-downloader, epub, python, python-3-6, webnovel, webscraper, wuxiaworld
- **GitHub 描述**：This Python script will download chapters from novels availaible on wuxiaworld.com saves then into the .epub format
- **本地描述**：wuxiaworld-2-ebook
- **拉取时间**：2026-07-25 19:20:55
