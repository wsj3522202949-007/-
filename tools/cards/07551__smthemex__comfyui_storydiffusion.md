...
summary: 风格微调/文风迁移
source: https://github.com/smthemex/comfyui_storydiffusion
created: 2026-07-18
updated: 2026-07-18
no: 7551
category: 画龙补充 / 扩容入库 — 补充源
repo: smthemex/comfyui_storydiffusion
stars: 510
url: https://github.com/smthemex/comfyui_storydiffusion
tier: "S"
use_case: "风格微调/文风迁移"
pitfalls: []
related:
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/smthemex/comfyui_storydiffusion
- **Stars**：510
- **语言**：Python
- **License**：Apache-2.0
- **Topics**：—
- **GitHub 描述**：You can using StoryDiffusion in ComfyUI 
- **本地描述**：comfyui_storydiffusion
- **拉取时间**：2026-07-25 19:25:22
