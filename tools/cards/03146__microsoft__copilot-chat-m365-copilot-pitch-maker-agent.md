...
title: copilot-chat-m365-copilot-pitch-maker-agent
summary: 风格微调/文风迁移
source: https://github.com/microsoft/copilot-chat-m365-copilot-pitch-maker-agent
created: 2026-07-18
updated: 2026-07-18
no: 3146
category: 六、多 Agent 小说生产 / 叙事引擎 库
repo: microsoft/copilot-chat-m365-copilot-pitch-maker-agent
stars: 6
url: https://github.com/microsoft/copilot-chat-m365-copilot-pitch-maker-agent
tier: "B"
use_case: "风格微调/文风迁移"
pitfalls: []
related:
...
# microsoft/copilot-chat-m365-copilot-pitch-maker-agent

- **分类**：六、多 Agent 小说生产 / 叙事引擎 库
- **链接**：https://github.com/microsoft/copilot-chat-m365-copilot-pitch-maker-agent
- **Stars**：6
- **语言**：None
- **License**：MIT
- **Topics**：copilot-chat, copilotstudio, m365-copilot, partner-tech
- **GitHub 描述**：AI pitch generator for Microsoft partners: from free Copilot Chat signals to executive-ready M365 Copilot value stories.
- **本地描述**：AI pitch generator for Microsoft partners: from free Copilot Chat signals to executive-ready M365 Copilot value stories.
- **拉取时间**：2026-07-23 23:50:54
...
![Example output from the Copilot Chat to M365 Copilot Pitch Maker Agent (BETA)](https://github.com/microsoft/copilot-chat-m365-copilot-pitch-maker-agent/blob/main/Media/Output.png)
...
For setup, deployment, and execution details, see the [run guide](https://github.com/microsoft/copilot-chat-m365-copilot-pitch-maker-agent/blob/main/RUN.MD).
