...
title: story-generator-application
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/piyushraj714/story-generator-application
created: 2026-07-18
updated: 2026-07-18
no: 992
category: 二、网文 / 长篇 AI 写作系统 库
repo: PiyushRaj714/story-generator-application
stars: 3
url: https://github.com/piyushraj714/story-generator-application
tier: "B"
...
# PiyushRaj714/story-generator-application

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/piyushraj714/story-generator-application
- **Stars**：3
- **语言**：Python
- **License**：MIT
- **Topics**：ai, python-project, python3, story-generation
- **GitHub 描述**：Story generator application implemented in Python.
- **本地描述**：Story generator application implemented in Python.
- **拉取时间**：2026-07-23 23:07:58
