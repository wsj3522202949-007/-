...
* (Oct 2023) We have added a new setting to utilize the ShareGPT corpus in retrieval-based detection experiments. In [`dipper_paraphrases/detect_retrieval.py`](https://github.com/srinivasvssj/ai-detection-paraphrases/blob/master/dipper_paraphrases/detect_retrieval.py), use the flag `--retrieval_corpus sharegpt`.
...
This is all documented in our minimal sample script to run DIPPER, [`dipper_paraphrases/paraphrase_minimal.py`](https://github.com/srinivasvssj/ai-detection-paraphrases/blob/master/dipper_paraphrases/paraphrase_minimal.py), and also in footnote 6 in our [paper](https://arxiv.org/pdf/2303.13408.pdf).
...
Use the scripts [`dipper_paraphrases/generate_gpt2.py`](https://github.com/srinivasvssj/ai-detection-paraphrases/blob/master/dipper_paraphrases/generate_gpt3.py), or [`dipper_paraphrases/generate_gpt3.py`](https://github.com/srinivasvssj/ai-detection-paraphrases/blob/master/dipper_paraphrases/generate_gpt3.py), or [`dipper_paraphrases/generate_opt.py`](https://github.com/srinivasvssj/ai-detection-paraphrases/blob/master/dipper_paraphrases/generate_opt.py) as shown below,
...
Use the scripts [`dipper_paraphrases/paraphrase.py`](https://github.com/srinivasvssj/ai-detection-paraphrases/blob/master/dipper_paraphrases/paraphrase.py) as shown below,
