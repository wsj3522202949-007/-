...
title: Tomislav-Sola_ai-slop-detector
summary: 长篇设定/人物一致性（RAG 记忆）
source: https://github.com/actions-marketplace-validations/tomislav-sola_ai-slop-detector
created: 2026-07-18
updated: 2026-07-18
no: 5149
category: 一、去 AI 味 / Humanizer 库
repo: actions-marketplace-validations/Tomislav-Sola_ai-slop-detector
stars: 0
url: https://github.com/actions-marketplace-validations/tomislav-sola_ai-slop-detector
tier: "C"
...
content_hash: e2ca4958a539dd7d
  - methods/改稿润色指令库.md
---

# actions-marketplace-validations/Tomislav-Sola_ai-slop-detector

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/actions-marketplace-validations/tomislav-sola_ai-slop-detector
- **Stars**：0
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：—
- **本地描述**：actions-marketplace-validations/Tomislav-Sola_ai-slop-detector
- **拉取时间**：2026-07-25 18:07:56
...
![Example slop comment as posted on a smoke-test PR](https://github.com/actions-marketplace-validations/Tomislav-Sola_ai-slop-detector/blob/main/docs/images/slop_comment.png)
...
See [CONTRIBUTING.md](https://github.com/actions-marketplace-validations/Tomislav-Sola_ai-slop-detector/blob/main/CONTRIBUTING.md) for local setup, how to run the eval, how to propose a new golden-set fixture, and the conventional-commit style this repo uses.

## License

MIT — see [LICENSE](https://github.com/actions-marketplace-validations/Tomislav-Sola_ai-slop-detector/blob/main/LICENSE).
