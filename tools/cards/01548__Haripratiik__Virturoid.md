...
![Virturoid pipeline: from a prompt to a trained, buildable robot](https://github.com/Haripratiik/Virturoid/blob/main/assets/architecture.svg)

Every body below was generated from a one-line prompt by the same pipeline — no per-species templates:

![Robots generated from prompts: a manipulator, quadruped, hexapod, mobile base, humanoid, and octopod](https://github.com/Haripratiik/Virturoid/blob/main/assets/robot_gallery.png)
...
![Each task generates its own scene, sized to the robot: sort, stack, push, lift, navigate, maze](https://github.com/Haripratiik/Virturoid/blob/main/assets/scene_generation.png)
...
Released under the MIT License. See [LICENSE](https://github.com/Haripratiik/Virturoid/blob/main/LICENSE).
