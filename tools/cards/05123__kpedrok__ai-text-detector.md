...
See [ROADMAP.md](https://github.com/kpedrok/ai-text-detector/blob/main/ROADMAP.md) for planned hardening, deployment, and product work.

## Learning

New to ML? Two resources, both written for a TypeScript developer:

- **🕹️ Interactive course** — [`learn-site/index.html`](https://github.com/kpedrok/ai-text-detector/blob/main/learn-site/index.html):
...
- **📖 Deep dive** — [LEARN.md](https://github.com/kpedrok/ai-text-detector/blob/main/LEARN.md): the same concepts in prose, from
