...
source: https://github.com/openwebgal/webgal
created: 2026-07-18
updated: 2026-07-18
no: 7478
category: 画龙补充 / 扩容入库 — 补充源
repo: openwebgal/webgal
stars: 3895
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/openwebgal/webgal
- **Stars**：3895
- **语言**：TypeScript
- **License**：MPL-2.0
- **Topics**：diy-tool, galgame, game, javascript, react, typescript, visual-novel, visual-novel-engine
- **GitHub 描述**：A brand new web Visual Novel engine | 全新的网页端视觉小说引擎
- **本地描述**：webgal
- **拉取时间**：2026-07-25 19:23:07
