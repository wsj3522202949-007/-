...
source: https://github.com/benpollarduk/ktvn
created: 2026-07-18
updated: 2026-07-18
$14
category: 二、网文 / 长篇 AI 写作系统 库
repo: benpollarduk/ktvn
stars: 20
language: Kotlin
license: MIT
url: https://github.com/benpollarduk/ktvn
tier: "B"
...
Example visual novels are provided in the [ktvn-exmples](ktvn-examples/src/main/kotlin/com/github/benpollarduk/ktvn/examples) directory 
...
![ktvn-sequencing-overview-components.png](https://github.com/benpollarduk/ktvn/blob/main/docs%2Foverview%2Fktvn-sequencing-overview-components.png)

The following sequence diagram shows the sequence of starting a game and a character speaking then asking a question:

![ktvn-sequencing-overview.png](https://github.com/benpollarduk/ktvn/blob/main/docs%2Foverview%2Fktvn-sequencing-overview.png)
