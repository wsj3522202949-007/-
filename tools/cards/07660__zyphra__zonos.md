...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/zyphra/zonos
- **Stars**：7234
- **语言**：Python
- **License**：Apache-2.0
- **Topics**：—
- **GitHub 描述**：Zonos-v0.1 is a leading open-weight text-to-speech model trained on more than 200k hours of varied multilingual speech, delivering expressiveness and quality on par with—or even surpassing—top TTS providers.
- **本地描述**：zonos
- **拉取时间**：2026-07-25 19:29:10
