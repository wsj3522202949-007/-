...
The detection rules are adapted from the stop-slop skill, used under the MIT License. See [LICENSE](https://github.com/Muntaha-Islam0019/slop-detector/blob/main/LICENSE).
