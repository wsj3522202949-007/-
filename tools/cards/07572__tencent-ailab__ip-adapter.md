...
- **License**：Apache-2.0
- **Topics**：—
- **GitHub 描述**：The image prompt adapter is designed to enable a pretrained text-to-image diffusion model to generate images with image prompt. 
- **本地描述**：ip-adapter
- **拉取时间**：2026-07-25 19:26:00
...
![arch](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/figs/fig1.png)
...
- [2023/11/10] 🔥 Add an updated version of IP-Adapter-Face. The demo is [here](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter-full-face_demo.ipynb).
- [2023/11/05] 🔥 Add text-to-image [demo](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter_t2i_demo.ipynb) with IP-Adapter and [Kandinsky 2.2 Prior](https://huggingface.co/kandinsky-community/kandinsky-2-2-prior)
...
- [2023/8/30] 🔥 Add an IP-Adapter with face image as prompt. The demo is [here](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter-plus-face_demo.ipynb).
- [2023/8/29] 🔥 Release the training code.
- [2023/8/23] 🔥 Add code and models of IP-Adapter with fine-grained features. The demo is [here](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter-plus_demo.ipynb).
- [2023/8/18] 🔥 Add code and models for [SDXL 1.0](https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0). The demo is [here](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter_sdxl_demo.ipynb).
...
- [**ip_adapter_demo**](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter_demo.ipynb): image variations, image-to-image, and inpainting with image prompt.
...
![image variations](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/demo/image_variations.jpg)

![image-to-image](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/demo/image-to-image.jpg)

![inpainting](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/demo/inpainting.jpg)

- [**ip_adapter_controlnet_demo**](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter_controlnet_demo_new.ipynb), [**ip_adapter_t2i-adapter**](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter_t2i-adapter_demo.ipynb): structural generation with image prompt.
...
![structural_cond](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/demo/structural_cond.jpg)
![structural_cond2](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/demo/t2i-adapter_demo.jpg)

- [**ip_adapter_multimodal_prompts_demo**](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter_multimodal_prompts_demo.ipynb): generation with multimodal prompts.
...
![multi_prompts](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/demo/multi_prompts.jpg)

- [**ip_adapter-plus_demo**](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter-plus_demo.ipynb): the demo of IP-Adapter with fine-grained features.

![ip_adpter_plus_image_variations](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/demo/ip_adpter_plus_image_variations.jpg)
![ip_adpter_plus_multi](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/demo/ip_adpter_plus_multi.jpg)

- [**ip_adapter-plus-face_demo**](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter-plus-face_demo.ipynb): generation with face image as prompt.

![ip_adpter_plus_face](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/demo/sd15_face.jpg)
...
![](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/demo/crop_and_resize_cmp.jpg)

### SDXL_1.0

- [**ip_adapter_sdxl_demo**](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter_sdxl_demo.ipynb): image variations with image prompt.
- [**ip_adapter_sdxl_controlnet_demo**](https://github.com/tencent-ailab/ip-adapter/blob/main/ip_adapter_sdxl_controlnet_demo.ipynb): structural generation with image prompt.

The comparison of **IP-Adapter_XL** with [Reimagine XL](https://clipdrop.co/stable-diffusion-reimagine) is shown as follows:

![sdxl_demo](https://github.com/tencent-ailab/ip-adapter/blob/main/assets/demo/sdxl_cmp.jpg)
