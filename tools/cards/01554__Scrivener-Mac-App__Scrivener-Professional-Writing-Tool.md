...
title: Scrivener-Professional-Writing-Tool
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/scrivener-mac-app/scrivener-professional-writing-tool
created: 2026-07-18
updated: 2026-07-18
no: 1554
category: 二、网文 / 长篇 AI 写作系统 库
repo: Scrivener-Mac-App/Scrivener-Professional-Writing-Tool
stars: 0
url: https://github.com/scrivener-mac-app/scrivener-professional-writing-tool
tier: "C"
...
content_hash: 1a13cdcc63e4c220
  - methods/最强写作方法论_全球最强综合版.md
---

# Scrivener-Mac-App/Scrivener-Professional-Writing-Tool

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/scrivener-mac-app/scrivener-professional-writing-tool
- **Stars**：0
- **语言**：None
- **License**：None
- **Topics**：—
- **GitHub 描述**：Scrivener professional writing tool helps you structure and write complex documents with ease. From novels and screenplays to research papers, Scrivener offers outlining, editing, and composition modes that adapt to your creative workflow.
- **本地描述**：Scrivener professional writing tool helps you structure and write complex documents with ease. From novels and screenplays to research papers, Scrivener offers outlining, editing, and composition modes that adapt to your creative workflow.
- **拉取时间**：2026-07-23 23:24:24
