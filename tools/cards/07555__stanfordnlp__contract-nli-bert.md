...
title: contract-nli-bert
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/stanfordnlp/contract-nli-bert
created: 2026-07-18
updated: 2026-07-18
no: 7555
category: 画龙补充 / 扩容入库 — 补充源
repo: stanfordnlp/contract-nli-bert
stars: 38
url: https://github.com/stanfordnlp/contract-nli-bert
tier: "B"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/stanfordnlp/contract-nli-bert
- **Stars**：38
- **语言**：Python
- **License**：Apache-2.0
- **Topics**：—
- **GitHub 描述**：A baseline system for ContractNLI (https://stanfordnlp.github.io/contract-nli/)
- **本地描述**：contract-nli-bert
- **拉取时间**：2026-07-25 19:25:29
...
Please refer attached "[LICENSE](https://github.com/stanfordnlp/contract-nli-bert/blob/main/LICENSE)" for the exact terms.
