...
area: 库
status: active
tags: [去AI味, Claude插件, 协议未明, 本地优先, 英文文档, 本地写作]
title: claude-humanizer
summary: 投稿前文本降 AI 痕、过检测
source: https://github.com/abnahid/claude-humanizer
created: 2026-07-18
updated: 2026-07-18
no: 5688
category: 一、去 AI 味 / Humanizer 库
repo: abnahid/claude-humanizer
stars: 0
url: https://github.com/abnahid/claude-humanizer
tier: "C"
...
content_hash: 913a4093b681f3e7
  - methods/改稿润色指令库.md
---

# abnahid/claude-humanizer

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/abnahid/claude-humanizer
- **Stars**：0
- **语言**：None
- **License**：None
- **Topics**：—
- **GitHub 描述**：Rewrites AI-generated text so it reads like natural human writing. The skill removes typical AI patterns such as repetitive phrasing, robotic tone, overly structured sentences, and predictable wording
- **本地描述**：Rewrites AI-generated text so it reads like natural human writing. The skill removes typical AI patterns such as repetitive phrasing, robotic tone, overly structured sentences, and predictable wording
- **拉取时间**：2026-07-25 18:27:57
