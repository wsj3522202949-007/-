...
Full API documentation is available in [news-copilot-backend/README.md](https://github.com/tnowad/news-copilot-reader/blob/main/news-copilot-backend/README.md).
