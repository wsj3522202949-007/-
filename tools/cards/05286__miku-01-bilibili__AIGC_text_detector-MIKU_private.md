...
title: AIGC_text_detector-MIKU_private
summary: 投稿前给正文降 AI 检测痕迹、改自然语气
source: https://github.com/miku-01-bilibili/aigc_text_detector-miku_private
created: 2026-07-18
updated: 2026-07-18
no: 5286
category: 一、去 AI 味 / Humanizer 库
repo: miku-01-bilibili/AIGC_text_detector-MIKU_private
stars: 5
url: https://github.com/miku-01-bilibili/aigc_text_detector-miku_private
tier: "B"
...
content_hash: 9d7359872f9b074d
  - methods/改稿润色指令库.md
---

# miku-01-bilibili/AIGC_text_detector-MIKU_private

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/miku-01-bilibili/aigc_text_detector-miku_private
- **Stars**：5
- **语言**：Python
- **License**：Apache-2.0
- **Topics**：—
- **GitHub 描述**：AI生成文本检测工具（自用，含生成文章段落AI使用l率、定位高风险文段）
- **本地描述**：AI生成文本检测工具（自用，含生成文章段落AI使用l率、定位高风险文段）
- **拉取时间**：2026-07-25 18:12:58
