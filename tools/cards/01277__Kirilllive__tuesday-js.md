...
source: https://github.com/kirilllive/tuesday-js
created: 2026-07-18
updated: 2026-07-18
no: 1277
category: 二、网文 / 长篇 AI 写作系统 库
repo: Kirilllive/tuesday-js
stars: 671
url: https://github.com/kirilllive/tuesday-js
tier: "S"
...
- **链接**：https://github.com/kirilllive/tuesday-js
- **Stars**：671
- **语言**：HTML
- **License**：Apache-2.0
- **Topics**：adventure-game-engine, creative-writing, edutainment, interactive-fiction, interactive-storytelling, literate-programming, long-read, nocode, screenplay, single-page-applications, storytelling, visual-novel, visual-novel-editor, visual-novel-engine, visual-novel-maker, visual-novels, web-based-application, web-based-game, web-editor
- **GitHub 描述**：simple web-based, free and open-source visual novel editor that can be used in a web browser. It is written in JavaScript without using any third party libraries and thus does not require additional software installation. The engine uses standard HTML document elements such as div and img.
- **本地描述**：simple web-based, free and open-source visual novel editor that can be used in a web browser. It is written in JavaScript without using any third party libraries and thus does not require additional software installation. The engine uses standard HTML document elements such as div and img.
- **拉取时间**：2026-07-23 23:16:19
