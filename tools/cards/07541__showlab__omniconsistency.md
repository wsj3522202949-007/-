...
summary: 风格微调/文风迁移
source: https://github.com/showlab/omniconsistency
created: 2026-07-18
updated: 2026-07-18
no: 7541
category: 画龙补充 / 扩容入库 — 补充源
repo: showlab/omniconsistency
stars: 423
url: https://github.com/showlab/omniconsistency
tier: "S"
use_case: "风格微调/文风迁移"
pitfalls:
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/showlab/omniconsistency
- **Stars**：423
- **语言**：Python
- **License**：None
- **Topics**：—
- **GitHub 描述**：The official code implementation of the paper "OmniConsistency: Learning Style-Agnostic Consistency from Paired Stylization Data."
- **本地描述**：omniconsistency
- **拉取时间**：2026-07-25 19:25:04
