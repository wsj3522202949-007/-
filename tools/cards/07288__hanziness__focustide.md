...
area: 库
status: active
tags: [Vue, 协议宽松, 本地优先, 英文文档, 本地写作]
title: focustide
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/hanziness/focustide
created: 2026-07-18
updated: 2026-07-18
no: 7288
category: 画龙补充 / 扩容入库 — 补充源
repo: hanziness/focustide
stars: 401
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/hanziness/focustide
- **Stars**：401
- **语言**：Vue
- **License**：MIT
- **Topics**：focus, free, nuxt, pomodoro, pomodoro-timer, productivity, productivity-tool, pwa, schedule, static-site, timers, tomato-timer, vue, vuejs, web
- **GitHub 描述**：Modern and customizable productivity timer app that runs in your browser.
- **本地描述**：focustide
- **拉取时间**：2026-07-25 19:16:44
...
![Screenshot of the application showing a work section.](https://github.com/hanziness/focustide/blob/main/public/assets/img/ProductImg_Default.png)
...
## 🖼 More screenshots
![The display section of the settings panel](https://github.com/hanziness/focustide/blob/main/public/assets/img/ProductImg_Settings.png)

![The traditional timer with the to-do panel open](https://github.com/hanziness/focustide/blob/main/public/assets/img/ProductImg_TodoOpen.png)
## 🏗 If you're a developer

This is an open-source project that welcomes contributions. Please check the [**contribution guidelines**](https://github.com/hanziness/focustide/blob/main/CONTRIBUTING.md) before opening issues, discussions or pull requests!
