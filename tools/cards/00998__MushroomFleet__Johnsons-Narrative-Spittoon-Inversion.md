...
area: 库
status: active
tags: [Mermaid, 协议未明, 本地优先, 英文文档, 大纲规划, 多Agent, 本地写作, 灵感创意]
title: Johnsons-Narrative-Spittoon-Inversion
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/mushroomfleet/johnsons-narrative-spittoon-inversion
created: 2026-07-18
updated: 2026-07-18
no: 998
category: 二、网文 / 长篇 AI 写作系统 库
repo: MushroomFleet/Johnsons-Narrative-Spittoon-Inversion
stars: 8
...
- **链接**：https://github.com/mushroomfleet/johnsons-narrative-spittoon-inversion
- **Stars**：8
- **语言**：Mermaid
- **License**：None
- **Topics**：agentic, ai-storytelling, cognitive-framework, creative-writing, generation, generative-ai, llm, narrative, narrative-generation, prompt-engineering, story-generation, text-generation, writers, writing
- **GitHub 描述**：Novel LLM narrative generation framework — structured story creation using cognitive inversion & deep-thinking models
- **本地描述**：Novel LLM narrative generation framework — structured story creation using cognitive inversion & deep-thinking models
- **拉取时间**：2026-07-23 23:08:08
