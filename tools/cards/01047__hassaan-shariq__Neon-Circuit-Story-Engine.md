...
title: Neon-Circuit-Story-Engine
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/hassaan-shariq/neon-circuit-story-engine
created: 2026-07-18
updated: 2026-07-18
no: 1047
category: 二、网文 / 长篇 AI 写作系统 库
repo: hassaan-shariq/Neon-Circuit-Story-Engine
stars: 1
url: https://github.com/hassaan-shariq/neon-circuit-story-engine
tier: "B"
...
# hassaan-shariq/Neon-Circuit-Story-Engine

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/hassaan-shariq/neon-circuit-story-engine
- **Stars**：1
- **语言**：Python
- **License**：None
- **Topics**：—
- **GitHub 描述**：AI-powered story generator set in the Neon Circuit               universe. Built with Python, Streamlit, and Groq API.
- **本地描述**：AI-powered story generator set in the Neon Circuit               universe. Built with Python, Streamlit, and Groq API.
- **拉取时间**：2026-07-23 23:09:32
...
![Neon Circuit Story Engine](https://github.com/hassaan-shariq/Neon-Circuit-Story-Engine/blob/main/screenshot.png)
