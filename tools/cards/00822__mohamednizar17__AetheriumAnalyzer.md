...
title: AetheriumAnalyzer
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/mohamednizar17/aetheriumanalyzer
created: 2026-07-18
updated: 2026-07-18
no: 822
category: 二、网文 / 长篇 AI 写作系统 库
repo: mohamednizar17/AetheriumAnalyzer
stars: 0
url: https://github.com/mohamednizar17/aetheriumanalyzer
tier: "C"
...
content_hash: 3effc8ed9d55bcf4
  - methods/最强写作方法论_全球最强综合版.md
---

# mohamednizar17/AetheriumAnalyzer

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/mohamednizar17/aetheriumanalyzer
- **Stars**：0
- **语言**：HTML
- **License**：None
- **Topics**：—
- **GitHub 描述**：A user-friendly AI tool that scores your script from 0 to 100 and offers tips to improve plot, characters, dialogue, and more. Paste or upload your script, chat with our assistant, and polish your story with ease!
- **本地描述**：A user-friendly AI tool that scores your script from 0 to 100 and offers tips to improve plot, characters, dialogue, and more. Paste or upload your script, chat with our assistant, and polish your story with ease!
- **拉取时间**：2026-07-23 23:03:01
