...
title: Keywordo-kun-AI-SEO-Agent-n8n-Workflow
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/agricidaniel/keywordo-kun-ai-seo-agent-n8n-workflow
created: 2026-07-18
updated: 2026-07-18
no: 1675
category: 二、网文 / 长篇 AI 写作系统 库
repo: AgriciDaniel/Keywordo-kun-AI-SEO-Agent-n8n-Workflow
stars: 70
url: https://github.com/agricidaniel/keywordo-kun-ai-seo-agent-n8n-workflow
tier: "A"
...
- **链接**：https://github.com/agricidaniel/keywordo-kun-ai-seo-agent-n8n-workflow
- **Stars**：70
- **语言**：None
- **License**：MIT
- **Topics**：ai, automation, marketing-automation, n8n, open-source, workflow
...
![Keywordo-kun Hero Image](https://github.com/AgriciDaniel/Keywordo-kun-AI-SEO-Agent-n8n-Workflow/blob/main/Keywordo-kun%20image.png)
...
2.  **Configure Tools Workflow:**
    * Open the "Tools" workflow and configure each HTTP Request node with your **DataForSEO** API credentials, as shown in the [video guide](https://github.com/AgriciDaniel/Keywordo-kun-AI-SEO-Agent-n8n-Workflow/blob/main/[https://www.youtube.com/watch?v=r9WMbzfY-mg&t]).
...
4.  **Deploy Frontend:**
    ...
    * In the v0.dev chat prompt, ask it to replace the old webhook URL with your new one, as shown in the [video guide](https://github.com/AgriciDaniel/Keywordo-kun-AI-SEO-Agent-n8n-Workflow/blob/main/[https://www.youtube.com/watch?v=r9WMbzfY-mg&t]).
5.  **Activate & Test:**
