...
source: https://github.com/kentwaredemo/prompt-optimizer
created: 2026-07-18
updated: 2026-07-18
no: 297
category: 二、网文 / 长篇 AI 写作系统 库
repo: KentwareDemo/prompt-optimizer
stars: 0
url: https://github.com/kentwaredemo/prompt-optimizer
tier: "C"
...
content_hash: 4f7482cbaccde419
  - methods/最强写作方法论_全球最强综合版.md
---

# KentwareDemo/prompt-optimizer

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/kentwaredemo/prompt-optimizer
- **Stars**：0
- **语言**：TypeScript
- **License**：NOASSERTION
- **Topics**：—
...
[English](https://github.com/KentwareDemo/prompt-optimizer/blob/main/README.md) | [中文](https://github.com/KentwareDemo/prompt-optimizer/blob/main/README.zh-CN.md)
...
[Development Docs](https://github.com/KentwareDemo/prompt-optimizer/blob/main/dev.md) | [Vercel Deployment Guide](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/user/deployment/vercel_en.md) | [MCP Deployment Guide](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/user/mcp-server_en.md) | [DeepWiki Docs](https://deepwiki.com/linshenkx/prompt-optimizer) | [ZRead Docs](https://zread.ai/linshenkx/prompt-optimizer)
...
For detailed usage instructions, please refer to the [Image Mode Documentation](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/image-mode.md)
...
- [Vercel Deployment Guide](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/user/deployment/vercel_en.md)
...
For more detailed information, please refer to the [MCP Server User Guide](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/user/mcp-server_en.md).
</details>
...
For more detailed information about `llmParams` configuration, please refer to the [LLM Parameters Configuration Guide](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/developer/llm-params-guide.md).
...
> 📖 **Detailed Configuration Guide**: See [Multiple Custom Models Documentation](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/user/multi-custom-models_en.md) for complete configuration methods and advanced usage

</details>

## Local Development
For detailed documentation, see [Development Documentation](https://github.com/KentwareDemo/prompt-optimizer/blob/main/dev.md)
...
For detailed project status, see [Project Status Document](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/project/project-status.md)

## 📖 Related Documentation

- [Documentation Index](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/README.md) - Index of all documentation
- [Technical Development Guide](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/developer/technical-development-guide.md) - Technology stack and development specifications
- [LLM Parameters Configuration Guide](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/developer/llm-params-guide.md) - Detailed guide for advanced LLM parameter configuration
- [Project Structure](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/developer/project-structure.md) - Detailed project structure description
- [Project Status](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/project/project-status.md) - Current progress and plans
- [Product Requirements](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/project/prd.md) - Product requirements document
- [Vercel Deployment Guide](https://github.com/KentwareDemo/prompt-optimizer/blob/main/docs/user/deployment/vercel_en.md) - Detailed instructions for Vercel deployment
...
This project is licensed under [AGPL-3.0](https://github.com/KentwareDemo/prompt-optimizer/blob/main/LICENSE).
