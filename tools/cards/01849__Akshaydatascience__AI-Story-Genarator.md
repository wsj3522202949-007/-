...
title: AI-Story-Genarator
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/akshaydatascience/ai-story-genarator
created: 2026-07-18
updated: 2026-07-18
no: 1849
category: 二、网文 / 长篇 AI 写作系统 库
repo: Akshaydatascience/AI-Story-Genarator
stars: 1
url: https://github.com/akshaydatascience/ai-story-genarator
tier: "B"
...
content_hash: 61930cb2ee605d4f
  - methods/最强写作方法论_全球最强综合版.md
---

# Akshaydatascience/AI-Story-Genarator

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/akshaydatascience/ai-story-genarator
- **Stars**：1
- **语言**：JavaScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：AI powered story generator and Education generator
- **本地描述**：AI powered story generator and Education generator
- **拉取时间**：2026-07-23 23:32:55
