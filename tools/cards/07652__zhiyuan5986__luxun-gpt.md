...
area: 库
status: active
tags: [文风迁移, 协议宽松, 本地优先, 中文友好, 改稿润色, 本地写作]
title: luxun-gpt
summary: 风格微调/文风迁移
source: https://github.com/zhiyuan5986/luxun-gpt
created: 2026-07-18
updated: 2026-07-18
no: 7652
category: 画龙补充 / 扩容入库 — 补充源
repo: zhiyuan5986/luxun-gpt
stars: 0
url: https://github.com/zhiyuan5986/luxun-gpt
tier: "C"
use_case: "风格微调/文风迁移"
pitfalls:
...
# zhiyuan5986/luxun-gpt

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/zhiyuan5986/luxun-gpt
- **Stars**：0
- **语言**：None
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：LLM with LuXun (鲁迅) style
- **本地描述**：luxun-gpt
- **拉取时间**：2026-07-25 19:28:58
...
该项目基于 MIT 许可证发布 - 有关详情，请参见 [LICENSE](https://github.com/zhiyuan5986/luxun-gpt/blob/main/LICENSE) 文件。
