...
area: 库
status: active
tags: [Jupyter Notebook, 协议宽松, 本地优先, 中文友好, 本地写作]
title: xunziap
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/huangbo2024/xunziap
created: 2026-07-18
updated: 2026-07-18
no: 7303
category: 画龙补充 / 扩容入库 — 补充源
repo: huangbo2024/xunziap
stars: 2
url: https://github.com/huangbo2024/xunziap
tier: "B"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/huangbo2024/xunziap
- **Stars**：2
- **语言**：Jupyter Notebook
- **License**：Apache-2.0
- **Topics**：—
- **GitHub 描述**：基于荀子大模型的古籍文本自动断句和标点。(Automatic Punctuation of ancient texts based on XunziChat)
- **本地描述**：xunziap
- **拉取时间**：2026-07-25 19:17:11
