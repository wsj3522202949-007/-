...
source: https://github.com/ydsgangge-ux/dramatica-flow
created: 2026-07-18
updated: 2026-07-18
no: 7626
...
stars: 183
url: https://github.com/ydsgangge-ux/dramatica-flow
tier: "A"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/ydsgangge-ux/dramatica-flow
- **Stars**：183
- **语言**：Python
- **License**：None
- **Topics**：ai-writing, creative-writing, deepseek, dramatica, fastapi, narrative-ai, novel-writing, story-generation
- **GitHub 描述**：深度集成 Dramatica 理论与 5 层 Agent 写作管线的下一代 AI 自动写小说引擎，支持因果链管理、多线叙事与伏笔追踪。A causal-driven AI novel creation system based on Dramatica theory, featuring a 5-layer Agent pipeline for deep narrative logic.
- **本地描述**：dramatica-flow
- **拉取时间**：2026-07-25 19:28:07
