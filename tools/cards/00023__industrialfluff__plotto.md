...
title: plotto
summary: 搭大纲/分卷/节拍
source: https://github.com/industrialfluff/plotto
created: 2026-07-18
updated: 2026-07-18
no: 23
category: 二、网文 / 长篇 AI 写作系统 库
repo: industrialfluff/plotto
stars: 2
url: https://github.com/industrialfluff/plotto
tier: "B"
use_case: "搭大纲/分卷/节拍"
pitfalls:
...
content_hash: 8d8f0f30e6fea92b
  - methods/最强写作方法论_全球最强综合版.md
---

# industrialfluff/plotto

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/industrialfluff/plotto
- **Stars**：2
- **语言**：Python
- **License**：None
- **Topics**：creative, fiction, generator, nanogenmo, nanowrimo, outline, plot, plotto, randomizer, storytelling, william-wallace-cook, writing-prompts
- **GitHub 描述**：Automatic Plotto Story Outline Random Generator
- **本地描述**：Automatic Plotto Story Outline Random Generator
- **拉取时间**：2026-07-23 22:39:32
