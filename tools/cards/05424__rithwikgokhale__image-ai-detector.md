...
For the full architecture see [ARCHITECTURE.md](https://github.com/rithwikgokhale/image-ai-detector/blob/main/ARCHITECTURE.md). For the build-out plan see [ROADMAP.md](https://github.com/rithwikgokhale/image-ai-detector/blob/main/ROADMAP.md).
...
MIT — see [LICENSE](https://github.com/rithwikgokhale/image-ai-detector/blob/main/LICENSE).
