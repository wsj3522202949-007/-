...
> **当前稳定版：** v0.4.3，与 `package.json` 保持一致；发行说明见 [RELEASE-NOTES-v0.4.3.md](https://github.com/FanyinLiu/Nexus/blob/main/docs/RELEASE-NOTES-v0.4.3.md)。正式安装包只由受保护的 tag 工作流发布到 GitHub Releases；更早历史统一放在 Releases。
...
更具体的执行拆分见 [Nexus 升级整合计划](https://github.com/FanyinLiu/Nexus/blob/main/docs/NEXUS_UPGRADE_INTEGRATION_PLAN.md)，可执行任务表见
[EXECUTABLE_OPTIMIZATION_TASKS](https://github.com/FanyinLiu/Nexus/blob/main/docs/EXECUTABLE_OPTIMIZATION_TASKS.md)。
...
> **主题：Check-In 策略和发布门禁对齐。** 中文说明见 [RELEASE-NOTES-v0.4.3.zh-CN.md](https://github.com/FanyinLiu/Nexus/blob/main/docs/RELEASE-NOTES-v0.4.3.zh-CN.md)，英文完整说明见 [RELEASE-NOTES-v0.4.3.md](https://github.com/FanyinLiu/Nexus/blob/main/docs/RELEASE-NOTES-v0.4.3.md)。
...
> **主题：陪伴 UI、设置和可靠性加固。** 中文说明见 [RELEASE-NOTES-v0.4.1.zh-CN.md](https://github.com/FanyinLiu/Nexus/blob/main/docs/RELEASE-NOTES-v0.4.1.zh-CN.md)，英文完整说明见 [RELEASE-NOTES-v0.4.1.md](https://github.com/FanyinLiu/Nexus/blob/main/docs/RELEASE-NOTES-v0.4.1.md)。
...
> **主题：桌面陪伴感知地基。** 中文说明见 [RELEASE-NOTES-v0.4.0.zh-CN.md](https://github.com/FanyinLiu/Nexus/blob/main/docs/RELEASE-NOTES-v0.4.0.zh-CN.md)，英文完整说明见 [RELEASE-NOTES-v0.4.0.md](https://github.com/FanyinLiu/Nexus/blob/main/docs/RELEASE-NOTES-v0.4.0.md)。
...
README 顶部只保留当前稳定版 v0.4.3 和上一公开版本 v0.4.1 的重点。更早版本的完整历史统一放在 [CHANGELOG](https://github.com/FanyinLiu/Nexus/blob/main/CHANGELOG.md) 和 [GitHub Releases](https://github.com/FanyinLiu/Nexus/releases)，避免首页继续滚动维护旧版本号。
...
[COMMUNITY.md](https://github.com/FanyinLiu/Nexus/blob/main/docs/COMMUNITY.md)，0.4 系列方向见
[v0.4 Desktop Companion Awareness](https://github.com/FanyinLiu/Nexus/blob/main/docs/V0.4_DESKTOP_COMPANION_AWARENESS.md)，
0.4 当前稳定版说明见
[RELEASE-NOTES-v0.4.3.md](https://github.com/FanyinLiu/Nexus/blob/main/docs/RELEASE-NOTES-v0.4.3.md)，
发布加固清单见
[RELEASE-CANDIDATE-v0.4-HARDENING.md](https://github.com/FanyinLiu/Nexus/blob/main/docs/RELEASE-CANDIDATE-v0.4-HARDENING.md)。
提交人格、提示词或桌宠素材前，请先看 [Nexus Companion Prompt Baseline](https://github.com/FanyinLiu/Nexus/blob/main/docs/NEXUS_COMPANION_PROMPT.md)；
它定义了 Nexus 的稳定身份、边界和社区投稿格式。新人格可以从
[Persona Contribution Template](https://github.com/FanyinLiu/Nexus/blob/main/docs/PERSONA_CONTRIBUTION_TEMPLATE.md) 开始填。
...
Released under the [MIT License](https://github.com/FanyinLiu/Nexus/blob/main/LICENSE).

Bundled Live2D sample characters are subject to Live2D's separate terms. See
[THIRD_PARTY_NOTICES.md](https://github.com/FanyinLiu/Nexus/blob/main/THIRD_PARTY_NOTICES.md) before redistributing Nexus.
