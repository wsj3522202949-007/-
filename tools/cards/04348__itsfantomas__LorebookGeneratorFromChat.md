...
This project is licensed under the **GNU Affero General Public License v3.0** — see the [LICENSE](https://github.com/itsfantomas/LorebookGeneratorFromChat/blob/main/LICENSE) file for details.
...
Проект лицензирован под **GNU Affero General Public License v3.0** — подробности в файле [LICENSE](https://github.com/itsfantomas/LorebookGeneratorFromChat/blob/main/LICENSE).
