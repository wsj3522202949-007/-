...
See [`docs/spindle-architecture.md`](https://github.com/VerifiedOrganic/spindle/blob/main/docs/spindle-architecture.md) for the
full tool reference.
...
- **Batch drafting.** `spindle-harness` is an operator-driven tool for
  ...
  artifacts. See [`docs/spindle-harness-usage.md`](https://github.com/VerifiedOrganic/spindle/blob/main/docs/spindle-harness-usage.md).
- **Custom model routing.** Bind specific tasks (drafting, editing,
  ...
  Bible search. See [`docs/spindle-agent-config.md`](https://github.com/VerifiedOrganic/spindle/blob/main/docs/spindle-agent-config.md).
...
[`docs/spindle-implementation-brief.md`](https://github.com/VerifiedOrganic/spindle/blob/main/docs/spindle-implementation-brief.md).
See [`docs/README.md`](https://github.com/VerifiedOrganic/spindle/blob/main/docs/README.md) for the full docs map.
