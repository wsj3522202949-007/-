...
source: https://github.com/elmehdi-boulmarouf/prompt-library
created: 2026-07-18
updated: 2026-07-18
no: 973
category: 二、网文 / 长篇 AI 写作系统 库
repo: elmehdi-boulmarouf/Prompt-Library
stars: 0
url: https://github.com/elmehdi-boulmarouf/prompt-library
tier: "C"
...
content_hash: 74181d1d7bc18333
  - methods/最强写作方法论_全球最强综合版.md
---

# elmehdi-boulmarouf/Prompt-Library

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/elmehdi-boulmarouf/prompt-library
- **Stars**：0
- **语言**：None
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：A curated collection of tested AI prompts for writing, productivity, automation, and image generation
- **本地描述**：A curated collection of tested AI prompts for writing, productivity, automation, and image generation
- **拉取时间**：2026-07-23 23:07:25
...
This project is licensed under the [MIT License](https://github.com/elmehdi-boulmarouf/Prompt-Library/blob/main/LICENSE).  
