...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/yuliang-liu/monkeyocr
- **Stars**：6607
- **语言**：Python
- **License**：Apache-2.0
- **Topics**：—
- **GitHub 描述**：A lightweight LMM-based Document Parsing Model
- **本地描述**：monkeyocr
- **拉取时间**：2026-07-25 19:28:35
...
See the [windows support guide](https://github.com/yuliang-liu/monkeyocr/blob/main/docs/windows_support.md) for details.

## Quantization

This model can be quantized using AWQ. Follow the instructions in the [quantization guide](https://github.com/yuliang-liu/monkeyocr/blob/main/docs/Quantization.md).
