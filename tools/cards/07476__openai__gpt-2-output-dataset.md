...
We provide some [initial analysis](https://github.com/openai/gpt-2-output-dataset/blob/main/detection.md) of two baselines, as well as [code](https://github.com/openai/gpt-2-output-dataset/blob/main/baseline.py) for the better baseline.
