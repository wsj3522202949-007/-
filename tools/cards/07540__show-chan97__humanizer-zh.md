...
source: https://github.com/show-chan97/humanizer-zh
created: 2026-07-18
updated: 2026-07-18
no: 7540
category: 画龙补充 / 扩容入库 — 补充源
repo: show-chan97/humanizer-zh
stars: 9
url: https://github.com/show-chan97/humanizer-zh
tier: "B"
...
content_hash: 23ce5f274356e60c
  - methods/QUICK_START.md
---

# show-chan97/humanizer-zh

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/show-chan97/humanizer-zh
- **Stars**：9
- **语言**：None
- **License**：MIT
- **Topics**：ai-detection, ai-writing, chinese, claude-code, humanizer, opencode, skill, writing-editor
- **GitHub 描述**：针对中文优化的 AI 写作痕迹去除工具，基于 Wikipedia 'Signs of AI writing' 指南 v2.5.1
- **本地描述**：humanizer-zh
- **拉取时间**：2026-07-25 19:25:02
