...
source: https://github.com/nariahlamb/st_book
created: 2026-07-18
updated: 2026-07-18
no: 7452
category: 画龙补充 / 扩容入库 — 补充源
repo: nariahlamb/st_book
stars: 26
url: https://github.com/nariahlamb/st_book
tier: "B"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/nariahlamb/st_book
- **Stars**：26
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：SillyTavern世界书和角色卡自动生成工具 - 基于AI智能分析小说文本，自动生成高质量的角色卡和世界书，支持统一配置管理和完整的工作流程
- **本地描述**：st_book
- **拉取时间**：2026-07-25 19:22:19
