...
[`reports/transformer_data_preparation.md`](https://github.com/AlgoCraftsman/sea820-ai-text-detector/blob/main/reports/transformer_data_preparation.md) for the
...
[`reports/transformer_training.md`](https://github.com/AlgoCraftsman/sea820-ai-text-detector/blob/main/reports/transformer_training.md) for the policy and
...
[`reports/transformer_training.md`](https://github.com/AlgoCraftsman/sea820-ai-text-detector/blob/main/reports/transformer_training.md) and
...
them. See [`reports/frozen_test_comparison.md`](https://github.com/AlgoCraftsman/sea820-ai-text-detector/blob/main/reports/frozen_test_comparison.md).
...
tune any model. See [`reports/error_analysis.md`](https://github.com/AlgoCraftsman/sea820-ai-text-detector/blob/main/reports/error_analysis.md).
