...
source: https://github.com/ajeibi/ai_prompt
created: 2026-07-18
updated: 2026-07-18
no: 1378
category: 二、网文 / 长篇 AI 写作系统 库
repo: Ajeibi/ai_prompt
stars: 0
url: https://github.com/ajeibi/ai_prompt
tier: "C"
...
- **链接**：https://github.com/ajeibi/ai_prompt
- **Stars**：0
- **语言**：JavaScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：This is a GitHub repository enabling users to create prompts for AI models like ChatGPT. Easily craft queries and get AI-generated responses for various tasks, from creative writing to conversational AI. Boost your projects with ai_prompt for efficient AI interaction.
- **本地描述**：This is a GitHub repository enabling users to create prompts for AI models like ChatGPT. Easily craft queries and get AI-generated responses for various tasks, from creative writing to conversational AI. Boost your projects with ai_prompt for efficient AI interaction.
- **拉取时间**：2026-07-23 23:19:18
...
This project is licensed under the [MIT License](https://github.com/Ajeibi/ai_prompt/blob/main/LICENSE).
