...
repo: aycanozarpaci/seo-pro-max-skill
stars: 5
url: https://github.com/aycanozarpaci/seo-pro-max-skill
tier: "B"
...
content_hash: e3f3c040a9411077
  - methods/最强写作方法论_全球最强综合版.md
---

# aycanozarpaci/seo-pro-max-skill

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/aycanozarpaci/seo-pro-max-skill
- **Stars**：5
- **语言**：JavaScript
- **License**：MIT
- **Topics**：—
...
Full protocol and all 23 surfaces: [`SKILL.md`](https://github.com/aycanozarpaci/seo-pro-max-skill/blob/main/SKILL.md).
...
| GitHub Copilot Chat   | [`platforms/copilot/.github/copilot-instructions.md`](https://github.com/aycanozarpaci/seo-pro-max-skill/blob/main/platforms/copilot/.github/copilot-instructions.md) |
| Aider                 | [`platforms/aider/CONVENTIONS.md`](https://github.com/aycanozarpaci/seo-pro-max-skill/blob/main/platforms/aider/CONVENTIONS.md)                         |
| Continue.dev          | [`platforms/continue/config-snippet.json`](https://github.com/aycanozarpaci/seo-pro-max-skill/blob/main/platforms/continue/config-snippet.json)         |
...
Edit `SKILL.md`, run `node scripts/build-platforms.mjs`, open a PR. See [CONTRIBUTING.md](https://github.com/aycanozarpaci/seo-pro-max-skill/blob/main/CONTRIBUTING.md).
...
MIT — see [LICENSE](https://github.com/aycanozarpaci/seo-pro-max-skill/blob/main/LICENSE).
