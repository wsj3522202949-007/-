...
area: 库
status: active
tags: [Go, 协议宽松, 本地优先, 中文友好, 大纲规划, 多Agent, 本地写作, 灵感创意]
title: Ai-Assistant
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/jiqi136/ai-assistant
created: 2026-07-18
updated: 2026-07-18
no: 5
category: 二、网文 / 长篇 AI 写作系统 库
repo: jiqi136/Ai-Assistant
stars: 28
url: https://github.com/jiqi136/ai-assistant
tier: "B"
...
- **链接**：https://github.com/jiqi136/ai-assistant
- **Stars**：28
- **语言**：Go
- **License**：Apache-2.0
- **Topics**：ai, ai-assistant, assistant, chatgpt, claude, deepseek, gemini, grok, image-2, nano-banana
- **GitHub 描述**：[Open Source] Novel Writing & AI Programming Assistant. 【公开源码】的小说写作与 AI 编程助手。Aggregates top large models from home and abroad聚合国内外顶尖大模型 (DeepSeek/Gemini/Claude/Kimi/ChatGPT, etc.)
- **本地描述**：[Open Source] Novel Writing & AI Programming Assistant. 【公开源码】的小说写作与 AI 编程助手。Aggregates top large models from home and abroad聚合国内外顶尖大模型 (DeepSeek/Gemini/Claude/Kimi/ChatGPT, etc.)
- **拉取时间**：2026-07-23 22:39:00
