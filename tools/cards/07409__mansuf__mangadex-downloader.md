...
source: https://github.com/mansuf/mangadex-downloader
created: 2026-07-18
updated: 2026-07-18
no: 7409
category: 画龙补充 / 扩容入库 — 补充源
repo: mansuf/mangadex-downloader
stars: 898
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/mansuf/mangadex-downloader
- **Stars**：898
- **语言**：Python
- **License**：MIT
- **Topics**：cli, downloader, manga, manga-downloader, mangadex, mangadex-api, mangadex-dl, mangadex-downloader, python, python3
- **GitHub 描述**：A command-line tool to download manga from MangaDex, written in Python.
- **本地描述**：mangadex-downloader
- **拉取时间**：2026-07-25 19:21:01
