...
title: nacelle-drafter
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/cvk/nacelle-drafter
created: 2026-07-18
updated: 2026-07-18
no: 82
category: 二、网文 / 长篇 AI 写作系统 库
repo: cvk/nacelle-drafter
stars: 0
url: https://github.com/cvk/nacelle-drafter
tier: "C"
...
- **链接**：https://github.com/cvk/nacelle-drafter
- **Stars**：0
- **语言**：JavaScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：A focus-writing and novel draft printing tool.
- **本地描述**：A focus-writing and novel draft printing tool.
- **拉取时间**：2026-07-23 22:41:14
