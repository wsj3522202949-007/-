...
source: https://github.com/abdulhadi0-byte/humanize-ai
created: 2026-07-18
updated: 2026-07-18
no: 4841
category: 一、去 AI 味 / Humanizer 库
repo: abdulhadi0-byte/humanize-ai
stars: 0
url: https://github.com/abdulhadi0-byte/humanize-ai
tier: "C"
...
# abdulhadi0-byte/humanize-ai

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/abdulhadi0-byte/humanize-ai
- **Stars**：0
- **语言**：HTML
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：AI Text Detector & Humanizer Web App
- **本地描述**：AI Text Detector & Humanizer Web App
- **拉取时间**：2026-07-25 17:56:25
