...
source: https://github.com/brsloan/warewoolf
created: 2026-07-18
updated: 2026-07-18
no: 617
...
- **链接**：https://github.com/brsloan/warewoolf
- **Stars**：334
- **语言**：JavaScript
- **License**：MIT
- **Topics**：docx, editor, fiction, markdown, novel-writing, quill, rich-text-editor, text-editor, word-processor, writerdeck, writing-software
- **GitHub 描述**：A minimalist novel-writing system/rich text editor designed to be usable without a mouse. For desktop and standalone word processors/digital typewriters/writerDecks.
- **本地描述**：A minimalist novel-writing system/rich text editor designed to be usable without a mouse. For desktop and standalone word processors/digital typewriters/writerDecks.
- **拉取时间**：2026-07-23 22:57:03
...
Dark Mode:
![screenshot of dark mode of program described](https://github.com/brsloan/warewoolf/blob/main/src/assets/screenshot_darkmode.png?raw=true%20"WareWoolf")
Light Mode:
![screenshot of program described](https://github.com/brsloan/warewoolf/blob/main/src/assets/screenshot_lightmode.png?raw=true%20"WareWoolf")
Corkboard:
![screenshot of program described](https://github.com/brsloan/warewoolf/blob/main/src/assets/screenshot_corkboard.png?raw=true%20"WareWoolf")
