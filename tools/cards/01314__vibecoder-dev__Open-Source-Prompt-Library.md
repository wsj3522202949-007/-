...
area: 库
status: active
tags: [提示词, TypeScript, 协议宽松, 本地优先, 英文文档, 多Agent, 本地写作]
title: Open-Source-Prompt-Library
summary: 提示词/写作工作流
source: https://github.com/vibecoder-dev/open-source-prompt-library
created: 2026-07-18
updated: 2026-07-18
no: 1314
category: 二、网文 / 长篇 AI 写作系统 库
repo: vibecoder-dev/Open-Source-Prompt-Library
stars: 1
url: https://github.com/vibecoder-dev/open-source-prompt-library
tier: "B"
use_case: "提示词/写作工作流"
pitfalls: []
related:
...
content_hash: 3d496402ac2e05d8
  - methods/最强写作方法论_全球最强综合版.md
---

# vibecoder-dev/Open-Source-Prompt-Library

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/vibecoder-dev/open-source-prompt-library
- **Stars**：1
- **语言**：TypeScript
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：📖 Open Source Prompt Library  The Open Source Prompt Library is a community-driven collection of high-quality prompts for AI tools like ChatGPT, Claude, and other LLMs.  💡 The goal is to make it easy to discover, share, and reuse effective prompts across categories like coding, study, career, writing, and health. 
- **本地描述**：📖 Open Source Prompt Library  The Open Source Prompt Library is a community-driven collection of high-quality prompts for AI tools like ChatGPT, Claude, and other LLMs.  💡 The goal is to make it easy to discover, share, and reuse effective prompts across categories like coding, study, career, writing, and health.
- **拉取时间**：2026-07-23 23:17:25
...
Check [CONTRIBUTING.md](https://github.com/vibecoder-dev/Open-Source-Prompt-Library/blob/main/CONTRIBUTING.md) for guidelines.
