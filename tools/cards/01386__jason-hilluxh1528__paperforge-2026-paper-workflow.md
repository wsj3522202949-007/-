...
title: paperforge-2026-paper-workflow
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/jason-hilluxh1528/paperforge-2026-paper-workflow
created: 2026-07-18
updated: 2026-07-18
no: 1386
category: 二、网文 / 长篇 AI 写作系统 库
repo: jason-hilluxh1528/paperforge-2026-paper-workflow
stars: 8
url: https://github.com/jason-hilluxh1528/paperforge-2026-paper-workflow
tier: "B"
...
- **链接**：https://github.com/jason-hilluxh1528/paperforge-2026-paper-workflow
- **Stars**：8
- **语言**：HTML
- **License**：GPL-3.0
- **Topics**：—
- **GitHub 描述**：PaperForge v2026 is a browser-based academic writing automation system with LLM-guided workflows for paper generation, citation handling, iteration, and validation.
- **本地描述**：PaperForge v2026 is a browser-based academic writing automation system with LLM-guided workflows for paper generation, citation handling, iteration, and validation.
- **拉取时间**：2026-07-23 23:19:32
