...
![PreCheck unlocked, showing the generated prompt and session history](https://github.com/levibmackay/PrecheckAI/blob/main/docs/screenshot-unlocked.png)
...
![The gate showing its live validation checklist before all conditions are met](https://github.com/levibmackay/PrecheckAI/blob/main/docs/screenshot-gate.png)
...
MIT — see [LICENSE](https://github.com/levibmackay/PrecheckAI/blob/main/LICENSE).
