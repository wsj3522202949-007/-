...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/monogatari/monogatari
- **Stars**：866
- **语言**：TypeScript
- **License**：MIT
- **Topics**：custom-elements, engine, game-engine, game-engines, interactive-storytelling, novel, progressive-web-app, text-based-adventure, visual, visual-novel, visual-novel-engine, visual-novels, web-components
- **GitHub 描述**：Monogatari is a simple web visual novel engine, created to bring Visual Novels to the web.
- **本地描述**：monogatari
- **拉取时间**：2026-07-25 19:21:44
...
The documentation source lives in the [`docs/`](https://github.com/monogatari/monogatari/tree/main/docs/) folder of this repository.
