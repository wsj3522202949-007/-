...
- **Hosting Instructions**: For complete setup instructions on obtaining weights, configuring the Docker container, and deploying to Google Cloud Run with GPU accelerators (NVIDIA L4), please refer to the detailed [SAM 3 Hosting Guide](https://github.com/yogendra-yatnalkar/storyboard-ai/blob/main/sam3-hosting/README.md) in the `sam3-hosting/` folder.

### 3. Pipeline Configuration Settings (`config.py`)
Core configuration parameters are set in [genai-pipeline/config.py](https://github.com/yogendra-yatnalkar/storyboard-ai/blob/main/genai-pipeline/config.py):
...
- **Core GenAI Pipeline**: Install dependencies via the root [requirements.txt](https://github.com/yogendra-yatnalkar/storyboard-ai/blob/main/requirements.txt).
- **SAM 3 Model Server**: Install dependencies via [sam3-hosting/requirements.txt](https://github.com/yogendra-yatnalkar/storyboard-ai/blob/main/sam3-hosting/requirements.txt) if not using the Docker image.
...
- **For the Core GenAI Pipeline**:
  Install the main dependencies in your Python/Conda environment using the root [requirements.txt](https://github.com/yogendra-yatnalkar/storyboard-ai/blob/main/requirements.txt):
  ```bash
  pip install -r requirements.txt
  ```

- **For the SAM 3 Self-Hosting Server**:
  If you are running or building the SAM 3 endpoint locally (instead of using the pre-configured [Dockerfile](https://github.com/yogendra-yatnalkar/storyboard-ai/blob/main/sam3-hosting/Dockerfile)), install the dependencies listed in [sam3-hosting/requirements.txt](https://github.com/yogendra-yatnalkar/storyboard-ai/blob/main/sam3-hosting/requirements.txt):
  ```bash
