...
source: https://github.com/infotechbridge/userstory
created: 2026-07-18
updated: 2026-07-18
no: 34
category: 二、网文 / 长篇 AI 写作系统 库
repo: InfoTechBridge/UserStory
stars: 1
url: https://github.com/infotechbridge/userstory
tier: "B"
...
- **链接**：https://github.com/infotechbridge/userstory
- **Stars**：1
- **语言**：C#
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：A simple .Net framework for Behavioral-Driven Development (BDD) approach that used for writing Given-When-Then user stories
- **本地描述**：A simple .Net framework for Behavioral-Driven Development (BDD) approach that used for writing Given-When-Then user stories
- **拉取时间**：2026-07-23 22:39:51
