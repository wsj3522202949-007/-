...
source: https://github.com/goraved/typhon-web-ui
created: 2026-07-18
updated: 2026-07-18
no: 845
category: 二、网文 / 长篇 AI 写作系统 库
repo: Goraved/Typhon-web-UI
stars: 2
...
- **链接**：https://github.com/goraved/typhon-web-ui
- **Stars**：2
- **语言**：Python
- **License**：None
- **Topics**：allure, github-actions, page-object, pylint, pytest, python, selenium
- **GitHub 描述**：This is a Python framework for writing test automation scenarios using the page object pattern. This framework was created by me like a free open source tool for creating automation tests of any complexity. It can help all specialists who decided to join the test automation community.
- **本地描述**：This is a Python framework for writing test automation scenarios using the page object pattern. This framework was created by me like a free open source tool for creating automation tests of any complexity. It can help all specialists who decided to join the test automation community.
- **拉取时间**：2026-07-23 23:03:40
