...
title: SocraticSeminar
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/nodiratillayeva/socraticseminar
created: 2026-07-18
updated: 2026-07-18
no: 1519
category: 二、网文 / 长篇 AI 写作系统 库
repo: NodiraTillayeva/SocraticSeminar
stars: 3
url: https://github.com/nodiratillayeva/socraticseminar
tier: "B"
...
content_hash: 357f5878dc1ef43e
  - methods/最强写作方法论_全球最强综合版.md
---

# NodiraTillayeva/SocraticSeminar

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/nodiratillayeva/socraticseminar
- **Stars**：3
- **语言**：Dart
- **License**：None
- **Topics**：ai, edtech, writing-tool
- **GitHub 描述**：A collaborative web/mobile application designed to support Socratic-style discussions in classrooms and study groups. The app combines structured prompts, AI-assisted scaffolding, and collaborative note-taking to enhance critical thinking and academic writing skills.
- **本地描述**：A collaborative web/mobile application designed to support Socratic-style discussions in classrooms and study groups. The app combines structured prompts, AI-assisted scaffolding, and collaborative note-taking to enhance critical thinking and academic writing skills.
- **拉取时间**：2026-07-23 23:23:24
...
This project is licensed under the MIT License – see the [LICENSE](https://github.com/NodiraTillayeva/SocraticSeminar/blob/main/LICENSE) file for details.  
