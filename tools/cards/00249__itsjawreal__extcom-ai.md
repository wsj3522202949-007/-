...
- **Backend source file (`apps/backend/PERSONA.md`):** optional persistent
  ...
  [docs/PROMPT.md](https://github.com/itsjawreal/extcom-ai/blob/main/docs/PROMPT.md#persona).
...
| --- | --- | --- |
| [Railway](https://github.com/itsjawreal/extcom-ai/blob/main/docs/deploy-railway.md) | Dockerfile | Railway Volume mounted to `/data` |
| [Render](https://github.com/itsjawreal/extcom-ai/blob/main/docs/deploy-render.md) | Dockerfile | Persistent Disk mounted to `/data` |
| [Fly.io](https://github.com/itsjawreal/extcom-ai/blob/main/docs/deploy-fly.md) | Dockerfile | Fly Volume mounted to `/data` |
| [Northflank](https://github.com/itsjawreal/extcom-ai/blob/main/docs/deploy-northflank.md) | Dockerfile | Volume mounted to `/data` |
| [Zeabur](https://github.com/itsjawreal/extcom-ai/blob/main/docs/deploy-zeabur.md) | Dockerfile | Volume mounted to `/data` |
| [VPS](https://github.com/itsjawreal/extcom-ai/blob/main/docs/deploy-vps.md) | Docker Compose | Docker named volume mounted to `/data` |
...
| `AI_ALLOWED_MODELS` | no | Comma-separated model IDs offered in the popup's model dropdown. Empty = a small built-in starter list. See [API.md](https://github.com/itsjawreal/extcom-ai/blob/main/docs/API.md). |
...
[Privacy policy](https://github.com/itsjawreal/extcom-ai/blob/main/docs/privacy-policy.md) — short version: nothing leaves
your device except to the backend URL you configure yourself.

## License

[MIT](https://github.com/itsjawreal/extcom-ai/blob/main/LICENSE)
