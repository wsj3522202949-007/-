...
Script: [`dipper_paraphrases/paraphrase_minimal.py`](https://github.com/martiansideofthemoon/ai-detection-paraphrases/blob/master/dipper_paraphrases/paraphrase_minimal.py)

*DIPPER manual download*

Checkpoint: https://drive.google.com/file/d/1LJJ1P5X2An0kMn8WAAAJBmxBuNS-5GiK/view?usp=sharing  
To run this downloaded model, in [`dipper_paraphrases/paraphrase_minimal.py`](https://github.com/martiansideofthemoon/ai-detection-paraphrases/blob/master/dipper_paraphrases/paraphrase_minimal.py), uncomment the line `dp = DipperParaphraser(model="...")` and specify your model checkpoint path.
...
This is all documented in our minimal sample script to run DIPPER, [`dipper_paraphrases/paraphrase_minimal.py`](https://github.com/martiansideofthemoon/ai-detection-paraphrases/blob/master/dipper_paraphrases/paraphrase_minimal.py), and also in footnote 6 in our [paper](https://arxiv.org/pdf/2303.13408.pdf).
...
Use the scripts [`dipper_paraphrases/generate_gpt2.py`](https://github.com/martiansideofthemoon/ai-detection-paraphrases/blob/master/dipper_paraphrases/generate_gpt3.py), or [`dipper_paraphrases/generate_gpt3.py`](https://github.com/martiansideofthemoon/ai-detection-paraphrases/blob/master/dipper_paraphrases/generate_gpt3.py), or [`dipper_paraphrases/generate_opt.py`](https://github.com/martiansideofthemoon/ai-detection-paraphrases/blob/master/dipper_paraphrases/generate_opt.py) as shown below,
...
Use the scripts [`dipper_paraphrases/paraphrase.py`](https://github.com/martiansideofthemoon/ai-detection-paraphrases/blob/master/dipper_paraphrases/paraphrase.py) as shown below,
...
For the scaled retrieval experiments, please see [`dipper_paraphrases/detect_retrieval_scale_*.py`](https://github.com/martiansideofthemoon/ai-detection-paraphrases/blob/master/dipper_paraphrases). Please contact me if you want the raw data accompanying this experiment (email me at kalpesh@cs.umass.edu).
