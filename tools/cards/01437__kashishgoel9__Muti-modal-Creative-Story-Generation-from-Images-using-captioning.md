...
title: Muti-modal-Creative-Story-Generation-from-Images-using-captioning
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/kashishgoel9/muti-modal-creative-story-generation-from-images-using-captioning
created: 2026-07-18
updated: 2026-07-18
no: 1437
category: 二、网文 / 长篇 AI 写作系统 库
repo: kashishgoel9/Muti-modal-Creative-Story-Generation-from-Images-using-captioning
stars: 2
url: https://github.com/kashishgoel9/muti-modal-creative-story-generation-from-images-using-captioning
tier: "B"
...
content_hash: decb5bf092edfc1b
  - methods/最强写作方法论_全球最强综合版.md
---

# kashishgoel9/Muti-modal-Creative-Story-Generation-from-Images-using-captioning

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/kashishgoel9/muti-modal-creative-story-generation-from-images-using-captioning
- **Stars**：2
- **语言**：Jupyter Notebook
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：The stories are generated using a two part framework as de- scriptive image captioning using smaller NLP models and then using a large language model for generating creative stories using those. The aim of the work is to generate stories which are coherent with the images and can incorporate the theme and context presented
- **本地描述**：The stories are generated using a two part framework as de- scriptive image captioning using smaller NLP models and then using a large language model for generating creative stories using those. The aim of the work is to generate stories which are coherent with the images and can incorporate the theme and context presented
- **拉取时间**：2026-07-23 23:21:00
