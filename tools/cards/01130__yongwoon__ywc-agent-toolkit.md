...
title: ywc-agent-toolkit
summary: Claude Code 插件式写作流
source: https://github.com/yongwoon/ywc-agent-toolkit
created: 2026-07-18
updated: 2026-07-18
no: 1130
category: 二、网文 / 长篇 AI 写作系统 库
repo: yongwoon/ywc-agent-toolkit
stars: 8
url: https://github.com/yongwoon/ywc-agent-toolkit
tier: "B"
...
content_hash: 3fef104f2da277c2
  - methods/最强写作方法论_全球最强综合版.md
---

# yongwoon/ywc-agent-toolkit

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/yongwoon/ywc-agent-toolkit
- **Stars**：8
- **语言**：Python
- **License**：MIT
- **Topics**：agentic-workflow, ai-agents, automation, claude-code, codex, developer-tools, llm-tools, skill-collection
- **GitHub 描述**：A skill collection for Claude Code and Codex that automates the full development workflow — from planning and spec writing to code generation, review, and release.
- **本地描述**：A skill collection for Claude Code and Codex that automates the full development workflow — from planning and spec writing to code generation, review, and release.
- **拉取时间**：2026-07-23 23:11:59
...
[한국어](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/README.ko.md) | [中文](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/README.zh.md) | [日本語](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/README.ja.md) | [Español](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/README.es.md)
...
Edit Codex skills in [codex/skills](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/codex/skills). Do not edit `plugins/ywc-agent-toolkit/skills` as the primary source; it is the generated marketplace package used by `codex plugin add`.
...
| Goal | Skills |
| ---- | ------ |
| Turn an idea into a plan or spec | [`ywc-plan`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-plan/README.md) → [`ywc-spec-writer`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-spec-writer/README.md) |
| Understand an unfamiliar codebase | [`ywc-onboard-repo`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-onboard-repo/README.md) |
| Break work into dependency-safe tasks | [`ywc-task-generator`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-task-generator/README.md) |
| Implement tasks end-to-end | [`ywc-sequential-executor`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-sequential-executor/README.md) / [`ywc-parallel-executor`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-parallel-executor/README.md) |
| Run the full pipeline from a goal | [`ywc-agentic`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-agentic/README.md) |
| Find the root cause of a bug | [`ywc-debug-rootcause`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-debug-rootcause/README.md) |
| Review code quality and security | [`ywc-impl-review`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-impl-review/README.md), [`ywc-security-audit`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-security-audit/README.md) |
| Open a PR and handle review comments | [`ywc-create-pr`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-create-pr/README.md) → [`ywc-handle-pr-reviews`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-handle-pr-reviews/README.md) |
| Generate a QA test sheet | [`ywc-gen-testcase`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-gen-testcase/README.md) |
| Write release notes | [`ywc-release-pr-list`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-release-pr-list/README.md) + [`ywc-changelog-release-notes`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-changelog-release-notes/README.md) |
| Author a new `ywc-*` skill | [`ywc-skill-author`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-skill-author/README.md) |

### Planning & Spec

| Skill | Description |
| ----- | ----------- |
| [`ywc-plan`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-plan/README.md) | Convert a rough idea into `plan.md` (Small) or a Spec document (Medium/Large) |
| [`ywc-spec-writer`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-spec-writer/README.md) | Write and update spec documents (`docs/specification/`) |
| [`ywc-spec-validate`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-spec-validate/README.md) | Validate spec quality (Completeness / Consistency / Feasibility) |
| [`ywc-tech-research`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-tech-research/README.md) | Research libraries and compare technical approaches |
| [`ywc-ubiquitous-language`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-ubiquitous-language/README.md) | Create and maintain a domain ubiquitous language dictionary |
| [`ywc-project-mission`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-project-mission/README.md) | Persist the project's durable Mission / Success Criteria / Out-of-Scope in `docs/project-mission.md` (read by ywc-plan to frame planning) |
| [`ywc-brainstorm`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-brainstorm/README.md) | Shape rough ideas before writing a formal plan or spec |
| [`ywc-confidence-gate`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-confidence-gate/README.md) | Check readiness and risk before starting substantial implementation |
| [`ywc-onboard-repo`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-onboard-repo/README.md) | Generate repository onboarding context for unfamiliar projects |
| [`ywc-spec-ready`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-spec-ready/README.md) | Recursively converge a spec to ywc-spec-validate DONE (validate ↔ ywc-plan --update-spec loop, default max 5 iterations) |

### Task & Execution

| Skill | Description |
| ----- | ----------- |
| [`ywc-task-generator`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-task-generator/README.md) | Decompose a spec into dependency-safe tasks |
| [`ywc-sequential-executor`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-sequential-executor/README.md) | Execute tasks sequentially (Branch → Implement → Commit → PR → Merge) |
| [`ywc-parallel-executor`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-parallel-executor/README.md) | Execute tasks in parallel using Git worktree isolation |
| [`ywc-code-gen`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-code-gen/README.md) | Generate Backend + Frontend + QA code in parallel |
| [`ywc-agentic`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-agentic/README.md) | Autonomously orchestrate the ywc-\* pipeline from a goal (Plan → Execute → Evaluate → Repeat, max 3 iterations) |
| [`ywc-tdd-ritual`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-tdd-ritual/README.md) | Drive feature and bugfix work through a red-green-refactor loop |
| [`ywc-worktrees`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-worktrees/README.md) | Create, audit, prune, and resolve worktree-based task isolation |
| [`ywc-docker-isolate`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-docker-isolate/README.md) | Deterministically isolate per-worktree Docker host ports for parallel runs (setup / teardown / audit) |

### Review & Verification

| Skill | Description |
| ----- | ----------- |
| [`ywc-impl-review`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-impl-review/README.md) | Verify implementation across Architecture / Design / Devex / Security / QA axes |
| [`ywc-review-learnings`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-review-learnings/README.md) | Accumulate per-project review preferences in `docs/review-learnings.md` |
| [`ywc-security-audit`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-security-audit/README.md) | Security audit based on OWASP Top 10 |
| [`ywc-ui-ux-review`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-ui-ux-review/README.md) | UI/UX review (IA + Visual design + WCAG 2.2 AA) |
| [`ywc-design-renew`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-design-renew/README.md) | Renew generic UI surfaces and audit AI-slop design tells |
| [`ywc-product-review`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-product-review/README.md) | Product feedback across 5 business dimensions |
| [`ywc-gen-testcase`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-gen-testcase/README.md) | Generate test sheets from PRs or tasks |
| [`ywc-e2e-test-strategy`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-e2e-test-strategy/README.md) | Design Playwright E2E test strategy |
| [`ywc-debug-rootcause`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-debug-rootcause/README.md) | Investigate bugs, failed tests, and build failures to the root cause |
| [`ywc-receive-review`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-receive-review/README.md) | Triage and apply human or automated review feedback |
| [`ywc-refactor-clean`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-refactor-clean/README.md) | Remove dead code, unused exports, stale files, and unused dependencies |
| [`ywc-verify-done`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-verify-done/README.md) | Verify tests, builds, and completion evidence before declaring work done |

### Git & Release

| Skill | Description |
| ----- | ----------- |
| [`ywc-commit`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-commit/README.md) | Stage and commit session work |
| [`ywc-create-pr`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-create-pr/README.md) | Commit and create a Draft PR |
| [`ywc-handle-pr-reviews`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-handle-pr-reviews/README.md) | Automate PR review responses |
| [`ywc-finish-branch`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-finish-branch/README.md) | Full branch delivery (CI → merge → cleanup) |
| [`ywc-merge-dependabot`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-merge-dependabot/README.md) | Auto-merge Dependabot PRs |
| [`ywc-release-pr-list`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-release-pr-list/README.md) | Summarize PRs included in a release |
| [`ywc-changelog-release-notes`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-changelog-release-notes/README.md) | Generate CHANGELOG entries and user-facing release notes |

### Documentation & Other

| Skill | Description |
| ----- | ----------- |
| [`ywc-project-scaffold`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-project-scaffold/README.md) | Generate directory structure for any language/framework |
| [`ywc-project-docs`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-project-docs/README.md) | Generate project documentation in Korean or Japanese |
| [`ywc-incident-postmortem`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-incident-postmortem/README.md) | Write a structured postmortem after a production incident |
| [`ywc-skill-author`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-skill-author/README.md) | (Meta) Rules for authoring new `ywc-*` skills |
...
Claude Code also ships 12 custom agents for worker, reviewer, and specialist dispatch. They install to `~/.claude/agents/` and are documented in [`claude-code/agents/README.md`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/agents/README.md).
...
| ----- | ------- | ------- |
| [`ywc-architect`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/agents/ywc-architect.md) | Architectural decision and trade-off advisor | `read-only` |
| [`ywc-security-engineer`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/agents/ywc-security-engineer.md) | Static security review and threat-model triage | `read-only` |
| [`ywc-root-cause-analyst`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/agents/ywc-root-cause-analyst.md) | Root-cause and incident-cause analysis | `read-only` |
| [`ywc-performance-engineer`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/agents/ywc-performance-engineer.md) | Performance review and profiling recommendations | `read-only` |
| [`ywc-typescript-reviewer`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/agents/ywc-typescript-reviewer.md) | TypeScript / JavaScript language-specific review | `read-only` |
...
Details: [`references/html-output.md`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/references/html-output.md).
...
For per-hook usage details see [`claude-code/hooks/README.md`](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/hooks/README.md).
...
Contributions are welcome! Please read [CONTRIBUTING.md](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/CONTRIBUTING.md) before submitting a PR.

- **Bug reports & skill improvements**: open an issue or PR
- **New skills**: follow the [ywc-skill-author](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/claude-code/skills/ywc-skill-author/SKILL.md) guidelines
- **Translations**: see the [translation guide](https://github.com/yongwoon/ywc-agent-toolkit/blob/main/CONTRIBUTING.md#translations)
