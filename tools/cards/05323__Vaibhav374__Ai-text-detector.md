...
source: https://github.com/vaibhav374/ai-text-detector
created: 2026-07-18
updated: 2026-07-18
no: 5323
category: 一、去 AI 味 / Humanizer 库
repo: Vaibhav374/Ai-text-detector
stars: 0
url: https://github.com/vaibhav374/ai-text-detector
tier: "C"
...
content_hash: b82a07abcda0dd81
  - methods/改稿润色指令库.md
---

# Vaibhav374/Ai-text-detector

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/vaibhav374/ai-text-detector
- **Stars**：0
- **语言**：Jupyter Notebook
- **License**：None
- **Topics**：—
- **GitHub 描述**：—
- **本地描述**：Vaibhav374/Ai-text-detector
- **拉取时间**：2026-07-25 18:14:21
