...
- Copy each [example prompt](https://github.com/giacomo9999/aiml_prompts_250107/tree/main/example-prompts/) from this repo into a shared Google doc. Think about what purpose each part of the prompt serves. What components can you identify? Use color coding or highlighting to “diagram” the prompts.
...
- Pair program through the [prompting challenges](https://github.com/giacomo9999/aiml_prompts_250107/tree/main/prompting-challenges/) provided, following the driver/navigator approach to write pseudocode and draft prompts for each challenge. **Don't “run” your prompts with an LLM!** You're just whiteboarding. 📝
