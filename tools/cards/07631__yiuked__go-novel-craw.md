...
area: 库
status: active
tags: [Go, 协议未明, 本地优先, 中文友好, 本地写作]
title: go-novel-craw
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/yiuked/go-novel-craw
created: 2026-07-18
updated: 2026-07-18
no: 7631
category: 画龙补充 / 扩容入库 — 补充源
repo: yiuked/go-novel-craw
stars: 0
url: https://github.com/yiuked/go-novel-craw
tier: "C"
...
content_hash: 131c4615226b769f
  - methods/QUICK_START.md
---

# yiuked/go-novel-craw

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/yiuked/go-novel-craw
- **Stars**：0
- **语言**：Go
- **License**：None
- **Topics**：—
