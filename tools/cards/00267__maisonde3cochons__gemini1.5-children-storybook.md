...
title: gemini1.5-children-storybook
summary: 多 Agent 协作自动产文
source: https://github.com/maisonde3cochons/gemini1.5-children-storybook
created: 2026-07-18
updated: 2026-07-18
no: 267
category: 二、网文 / 长篇 AI 写作系统 库
repo: maisonde3cochons/gemini1.5-children-storybook
stars: 3
url: https://github.com/maisonde3cochons/gemini1.5-children-storybook
tier: "B"
...
content_hash: ee6b091fbd32a21c
  - methods/最强写作方法论_全球最强综合版.md
---

# maisonde3cochons/gemini1.5-children-storybook

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/maisonde3cochons/gemini1.5-children-storybook
- **Stars**：3
- **语言**：Python
- **License**：None
- **Topics**：—
- **GitHub 描述**：AI storybook generator using Google's Gemini 1.5 model and CrewAI
- **本地描述**：AI storybook generator using Google's Gemini 1.5 model and CrewAI
- **拉取时间**：2026-07-23 22:46:51
...
이 프로젝트는 [MIT 라이선스](https://github.com/maisonde3cochons/gemini1.5-children-storybook/blob/main/LICENSE)에 따라 라이선스가 부여됩니다.
