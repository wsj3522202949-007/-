...
area: 库
status: active
tags: [去AI味, 提示词, JavaScript, 协议未明, 本地优先, 中文友好, 本地写作]
title: de-ai-prompt-enhancer-writer-booster-skill
...
repo: oubigfa/de-ai-prompt-enhancer-writer-booster-skill
stars: 565
url: https://github.com/oubigfa/de-ai-prompt-enhancer-writer-booster-skill
tier: "S"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/oubigfa/de-ai-prompt-enhancer-writer-booster-skill
- **Stars**：565
- **语言**：JavaScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：去AI味提示词-作家增强-SKILL
- **本地描述**：de-ai-prompt-enhancer-writer-booster-skill
- **拉取时间**：2026-07-25 19:23:12
