...
title: renpy-mcp-pro-public
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/youichi-uda/renpy-mcp-pro-public
created: 2026-07-18
updated: 2026-07-18
no: 7634
category: 画龙补充 / 扩容入库 — 补充源
repo: youichi-uda/renpy-mcp-pro-public
stars: 3
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/youichi-uda/renpy-mcp-pro-public
- **Stars**：3
- **语言**：None
- **License**：None
- **Topics**：ai-tools, claude, devtools, game-dev, mcp, renpy, visual-novel
- **GitHub 描述**：MCP server + visual development tools for Ren'Py visual novel engine. 60 tools, story map, live dashboard, standalone CLI.
- **本地描述**：renpy-mcp-pro-public
- **拉取时间**：2026-07-25 19:28:23
...
![Story Map](https://github.com/youichi-uda/renpy-mcp-pro-public/blob/main/docs/img/story-map.png)

### Dev Dashboard
Live preview, variable inspector with tree view, quick actions — all while the game runs.

![Dashboard](https://github.com/youichi-uda/renpy-mcp-pro-public/blob/main/docs/img/dashboard.png)
