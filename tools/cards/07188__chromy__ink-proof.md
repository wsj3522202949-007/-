...
source: https://github.com/chromy/ink-proof
created: 2026-07-18
updated: 2026-07-18
no: 7188
category: 画龙补充 / 扩容入库 — 补充源
repo: chromy/ink-proof
stars: 22
url: https://github.com/chromy/ink-proof
tier: "B"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/chromy/ink-proof
- **Stars**：22
- **语言**：Python
- **License**：MIT
- **Topics**：ink
- **GitHub 描述**：Testing for Ink compilers and runtimes
- **本地描述**：ink-proof
- **拉取时间**：2026-07-25 19:13:31
...
![ink-proof screenshot](https://github.com/chromy/ink-proof/blob/master/docs/screenshot.png)
...
Ink test cases live under the [ink](https://github.com/chromy/ink-proof/blob/master/ink) directory. They consist of a `story.ink` file (for example [ink/I002/story.ink](https://github.com/chromy/ink-proof/tree/master/ink/I002/story.ink)), an [input.txt](https://github.com/chromy/ink-proof/blob/master/ink/I002/input.txt) file, an expected output file named [transcript.txt](https://github.com/chromy/ink-proof/blob/master/ink/I002/transcript.txt), and metadata in a file named [metadata.json](https://github.com/chromy/ink-proof/blob/master/ink/I002/metadata.json).

Json test cases live under the [bytecode](https://github.com/chromy/ink-proof/blob/master/bytecode) directory.
They consist of a `.json` file (for example [bytecode/B005/story.json](https://github.com/chromy/ink-proof/blob/master/bytecode/B005/story.json)), an [input.txt](https://github.com/chromy/ink-proof/blob/master/bytecode/B005/input.txt) file, an expected output file named [transcript.txt](https://github.com/chromy/ink-proof/blob/master/bytecode/B005/transcript.txt), and metadata in a file named [metadata.json](https://github.com/chromy/ink-proof/blob/master/bytecode/B005/metadata.json).
...
These shim programs live in the [driver](https://github.com/chromy/ink-proof/blob/master/driver) directory.

Compiler drivers are named with the suffix `_compiler_driver`, for example [inklecate_v0.9.0_compiler_driver](https://github.com/chromy/ink-proof/tree/master/drivers/inklecate_v0.9.0_compiler_driver).
During testing they are invoked as follows:
```bash
your_fancy_compiler_driver -o output.json input.ink
```

Runtime drivers are named with the suffix `_runtime_driver`, for example [inkjs_v1.9.0_runtime_driver](https://github.com/chromy/ink-proof/tree/master/driver/inkjs_v1.9.0_runtime_driver).
