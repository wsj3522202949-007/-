...
![ink-proof screenshot](https://github.com/chromy/ink-proof/blob/main/docs/screenshot.png)
...
Ink test cases live under the [ink](https://github.com/chromy/ink-proof/blob/main/ink) directory. They consist of a `story.ink` file (for example [ink/I002/story.ink](https://github.com/chromy/ink-proof/blob/main/ink/I002/story.ink)), an [input.txt](https://github.com/chromy/ink-proof/blob/main/ink/I002/input.txt) file, an expected output file named [transcript.txt](https://github.com/chromy/ink-proof/blob/main/ink/I002/transcript.txt), and metadata in a file named [metadata.json](https://github.com/chromy/ink-proof/blob/main/ink/I002/metadata.json).

Json test cases live under the [bytecode](https://github.com/chromy/ink-proof/blob/main/bytecode) directory.
They consist of a `.json` file (for example [bytecode/B005/story.json](https://github.com/chromy/ink-proof/blob/main/bytecode/B005/story.json)), an [input.txt](https://github.com/chromy/ink-proof/blob/main/bytecode/B005/input.txt) file, an expected output file named [transcript.txt](https://github.com/chromy/ink-proof/blob/main/bytecode/B005/transcript.txt), and metadata in a file named [metadata.json](https://github.com/chromy/ink-proof/blob/main/bytecode/B005/metadata.json).
...
These shim programs live in the [driver](https://github.com/chromy/ink-proof/blob/main/driver) directory.

Compiler drivers are named with the suffix `_compiler_driver`, for example [inklecate_v0.9.0_compiler_driver](https://github.com/chromy/ink-proof/blob/main/drivers/inklecate_v0.9.0_compiler_driver).
During testing they are invoked as follows:
```bash
your_fancy_compiler_driver -o output.json input.ink
```

Runtime drivers are named with the suffix `_runtime_driver`, for example [inkjs_v1.9.0_runtime_driver](https://github.com/chromy/ink-proof/blob/main/driver/inkjs_v1.9.0_runtime_driver).
