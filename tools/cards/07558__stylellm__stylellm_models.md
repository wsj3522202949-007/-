...
title: stylellm_models
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/stylellm/stylellm_models
created: 2026-07-18
updated: 2026-07-18
no: 7558
category: 画龙补充 / 扩容入库 — 补充源
repo: stylellm/stylellm_models
stars: 356
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/stylellm/stylellm_models
- **Stars**：356
- **语言**：None
- **License**：Apache-2.0
- **Topics**：aigc, large-language-models, literature, llm, style-transfer, text-style-transfer, transformers
- **GitHub 描述**：StyleLLM文风大模型：基于大语言模型的文本风格迁移项目。Text style transfer base on Large Language Model.  #文字修饰 # 润色 #风格模仿
- **本地描述**：stylellm_models
- **拉取时间**：2026-07-25 19:25:35
