...
title: smart-contract-cli-tool-phishing-detector
summary: 投稿前给正文降 AI 检测痕迹、改自然语气
source: https://github.com/majesticsilhouette/smart-contract-cli-tool-phishing-detector
created: 2026-07-18
updated: 2026-07-18
no: 4966
category: 一、去 AI 味 / Humanizer 库
repo: majesticsilhouette/smart-contract-cli-tool-phishing-detector
stars: 0
url: https://github.com/majesticsilhouette/smart-contract-cli-tool-phishing-detector
tier: "C"
...
content_hash: 8169ad1a342d2d02
  - methods/改稿润色指令库.md
---

# majesticsilhouette/smart-contract-cli-tool-phishing-detector

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/majesticsilhouette/smart-contract-cli-tool-phishing-detector
- **Stars**：0
- **语言**：TypeScript
- **License**：Apache-2.0
- **Topics**：—
- **GitHub 描述**：A self-hostable bookmark-everything app (links, notes and images) with AI-based automatic tagging and full text search
- **本地描述**：A self-hostable bookmark-everything app (links, notes and images) with AI-based automatic tagging and full text search
- **拉取时间**：2026-07-25 18:01:14
