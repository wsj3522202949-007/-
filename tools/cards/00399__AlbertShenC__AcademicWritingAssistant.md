...
title: AcademicWritingAssistant
summary: Claude Code 插件式写作流
source: https://github.com/albertshenc/academicwritingassistant
created: 2026-07-18
updated: 2026-07-18
no: 399
category: 二、网文 / 长篇 AI 写作系统 库
repo: AlbertShenC/AcademicWritingAssistant
stars: 5
url: https://github.com/albertshenc/academicwritingassistant
tier: "B"
...
content_hash: 43cb72ce12f45b39
  - methods/最强写作方法论_全球最强综合版.md
---

# AlbertShenC/AcademicWritingAssistant

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/albertshenc/academicwritingassistant
- **Stars**：5
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：AI tool to help inexperienced researchers to write more "SOTA" expression in academic papers, with a simple plugin to use it easily in overleaf.
- **本地描述**：AI tool to help inexperienced researchers to write more "SOTA" expression in academic papers, with a simple plugin to use it easily in overleaf.
- **拉取时间**：2026-07-23 22:50:46
