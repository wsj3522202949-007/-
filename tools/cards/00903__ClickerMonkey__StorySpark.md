...
![StorySpark Logo](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/1-login.png)
...
1. **Story Details & Concept** - Define the basic premise, title, and story parameters
   ![Story Details](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/3-story-details.png)

2. **Setting Expansion** - AI helps you develop rich, detailed story settings
   ![Expand Setting](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/4-expand-setting.png)

3. **Character Definition** - Create and refine character profiles with detailed descriptions
   ![Define Characters](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/5-define-characters.png)

4. **Story Review & Core Imagery** - Review the complete narrative and generate core visual concepts before page-by-page imagery
   ![Review Story](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/6-review-story.png)

5. **Image Generation** - Transform your story into illustrated pages with AI-generated artwork
   ![Generate Images](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/7-generate-images.png)
...
![Library View](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/2-library.png)
...
![Profile Settings](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/14-profile.png)
...
![Replicate Configuration](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/15-profile-replicate.png)
...
![Add Model](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/16-add-model.png)
![Analyze Model](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/17-analyze-model.png)
![Model Configuration](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/18-model-configuration.png)
...
- **Core Image Regeneration** - Regenerate the thematic core imagery that guides all page illustrations
  ![Regenerate Core Image](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/8-regenerate-core-image.png)

- **Individual Page Regeneration** - Regenerate specific page images without affecting the rest of your story
  ![Regenerate Page Image](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/9-regenerate-page-image.png)
...
![Read Mode](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/11-read-mode.png)
![View Image](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/12-view-image.png)
...
![Finished Story](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/10-story-finished.png)
![Exported PDF](https://github.com/ClickerMonkey/StorySpark/blob/main/docs/13-exported-pdf.png)
