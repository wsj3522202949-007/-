...
[`docs/benchmark.md`](https://github.com/TaewoooPark/personal-humanizer-maker/blob/main/docs/benchmark.md).
...
Original work in this repository is released under the [MIT License](https://github.com/TaewoooPark/personal-humanizer-maker/blob/main/LICENSE).
