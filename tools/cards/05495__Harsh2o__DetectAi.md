...
> 📖 **Deep dive:** See [docs/architecture.md](https://github.com/Harsh2o/DetectAi/blob/main/docs/architecture.md) for full technical details on each branch.
...
|----------|-------------|
| [Architecture](https://github.com/Harsh2o/DetectAi/blob/main/docs/architecture.md) | Full system architecture, engine details, and infrastructure |
| [API Reference](https://github.com/Harsh2o/DetectAi/blob/main/docs/api_reference.md) | Complete REST API endpoint documentation |
| [Text Engine](https://github.com/Harsh2o/DetectAi/blob/main/docs/text_engine_architecture.md) | Deep-dive into the text detection pipeline |
| [Contributing](https://github.com/Harsh2o/DetectAi/blob/main/CONTRIBUTING.md) | Development setup and contribution guidelines |

---

## 📄 License

This project is licensed under **All Rights Reserved** — see the [LICENSE](https://github.com/Harsh2o/DetectAi/blob/main/LICENSE) file for details. You may view this code for educational purposes, but copying, deploying, or modifying it is strictly prohibited.
