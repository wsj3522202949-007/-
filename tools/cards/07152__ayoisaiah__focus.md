...
source: https://github.com/ayoisaiah/focus
created: 2026-07-18
updated: 2026-07-18
no: 7152
category: 画龙补充 / 扩容入库 — 补充源
repo: ayoisaiah/focus
stars: 581
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/ayoisaiah/focus
- **Stars**：581
- **语言**：Go
- **License**：MIT
- **Topics**：command-line, countdown-timer, pomodoro, pomodoro-timer, productivity, whitenoise
- **GitHub 描述**：A fully featured productivity timer for the command line, based on the Pomodoro Technique. Supports Linux, Windows, and macOS.
- **本地描述**：focus
- **拉取时间**：2026-07-25 19:12:26
