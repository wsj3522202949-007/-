...
source: https://github.com/stanleyylin/miso
created: 2026-07-18
updated: 2026-07-18
no: 5718
category: 一、去 AI 味 / Humanizer 库
repo: stanleyylin/Miso
stars: 4
...
- **链接**：https://github.com/stanleyylin/miso
- **Stars**：4
- **语言**：Python
- **License**：MIT
- **Topics**：discord, discord-bot, html-css, python, react, reactjs, webapp
- **GitHub 描述**：Meet Miso, an AI-powered misogyny detector in text messages. Winner of UofT Hacks Best Hack to Empower Females in STEM.
- **本地描述**：Meet Miso, an AI-powered misogyny detector in text messages. Winner of UofT Hacks Best Hack to Empower Females in STEM.
- **拉取时间**：2026-07-25 18:29:02
