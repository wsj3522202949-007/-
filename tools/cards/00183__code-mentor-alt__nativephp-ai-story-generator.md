...
![Demo](https://github.com/code-mentor-alt/nativephp-ai-story-generator/blob/main//docs/demo.gif)

[View full demo video (With Audio)](https://github.com/code-mentor-alt/nativephp-ai-story-generator/blob/main/docs/demo.mp4)
