...
title: Disappearing_Text_Tkinter_App
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/id-dark-dragon/disappearing_text_tkinter_app
created: 2026-07-18
updated: 2026-07-18
no: 1001
category: 二、网文 / 长篇 AI 写作系统 库
repo: Id-Dark-Dragon/Disappearing_Text_Tkinter_App
stars: 0
url: https://github.com/id-dark-dragon/disappearing_text_tkinter_app
tier: "C"
...
- **链接**：https://github.com/id-dark-dragon/disappearing_text_tkinter_app
- **Stars**：0
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：Interfaced Creative Writing App using Tkinter GUI Framework - Package-Based Structure
- **本地描述**：Interfaced Creative Writing App using Tkinter GUI Framework - Package-Based Structure
- **拉取时间**：2026-07-23 23:08:13
