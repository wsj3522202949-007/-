...
See the [full changelog](https://github.com/rudra496/StealthHumanizer/blob/main/CHANGELOG.md#230---2026-06-28) for details.
...
> 💡 **Troubleshooting?** See our [comprehensive troubleshooting guide](https://github.com/rudra496/StealthHumanizer/blob/main/docs/TROUBLESHOOTING.md) for common issues and solutions.
...
1. Open **Settings**, then go to **Danger Zone** and clear old keys if you want a clean reset.
   ![Groq Free Step 1](https://github.com/rudra496/StealthHumanizer/blob/main/steps/1.jpg)

2. In provider selection, choose **Groq (FREE)**.
   ![Groq Free Step 2](https://github.com/rudra496/StealthHumanizer/blob/main/steps/2.jpg)

3. In the Groq settings card, click **Get API Key**.
   ![Groq Free Step 3](https://github.com/rudra496/StealthHumanizer/blob/main/steps/3.jpg)

4. In Groq Console, create a key (set name + expiration setting).
   ![Groq Free Step 4](https://github.com/rudra496/StealthHumanizer/blob/main/steps/4.jpg)

5. Copy the generated Groq key (usually visible once).
   ![Groq Free Step 5](https://github.com/rudra496/StealthHumanizer/blob/main/steps/5.jpg)

6. Paste it into StealthHumanizer’s Groq API key field and press **Save**.
   ![Groq Free Step 6](https://github.com/rudra496/StealthHumanizer/blob/main/steps/6.jpg)

7. Click **Test Key** and confirm the key is valid.
   ![Groq Free Step 7](https://github.com/rudra496/StealthHumanizer/blob/main/steps/7.jpg)

8. Return to provider selection and keep **Groq (Free)** active.
   ![Groq Free Step 8](https://github.com/rudra496/StealthHumanizer/blob/main/steps/8.jpg)

9. Configure Humanizer options (rewrite level, style, tone, target score, max words).
   ![Groq Free Step 9](https://github.com/rudra496/StealthHumanizer/blob/main/steps/9.jpg)

10. Paste/upload your text and run the pipeline.
    ![Groq Free Step 10](https://github.com/rudra496/StealthHumanizer/blob/main/steps/10.jpg)

11. Review output, re-humanize if needed, and export.
    ![Groq Free Step 11](https://github.com/rudra496/StealthHumanizer/blob/main/steps/11.jpg)
...
Read [CONTRIBUTING.md](https://github.com/rudra496/StealthHumanizer/blob/main/CONTRIBUTING.md) for full guidelines.
...
[MIT License](https://github.com/rudra496/StealthHumanizer/blob/main/LICENSE) &copy; 2024 Rudra Sarker. Free for personal and commercial use.
...
**[⭐ Star this repo](https://github.com/rudra496/StealthHumanizer/blob/main/../../stargazers) · [🍴 Fork it](https://github.com/rudra496/StealthHumanizer/blob/main/../../fork) · [👤 Follow @rudra496](https://github.com/rudra496)**
