...
4. Optionally register `slop mcp` with your AI client. See
   [`skills/agentic-humanizer/references/slop-mcp-setup.md`](https://github.com/numen-tech/slopornot/blob/main/skills/agentic-humanizer/references/slop-mcp-setup.md)
...
SlopOrNot is licensed under the [MIT License](https://github.com/numen-tech/slopornot/blob/main/LICENSE).
...
See [`CONTRIBUTING.md`](https://github.com/numen-tech/slopornot/blob/main/CONTRIBUTING.md). New harness routing files are
welcome.
