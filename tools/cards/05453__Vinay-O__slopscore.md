...
[`ANTI_SLOP_PROTOCOL.md`](https://github.com/Vinay-O/slopscore/blob/main/ANTI_SLOP_PROTOCOL.md) is a **286-pattern operating manual** for AI agents. Hand it to Claude Code, Cursor, Codex CLI, Aider, Copilot, Windsurf, or Cline and say:
...
*(The rule-definition file and example fixtures are excluded — they necessarily contain the very strings slopscore looks for, exactly as ESLint excludes its own fixtures. See [`.slopscoreignore.md`](https://github.com/Vinay-O/slopscore/blob/main/.slopscoreignore.md).)*
...
The CLI runs the deterministic subset; the [full 286-pattern catalog](https://github.com/Vinay-O/slopscore/blob/main/ANTI_SLOP_PROTOCOL.md) (including visual, architectural, and judgment-heavy patterns) is what you hand your agent.
...
MIT — see [LICENSE](https://github.com/Vinay-O/slopscore/blob/main/LICENSE). Use it, fork it, build it into your pipeline.
