...
title: Papyrus-Author-Novel-Drafting-Tool
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/papyrus-author-mac-writing-software/papyrus-author-novel-drafting-tool
created: 2026-07-18
updated: 2026-07-18
no: 695
category: 二、网文 / 长篇 AI 写作系统 库
repo: Papyrus-Author-Mac-Writing-Software/Papyrus-Author-Novel-Drafting-Tool
stars: 0
url: https://github.com/papyrus-author-mac-writing-software/papyrus-author-novel-drafting-tool
tier: "C"
...
content_hash: 8bd72c4af0844314
  - methods/最强写作方法论_全球最强综合版.md
---

# Papyrus-Author-Mac-Writing-Software/Papyrus-Author-Novel-Drafting-Tool

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/papyrus-author-mac-writing-software/papyrus-author-novel-drafting-tool
- **Stars**：0
- **语言**：None
- **License**：None
- **Topics**：—
- **GitHub 描述**：Papyrus Author novel drafting tool provides advanced features for planning and writing books, scripts, and academic papers. Enjoy character and plot management, integrated research panels, and export to popular formats.
- **本地描述**：Papyrus Author novel drafting tool provides advanced features for planning and writing books, scripts, and academic papers. Enjoy character and plot management, integrated research panels, and export to popular formats.
- **拉取时间**：2026-07-23 22:59:17
