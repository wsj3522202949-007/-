...
title: chatgpt-comparison-detection
...
- **语言**：Python
- **License**：None
- **Topics**：ai, chatbot, chatgpt, dataset, deep-learning, gpt-3, gpt2, gpt3, machine-learning, ml, nlp, openai, python, text-classification
- **GitHub 描述**：Human ChatGPT Comparison Corpus (HC3), Detectors, and more! 🔥
- **本地描述**：chatgpt-comparison-detection
- **拉取时间**：2026-07-25 19:16:57
...
> Train/Test splits & filtered versions of the paper, ref to Google Drive links in [HC3/README.md](https://github.com/hello-simpleai/chatgpt-comparison-detection/blob/main/HC3/README.md).
