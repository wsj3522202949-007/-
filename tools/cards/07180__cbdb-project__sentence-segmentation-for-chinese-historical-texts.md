...
title: sentence-segmentation-for-chinese-historical-texts
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/cbdb-project/sentence-segmentation-for-chinese-historical-texts
created: 2026-07-18
updated: 2026-07-18
no: 7180
category: 画龙补充 / 扩容入库 — 补充源
repo: cbdb-project/sentence-segmentation-for-chinese-historical-texts
stars: 32
url: https://github.com/cbdb-project/sentence-segmentation-for-chinese-historical-texts
tier: "B"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/cbdb-project/sentence-segmentation-for-chinese-historical-texts
- **Stars**：32
- **语言**：None
- **License**：NOASSERTION
- **Topics**：china, history, segmentation, text
- **GitHub 描述**：This is a pre-trained LSTM model. This model can help you to segment unpunctuated historical Chinese texts. 這是基於 LSTM 的預訓練模型。此模型可幫助您為漢語古文斷句。
- **本地描述**：sentence-segmentation-for-chinese-historical-texts
- **拉取时间**：2026-07-25 19:13:17
