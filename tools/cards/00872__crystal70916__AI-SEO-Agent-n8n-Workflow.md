...
2.  **Configure Tools Workflow:**
    * Open the "Tools" workflow and configure each HTTP Request node with your **DataForSEO** API credentials, as shown in the [video guide](https://github.com/crystal70916/AI-SEO-Agent-n8n-Workflow/blob/main/[https://www.youtube.com/watch?v=r9WMbzfY-mg&t]).
...
4.  **Deploy Frontend:**
    ...
    * In the v0.dev chat prompt, ask it to replace the old webhook URL with your new one, as shown in the [video guide](https://github.com/crystal70916/AI-SEO-Agent-n8n-Workflow/blob/main/[https://www.youtube.com/watch?v=r9WMbzfY-mg&t]).
5.  **Activate & Test:**
