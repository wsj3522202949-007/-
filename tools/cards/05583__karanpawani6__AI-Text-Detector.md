...
Full methodology, parameter sweeps, cross-validation results, and failure-case analysis are documented in [`reports/AI_Text_Detection_Final_Report.docx`](https://github.com/karanpawani6/AI-Text-Detector/blob/main/reports/AI_Text_Detection_Final_Report.docx).
