...
> **Note:** Live demo may take 30 seconds to wake up on first request (Render free tier limitation). For deployment instructions, see [DEPLOYMENT.md](https://github.com/miki42v/ai-threat-detector/blob/main/DEPLOYMENT.md).
...
For detailed deployment instructions to production (Vercel + Render), see [DEPLOYMENT.md](https://github.com/miki42v/ai-threat-detector/blob/main/DEPLOYMENT.md).
