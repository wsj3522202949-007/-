...
area: 库
status: active
tags: [协议未明, 需API密钥, 中文友好]
title: ai_novelgenerator
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/limcod/ai_novelgenerator
created: 2026-07-18
updated: 2026-07-18
no: 7385
category: 画龙补充 / 扩容入库 — 补充源
repo: limcod/ai_novelgenerator
stars: 0
url: https://github.com/limcod/ai_novelgenerator
tier: "C"
...
content_hash: 56cb706e6914be48
  - methods/QUICK_START.md
---

# limcod/ai_novelgenerator

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/limcod/ai_novelgenerator
- **Stars**：0
- **语言**：None
- **License**：None
- **Topics**：—
