...
source: https://github.com/abehou/semstamp
created: 2026-07-18
updated: 2026-07-18
no: 7120
category: 画龙补充 / 扩容入库 — 补充源
repo: abehou/semstamp
stars: 29
url: https://github.com/abehou/semstamp
tier: "B"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/abehou/semstamp
- **Stars**：29
- **语言**：Python
- **License**：None
- **Topics**：—
- **GitHub 描述**：Repo for SemStamp (NAACL2024) and k-SemStamp (ACL2024)
- **本地描述**：semstamp
- **拉取时间**：2026-07-25 19:11:29
