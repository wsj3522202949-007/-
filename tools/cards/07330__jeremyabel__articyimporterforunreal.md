...
title: articyimporterforunreal
summary: Claude Code 插件式写作流
source: https://github.com/jeremyabel/articyimporterforunreal
created: 2026-07-18
updated: 2026-07-18
no: 7330
category: 画龙补充 / 扩容入库 — 补充源
repo: jeremyabel/articyimporterforunreal
stars: 0
url: https://github.com/jeremyabel/articyimporterforunreal
tier: "C"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/jeremyabel/articyimporterforunreal
- **Stars**：0
- **语言**：None
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：Articy Importer plugin for the Unreal Engine 4 and Unreal Engine 5 (work in progress).
- **本地描述**：articyimporterforunreal
- **拉取时间**：2026-07-25 19:18:04
...
**Unreal Engine 5**
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/ImporterButtonUE5.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/custom-method-node.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/interface-class-settings.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/implement-custom-function.png)

This will create a new event node in your Blueprint graph with all the appropriate parameters.

![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/custom-function-node.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/articy-return-custom-method.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/implement-custom-return-function.png)

Then, you'll get a custom function in Blueprint that can return a value.

![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/custom-function-return-blueprint.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/check-shadow-state.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/create-alternative-globals.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/assign-alternative-globals.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/get-vars-bp.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/get-script-gvs-bp.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/2021-10-31-10-31-19.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/2021-10-31-10-36-25.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/2021-10-31-10-48-28.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/2021-10-31-10-49-09.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/2021-10-31-10-50-17.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/2021-10-31-10-50-31.png)
...
![](https://github.com/jeremyabel/articyimporterforunreal/blob/master/docs/CookSettings.png)
