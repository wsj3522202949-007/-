...
area: 库
status: active
tags: [TTS, 协议宽松, 需API密钥, 英文文档]
title: awesome-ai-tools
summary: 小说转语音/有声书
source: https://github.com/sarahofai/awesome-ai-tools
created: 2026-07-18
updated: 2026-07-18
no: 7531
category: 画龙补充 / 扩容入库 — 补充源
repo: sarahofai/awesome-ai-tools
stars: 50
url: https://github.com/sarahofai/awesome-ai-tools
tier: "A"
use_case: "小说转语音/有声书"
pitfalls:
...
# sarahofai/awesome-ai-tools

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/sarahofai/awesome-ai-tools
- **Stars**：50
- **语言**：None
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：A curated list of Artificial Intelligence Top Tools
- **本地描述**：awesome-ai-tools
- **拉取时间**：2026-07-25 19:24:46
...
- [Amazon Q Developer](https://github.com/sarahofai/awesome-ai-tools/blob/main/[https://aws.amazon.com/codewhisperer/](https://aws.amazon.com/q/developer/build/?trk=fd6bb27a-13b0-4286-8269-c7b1cfaa29f0&sc_channel=el)) - AI coding assistant with extensions for IDEs such as VS Code and IntelliJ IDEA that provides both chat and agentic workflows.
