...
area: 库
status: active
tags: [RAG, Claude插件, Python, 协议传染, 本地优先, 中文友好, 人物设定, 本地写作]
title: Novel-Claude
summary: 长篇设定/人物一致性（RAG 记忆）
source: https://github.com/wzxsph/novel-claude
created: 2026-07-18
updated: 2026-07-18
no: 1649
category: 二、网文 / 长篇 AI 写作系统 库
repo: wzxsph/Novel-Claude
stars: 11
url: https://github.com/wzxsph/novel-claude
tier: "B"
...
- **链接**：https://github.com/wzxsph/novel-claude
- **Stars**：11
- **语言**：Python
- **License**：GPL-3.0
- **Topics**：agent, ai, ai-writer, llm, mcp, rag, story-generation, web-novel
- **GitHub 描述**：🚀 工业级 AI 长篇网文生成框架 | An industrial-grade AI web novel generation framework based on a microkernel and plugin architecture, featuring context isolation, RAG memory, and MCP-inspired skills for writing million-word stories.
- **本地描述**：🚀 工业级 AI 长篇网文生成框架 （ An industrial-grade AI web novel generation framework based on a microkernel and plugin architecture, featuring context isolation, RAG memory, and MCP-inspired skills for writing million-word stories.
- **拉取时间**：2026-07-23 23:27:07

---

# 🚀 Novel-Claude V3: Agentic Novel Generation Framework

[简体中文](https://github.com/wzxsph/Novel-Claude/blob/main/README.md) | [English](https://github.com/wzxsph/Novel-Claude/blob/main/README_EN.md) | [日本語](https://github.com/wzxsph/Novel-Claude/blob/main/README_JP.md)
