...
title: Distilled-Novel-Toolbox
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/dama-cyber/distilled-novel-toolbox
created: 2026-07-18
updated: 2026-07-18
no: 1293
category: 二、网文 / 长篇 AI 写作系统 库
repo: dama-cyber/Distilled-Novel-Toolbox
stars: 157
url: https://github.com/dama-cyber/distilled-novel-toolbox
tier: "A"
...
- **链接**：https://github.com/dama-cyber/distilled-novel-toolbox
- **Stars**：157
- **语言**：None
- **License**：None
- **Topics**：—
- **GitHub 描述**：??????? - novel writing skills toolbox
- **本地描述**：??????? - novel writing skills toolbox
- **拉取时间**：2026-07-23 23:16:47
