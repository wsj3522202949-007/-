...
title: LLM-StockTrading
summary: 长篇人物/设定/伏笔一致性（RAG 记忆库）
source: https://github.com/pixelwhiz/llm-stocktrading
created: 2026-07-18
updated: 2026-07-18
no: 4382
category: 四、长篇一致性 / RAG / 故事圣经 库
repo: pixelwhiz/LLM-StockTrading
stars: 1
url: https://github.com/pixelwhiz/llm-stocktrading
tier: "B"
...
content_hash: c98a8c656ed15888
  - methods/模板库.md
---

# pixelwhiz/LLM-StockTrading

- **分类**：四、长篇一致性 / RAG / 故事圣经 库
- **链接**：https://github.com/pixelwhiz/llm-stocktrading
- **Stars**：1
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：A Performance-Enhanced LLM Trading Agent with Layered Memory and Character Design
- **本地描述**：A Performance-Enhanced LLM Trading Agent with Layered Memory and Character Design
- **拉取时间**：2026-07-25 17:45:14
...
![1](https://github.com/pixelwhiz/LLM-StockTrading/blob/main/figures/memory_flow.png)
![2](https://github.com/pixelwhiz/LLM-StockTrading/blob/main/figures/workflow.png)
![3](https://github.com/pixelwhiz/LLM-StockTrading/blob/main/figures/character.png)
