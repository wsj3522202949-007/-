...
area: 库
status: active
tags: [RAG, TypeScript, 协议未明, 需API密钥, 中文友好, 人物设定]
...
repo: explosivecoderflome/ai-novel-writing-assistant
stars: 2112
...
![当前长篇生成能力支撑图](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E6%B5%81%E7%A8%8B%E5%9B%BE.svg?v=1)
...
完整历史更新见 [docs/releases/release-notes.md](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/docs/releases/release-notes.md)。
...
> 查看完整更新历史：[docs/releases/release-notes.md](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/docs/releases/release-notes.md)
...
![提示词编辑器](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/ScreenShot_2026-07-08_140153_328.png)

### Creative Hub

统一承载对话、规划、工具执行和创作推进的创作中枢。

![创作中枢](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E5%88%9B%E4%BD%9C%E4%B8%AD%E6%9E%A2.png)

### 自动导演模式

自动导演创建页现在会把一句灵感、导演起始参数、书级 framing、模型设置和运行方式收进同一面板；进入方向选择后，不只是给你两套整本方案，还会配套书名组选项、推荐理由和定向重做入口，适合先把这本书“该怎么开”定下来。

![自动导演创建](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E5%AF%BC%E6%BC%94%E6%A8%A1%E5%BC%8F-%E5%88%9B%E5%BB%BA.png)

![自动导演选择方向](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E5%AF%BC%E6%BC%94%E6%A8%A1%E5%BC%8F-%E9%80%89%E6%8B%A9%E6%96%B9%E5%90%91.png)

![自动导演执行中](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E5%AF%BC%E6%BC%94%E6%A8%A1%E5%BC%8F-%E5%88%9B%E5%BB%BA%E4%B8%AD.png)

![自动导演交接与继续执行](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E5%AF%BC%E6%BC%94%E6%A8%A1%E5%BC%8F-%E7%BC%96%E8%BE%91.png)

### 项目设定

项目设定已经挂到单书工作台的连续流程里：左侧能直接看到当前步骤与整体进度，上方能看到 AI 接管状态，正文区则集中处理标题、简介、书级 framing、写法确认和本书真正会用到的世界边界。

![项目设定](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/write/%E9%A1%B9%E7%9B%AE%E8%AE%BE%E5%AE%9A.png)

### 故事宏观规划

故事宏观规划不再只是大段摘要，而是先把故事引擎、推进与兑现摘要、长期对立和前 30 章承诺压成后续可继承的书级引导层，先保证整本主线能推，再把卷级和章节级规划建在这套底盘上。

![故事宏观规划](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/write/%E6%95%85%E4%BA%8B%E5%AE%8F%E8%A7%82%E8%A7%84%E5%88%92.png)

### 角色准备

角色准备页现在更像角色工作台而不是角色表单：会先盘点目标区段的核心角色，再给出 AI 阵容方案、结构关系网和动态角色系统，减少开书后角色断档、功能位缺失和关系推进失速。

![角色准备](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/write/%E8%A7%92%E8%89%B2%E5%87%86%E5%A4%87.png)

### 卷战略 / 卷骨架

卷战略阶段已经开始显式区分“卷战略、卷骨架、节奏板、拆章节”四个阶段完成度。系统会先判断当前是不是已经具备继续推进条件，再生成卷战略建议、审查卷骨架，并把版本控制与影响分析收进同一页。

![卷战略 / 卷骨架](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/write/%E5%8D%B7%E6%88%98%E7%95%A5.png)

### 节奏 / 拆章

节奏 / 拆章现在把节奏段列表、批量细化、单章标题、摘要、章节目标和任务单放进同一工作区；可以按当前可见章节或指定范围连续细化，也可以对摘要和目标做局部 AI 修正，更适合连载网文式的持续推进。

![节奏 / 拆章](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/write/%E8%8A%82%E5%A5%8F%E6%8B%86%E7%AB%A0.png)

### 章节执行

章节执行页现在更像主写作工作台：左侧是章节卡片与下一步状态，中间是已保存正文和版本区，右侧则把执行计划、正文写作、审核、修复、状态同步和伏笔回填收在同一套动作面板里，适合逐章推进。

![章节执行](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/write/%E7%AB%A0%E8%8A%82%E6%89%A7%E8%A1%8C.png)

### 质量修复

质量修复已经从零散按钮收成独立工作台：可以围绕当前章节执行审核、执行修复、生成钩子，并结合当前批次、质量阈值和 AI 输出继续往后处理，适合把“写完之后怎么稳住质量”也纳入主流程。

![质量修复](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/write/%E8%B4%A8%E9%87%8F%E4%BF%AE%E5%A4%8D.png)

### 正文修改

当一章已经写出正文后，还可以进入独立正文编辑器继续局部改写。正文修改页会把任务单、审计结果和修复链路继续挂在这章身上，避免用户在“主写作区”和“精修区”之间断掉上下文。

![正文修改](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E6%AD%A3%E6%96%87%E4%BF%AE%E6%94%B9.jpeg)

### 小说列表

从这里进入开书、管理、编辑和整本生产。

![小说列表](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E5%B0%8F%E8%AF%B4%E5%88%97%E8%A1%A8.png)
...
![拆书分析](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E6%8B%86%E4%B9%A6.png)

### 知识库

统一管理文档、索引、重建任务和检索能力。

![知识库](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E7%9F%A5%E8%AF%86%E5%BA%93.png)

### 世界观

世界观不再只是描述文本，而是能生成世界骨架、维护世界手册，并绑定为每本小说自己的本书世界上下文。

![世界观](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E4%B8%96%E7%95%8C%E8%A7%82.png)

### 角色库

统一维护角色基础档案与小说内角色信息。

![角色库](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E8%A7%92%E8%89%B2%E5%BA%93.png)

### 类型管理

集中维护题材与类型资产，让故事规划、角色准备和正文生成共享同一套题材语言。

![类型管理](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E7%B1%BB%E5%9E%8B%E7%AE%A1%E7%90%86.jpeg)

### 流派管理

把推进模式、兑现方式和冲突边界收成可复用的流派模式资产，让整本书更容易保持读者预期。

![流派管理](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E6%B5%81%E6%B4%BE%E7%AE%A1%E7%90%86.jpeg)

### 标题工坊

批量生成、筛选和微调书名与标题方向，降低新手在开书命名阶段的试错成本。

![标题工坊](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E6%A0%87%E9%A2%98%E5%B7%A5%E5%9D%8A.jpeg)

### 写法引擎与反 AI 规则

统一管理写法资产、风格约束和反 AI 规则，让正文更像作品本身，而不是模板式补全文本。

![写法引擎与反 AI 规则](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E5%86%99%E6%B3%95%E5%BC%95%E6%93%8E%E4%B8%8E%E5%8F%8DAI%E8%A7%84%E5%88%99.jpeg)
![配置写法引擎的效果](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/ScreenShot_2026-04-22_154855_026.png)

### 任务中心

查看拆书、知识库重建和其他后台任务的排队、执行与失败状态。

![任务中心](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E4%BB%BB%E5%8A%A1%E4%B8%AD%E5%BF%83.png)

### 模型配置

为不同能力配置不同模型，减少一套模型硬吃所有任务的成本。

![模型配置](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E6%A8%A1%E5%9E%8B%E9%85%8D%E7%BD%AE.png)
...
更细的文档分区说明可以看 [docs/README.md](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/docs/README.md)。
...
![QQ 群二维码](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/images/%E7%BE%A42.png)
...
提交 Pull Request 即表示你确认自己有权提交该内容，并已阅读且同意 [CLA.md](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/CLA.md)；如果包含第三方代码、素材、AI 生成内容或其他受许可证约束的内容，请在 PR 中明确说明来源和许可证。详见 [CONTRIBUTING.md](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/CONTRIBUTING.md)。
...
- 如果你更关心阶段目标、优先级和后续优化计划，请直接查看 [TASK.md](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/TASK.md)。

## License

本项目采用双许可证授权模式：

- 默认情况下，本项目基于 GNU Affero General Public License v3.0 (AGPLv3) 授权，详见 [LICENSE](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/LICENSE)；归属与附加说明见 [NOTICE](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/NOTICE)。
- 服务型商用：将本项目（或其修改版本）作为后端以 SaaS、托管或其他形式向第三方提供服务，须通过作者获取商业授权许可。
- 请遵守开源协议条款，并在适用场景下取得相应授权。

贡献说明：新贡献默认按 [CLA.md](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/CLA.md) 提交，可随项目按 AGPL-3.0-only 分发，并可纳入项目维护者另行提供的商业授权；详见 [CONTRIBUTING.md](https://github.com/explosivecoderflome/ai-novel-writing-assistant/blob/main/CONTRIBUTING.md)。
