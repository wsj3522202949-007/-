...
area: 库
status: active
tags: [校对, Swift, 协议宽松, 需API密钥, 英文文档, 改稿润色]
title: ClipSlop
summary: 错别字/语法/风格校对
source: https://github.com/mekedron/clipslop
created: 2026-07-18
updated: 2026-07-18
no: 5473
category: 一、去 AI 味 / Humanizer 库
repo: mekedron/ClipSlop
stars: 21
...
- **链接**：https://github.com/mekedron/clipslop
- **Stars**：21
- **语言**：Swift
- **License**：MIT
- **Topics**：ai, anthropic, chatgpt, clipboard, grammar-checker, keyboard-shortcuts, macos, macos-app, ocr, ollama, open-source, productivity, prompt, shortcuts, swift, swiftui, text-transformation, translation, writing-tool
- **GitHub 描述**：AI writing tool for macOS — fix grammar, translate, rewrite, format text with a hotkey. Chain prompts into pipelines. Works with ChatGPT, Anthropic, Ollama. Free and open-source.
- **本地描述**：AI writing tool for macOS — fix grammar, translate, rewrite, format text with a hotkey. Chain prompts into pipelines. Works with ChatGPT, Anthropic, Ollama. Free and open-source.
- **拉取时间**：2026-07-25 18:20:00
