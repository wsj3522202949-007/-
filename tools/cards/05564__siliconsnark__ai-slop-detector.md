...
Download [`ai-slop-detector.md`](https://github.com/siliconsnark/ai-slop-detector/blob/main/ai-slop-detector.md), paste the file into Claude Cowork, Codex, ChatGPT, or your favorite chatbot, then either a) save it as a skill or b) insert the output you want reviewed under `Text To Review`.
...
- [`ai-slop-detector.md`](https://github.com/siliconsnark/ai-slop-detector/blob/main/ai-slop-detector.md): the reusable prompt
- [`LICENSE`](https://github.com/siliconsnark/ai-slop-detector/blob/main/LICENSE): MIT license
