...
title: 5W1H_prompt_generator
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/chloeloveai/5w1h_prompt_generator
created: 2026-07-18
updated: 2026-07-18
no: 1398
category: 二、网文 / 长篇 AI 写作系统 库
repo: chloeloveAI/5W1H_prompt_generator
stars: 0
url: https://github.com/chloeloveai/5w1h_prompt_generator
tier: "C"
...
content_hash: b64cc03570960318
  - methods/最强写作方法论_全球最强综合版.md
---

# chloeloveAI/5W1H_prompt_generator

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/chloeloveai/5w1h_prompt_generator
- **Stars**：0
- **语言**：HTML
- **License**：None
- **Topics**：—
- **GitHub 描述**：5W1H Prompt Generator helps users create structured prompts using the Who, What, When, Where, Why, and How framework. Users input key story elements, and the generator formats them into a well-structured prompt, ready for AI story generation. This tool simplifies AI-assisted storytelling, making prompts more organized and engaging.
- **本地描述**：5W1H Prompt Generator helps users create structured prompts using the Who, What, When, Where, Why, and How framework. Users input key story elements, and the generator formats them into a well-structured prompt, ready for AI story generation. This tool simplifies AI-assisted storytelling, making prompts more organized and engaging.
- **拉取时间**：2026-07-23 23:19:53

---

# 5W1H_prompt_generator
...
## 📜 License
This project is licensed under the **MIT License** – see the [LICENSE](https://github.com/chloeloveAI/5W1H_prompt_generator/blob/main/LICENSE) file for details.
