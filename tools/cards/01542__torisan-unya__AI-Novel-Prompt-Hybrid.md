...
title: AI-Novel-Prompt-Hybrid
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/torisan-unya/ai-novel-prompt-hybrid
created: 2026-07-18
updated: 2026-07-18
no: 1542
category: 二、网文 / 长篇 AI 写作系统 库
repo: torisan-unya/AI-Novel-Prompt-Hybrid
stars: 0
url: https://github.com/torisan-unya/ai-novel-prompt-hybrid
tier: "C"
...
content_hash: 0053ffab25ab0e6e
  - methods/最强写作方法论_全球最强综合版.md
---

# torisan-unya/AI-Novel-Prompt-Hybrid

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/torisan-unya/ai-novel-prompt-hybrid
- **Stars**：0
- **语言**：None
- **License**：NOASSERTION
- **Topics**：—
- **GitHub 描述**：Open-source AI prompt for novel writing with arXiv integration, CC BY SA4.0
- **本地描述**：Open-source AI prompt for novel writing with arXiv integration, CC BY SA4.0
- **拉取时间**：2026-07-23 23:24:05
