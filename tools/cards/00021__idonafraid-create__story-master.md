...
**English** · [简体中文](https://github.com/idonafraid-create/story-master/blob/main/README.zh-CN.md)
...
| File | Purpose |
|---|---|
| [SKILL.md](https://github.com/idonafraid-create/story-master/blob/main/SKILL.md) | Main Agent workflow rules, scaling guidelines, and quality gates. |
| [premise_7steps.md](https://github.com/idonafraid-create/story-master/blob/main/references/premise_7steps.md) | 10 steps to refine premise and the 7 key structural steps. |
| [character_theme.md](https://github.com/idonafraid-create/story-master/blob/main/references/character_theme.md) | Archetype directories, four-corner opposition, and double reversal design. |
| [world_symbols.md](https://github.com/idonafraid-create/story-master/blob/main/references/world_symbols.md) | Symbol networks, time structures, and spatial storytelling. |
| [plot_22steps.md](https://github.com/idonafraid-create/story-master/blob/main/references/plot_22steps.md) | In-depth breakdown of the 22 plot steps. |
| [scene_dialogue.md](https://github.com/idonafraid-create/story-master/blob/main/references/scene_dialogue.md) | Scene weaving techniques and three-track symphonic dialogue. |
...
[MIT](https://github.com/idonafraid-create/story-master/blob/main/LICENSE)
