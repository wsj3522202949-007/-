...
title: PhishGPT--Text-Email-content-Phishing-Detector-based-on-OpenAI-API
summary: 投稿前给正文降 AI 检测痕迹、改自然语气
source: https://github.com/juanchavarriau/phishgpt--text-email-content-phishing-detector-based-on-openai-api
created: 2026-07-18
updated: 2026-07-18
no: 5132
category: 一、去 AI 味 / Humanizer 库
repo: JuanChavarriaU/PhishGPT--Text-Email-content-Phishing-Detector-based-on-OpenAI-API
stars: 1
url: https://github.com/juanchavarriau/phishgpt--text-email-content-phishing-detector-based-on-openai-api
tier: "B"
...
content_hash: 208305a8e469276f
  - methods/改稿润色指令库.md
---

# JuanChavarriaU/PhishGPT--Text-Email-content-Phishing-Detector-based-on-OpenAI-API

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/juanchavarriau/phishgpt--text-email-content-phishing-detector-based-on-openai-api
- **Stars**：1
- **语言**：HTML
- **License**：None
- **Topics**：—
- **GitHub 描述**：A interesting capstone project for Wizeline ChatGPT developers sprint
- **本地描述**：A interesting capstone project for Wizeline ChatGPT developers sprint
- **拉取时间**：2026-07-25 18:07:19
