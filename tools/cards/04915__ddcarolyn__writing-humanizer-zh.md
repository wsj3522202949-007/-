...
source: https://github.com/ddcarolyn/writing-humanizer-zh
created: 2026-07-18
updated: 2026-07-18
no: 4915
category: 一、去 AI 味 / Humanizer 库
repo: ddcarolyn/writing-humanizer-zh
stars: 0
url: https://github.com/ddcarolyn/writing-humanizer-zh
tier: "C"
...
content_hash: 7d635d439786011b
  - methods/改稿润色指令库.md
---

# ddcarolyn/writing-humanizer-zh

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/ddcarolyn/writing-humanizer-zh
- **Stars**：0
- **语言**：None
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：Claude skill: remove AI writing patterns from Chinese text (translated from blader/humanizer, MIT)
- **本地描述**：Claude skill: remove AI writing patterns from Chinese text (translated from blader/humanizer, MIT)
- **拉取时间**：2026-07-25 17:59:13
