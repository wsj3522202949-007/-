...
area: 库
status: active
tags: [大纲规划, Claude插件, Python, 协议传染, 需API密钥, 中文友好]
...
- **License**：GPL-3.0
- **Topics**：—
- **GitHub 描述**：基于 Claude Code 的长篇网文辅助创作系统，解决 AI 写作中的「遗忘」和「幻觉」问题，支持 200 万字量级 连载创作。
- **本地描述**：webnovel-writer
- **拉取时间**：2026-07-25 19:20:21
...
完整列表见 [题材模板文档](https://github.com/lingfengqaq/webnovel-writer/blob/main/docs/guides/genres.md)。
...
更多命令见 [命令详解](https://github.com/lingfengqaq/webnovel-writer/blob/main/docs/guides/commands.md)。

## 文档导航

| 文档 | 内容 |
|------|------|
| [文档中心](https://github.com/lingfengqaq/webnovel-writer/blob/main/docs/README.md) | 所有文档索引和推荐阅读顺序 |
| [系统架构与模块](https://github.com/lingfengqaq/webnovel-writer/blob/main/docs/architecture/overview.md) | 核心理念、Agent 分工、Story System 设计 |
| [命令详解](https://github.com/lingfengqaq/webnovel-writer/blob/main/docs/guides/commands.md) | Skill 命令和 CLI 子命令速查 |
| [RAG 与配置](https://github.com/lingfengqaq/webnovel-writer/blob/main/docs/guides/rag-and-config.md) | 检索流程、环境变量、默认模型 |
| [题材模板](https://github.com/lingfengqaq/webnovel-writer/blob/main/docs/guides/genres.md) | 37 个题材模板和复合题材规则 |
| [项目结构与运维](https://github.com/lingfengqaq/webnovel-writer/blob/main/docs/operations/operations.md) | 目录层级、健康检查、备份恢复 |
| [插件发版](https://github.com/lingfengqaq/webnovel-writer/blob/main/docs/operations/plugin-release.md) | Marketplace 发版和版本同步流程 |
...
更多运维说明见 [项目结构与运维](https://github.com/lingfengqaq/webnovel-writer/blob/main/docs/operations/operations.md)。
...
本项目使用 [GPL v3](https://github.com/lingfengqaq/webnovel-writer/blob/main/LICENSE) 协议。
