...
source: https://github.com/eibarrr/ai-fake-news-detector
created: 2026-07-18
updated: 2026-07-18
no: 5189
category: 一、去 AI 味 / Humanizer 库
repo: eibaRRR/ai-fake-news-detector
stars: 3
url: https://github.com/eibarrr/ai-fake-news-detector
tier: "B"
...
content_hash: 463f9a97aa11370c
  - methods/改稿润色指令库.md
---

# eibaRRR/ai-fake-news-detector

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/eibarrr/ai-fake-news-detector
- **Stars**：3
- **语言**：JavaScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：A smart web application developed with Next.js that analyzes news content for potential misinformation. Users can submit news via image, URL, or plain text to get a detailed analysis including a trust score from verification sources.
- **本地描述**：A smart web application developed with Next.js that analyzes news content for potential misinformation. Users can submit news via image, URL, or plain text to get a detailed analysis including a trust score from verification sources.
- **拉取时间**：2026-07-25 18:09:23
