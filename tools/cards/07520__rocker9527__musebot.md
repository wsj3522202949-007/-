...
area: 库
status: active
tags: [TTS, 互动叙事, 协议宽松, 需API密钥, 中文友好]
title: musebot
summary: 小说转语音/有声书
source: https://github.com/rocker9527/musebot
created: 2026-07-18
updated: 2026-07-18
no: 7520
category: 画龙补充 / 扩容入库 — 补充源
repo: rocker9527/musebot
stars: 0
url: https://github.com/rocker9527/musebot
tier: "C"
use_case: "小说转语音/有声书"
pitfalls:
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/rocker9527/musebot
- **Stars**：0
- **语言**：None
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：supports Telegram, Discord, Slack, Lark（飞书），钉钉, 企业微信, QQ, 微信, compatible with various LLMs including OpenAI, Gemini, DeepSeek, Doubao, and OpenRouter. It offers intelligent conversation, image generation, video creation, and more. Works seamlessly in both private chats and group settings.
- **本地描述**：musebot
- **拉取时间**：2026-07-25 19:24:24
