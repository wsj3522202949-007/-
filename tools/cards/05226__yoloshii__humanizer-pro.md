...
area: 库
status: active
tags: [去AI味, 多Agent, TTS, 协议未明, 本地优先, 英文文档, 本地写作]
title: humanizer-pro
summary: 投稿前文本降 AI 痕、过检测
source: https://github.com/yoloshii/humanizer-pro
created: 2026-07-18
updated: 2026-07-18
no: 5226
category: 一、去 AI 味 / Humanizer 库
repo: yoloshii/humanizer-pro
stars: 5
url: https://github.com/yoloshii/humanizer-pro
tier: "B"
...
content_hash: ae7b952ec900a268
  - methods/改稿润色指令库.md
---

# yoloshii/humanizer-pro

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/yoloshii/humanizer-pro
- **Stars**：5
- **语言**：None
- **License**：NOASSERTION
- **Topics**：—
- **GitHub 描述**：Enables LLMs to write text that passes AI detection by applying 39 composition constraints from Wikipedia and peer-reviewed stylometric research.
- **本地描述**：Enables LLMs to write text that passes AI detection by applying 39 composition constraints from Wikipedia and peer-reviewed stylometric research.
- **拉取时间**：2026-07-25 18:10:44
