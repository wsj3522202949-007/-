...
area: 库
status: active
tags: [Shell, 协议未明, 本地优先, 中文友好, 本地写作]
title: novel-kit
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/t59688/novel-kit
created: 2026-07-18
updated: 2026-07-18
no: 7564
category: 画龙补充 / 扩容入库 — 补充源
repo: t59688/novel-kit
stars: 148
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/t59688/novel-kit
- **Stars**：148
- **语言**：Shell
- **License**：None
- **Topics**：—
- **GitHub 描述**：NovelKit 是一个基于规范驱动开发（Spec-Driven Development）理念的 AI 小说写作工具包，帮助作者使用 AI 助手创作百万字长篇小说。
- **本地描述**：novel-kit
- **拉取时间**：2026-07-25 19:25:46
...
> 📖 **完整命令列表和使用说明请查看 [命令文档](https://github.com/t59688/novel-kit/blob/main/docs/commands.md)**
...
- [📋 命令文档](https://github.com/t59688/novel-kit/blob/main/docs/commands.md) - 完整的命令列表和使用说明
- [🔧 构建文档](https://github.com/t59688/novel-kit/blob/main/docs/build.md) - 如何构建和发布 NovelKit
- [🤝 贡献指南](https://github.com/t59688/novel-kit/blob/main/CONTRIBUTING.md) - 如何参与项目开发
- [🐛 问题反馈](https://github.com/t59688/novel-kit/issues) - 报告 Bug 或提出建议

## 🤝 贡献

欢迎贡献代码、报告问题或提出建议！请查看 [贡献指南](https://github.com/t59688/novel-kit/blob/main/CONTRIBUTING.md) 了解详情。
