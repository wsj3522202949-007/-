...
area: 库
status: active
tags: [Ren'Py, 协议宽松, 本地优先, 英文文档, 本地写作]
title: learntocoderpg
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/freecodecamp/learntocoderpg
created: 2026-07-18
updated: 2026-07-18
no: 7259
...
stars: 1133
url: https://github.com/freecodecamp/learntocoderpg
tier: "S"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/freecodecamp/learntocoderpg
- **Stars**：1133
- **语言**：Ren'Py
- **License**：BSD-3-Clause
- **Topics**：game, learn-to-code, renpy, renpy-game, renpy-visual-novels, video-game, visual-novel
- **GitHub 描述**：A visual novel video game where you learn to code and get a dev job 🎯
- **本地描述**：learntocoderpg
- **拉取时间**：2026-07-25 19:15:50
