...
- **[Data Generation Pipeline](https://github.com/JonathanZha47/PadBen-Paraphrase-Attack-Benchmark/blob/main/data_generation/README.md)**: Complete guide to LLM-based text generation (Type 2, 4, 5)
- **[Data Processing Module](https://github.com/JonathanZha47/PadBen-Paraphrase-Attack-Benchmark/blob/main/data_processing/README.md)**: Multi-dataset processing and standardization
- **[Quality Assurance Tools](https://github.com/JonathanZha47/PadBen-Paraphrase-Attack-Benchmark/blob/main/data_quality_assurance/README.md)**: Quality metrics, similarity analysis, and RAID comparison
- **[Task Preparation](https://github.com/JonathanZha47/PadBen-Paraphrase-Attack-Benchmark/blob/main/task_preparation/README.md)**: Task preparation and data formatting utilities

### Intrinsic Mechanism Experiments

- **[Experiment 1](https://github.com/JonathanZha47/PadBen-Paraphrase-Attack-Benchmark/blob/main/intrinsic_mechanism/experiment1/README.md)**: Semantic vs Paraphrase Analysis using BGE-m3 embeddings
- **[Experiment 2](https://github.com/JonathanZha47/PadBen-Paraphrase-Attack-Benchmark/blob/main/intrinsic_mechanism/experiment2/README.md)**: Iterative Paraphrasing Semantic Drift Analysis

### Data Documentation

- **[Data Documentation](https://github.com/JonathanZha47/PadBen-Paraphrase-Attack-Benchmark/blob/main/data/README.md)**: Generated benchmark data and task-specific datasets
- 
## 📝 Citation
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/JonathanZha47/PadBen-Paraphrase-Attack-Benchmark/blob/main/LICENSE) file for details.
