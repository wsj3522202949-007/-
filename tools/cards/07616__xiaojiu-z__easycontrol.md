...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/xiaojiu-z/easycontrol
- **Stars**：1732
- **语言**：Python
- **License**：Apache-2.0
- **Topics**：—
- **GitHub 描述**：Implementation of "EasyControl: Adding Efficient and Flexible Control for Diffusion Transformer"(ICCV2025)
- **本地描述**：easycontrol
- **拉取时间**：2026-07-25 19:27:50
