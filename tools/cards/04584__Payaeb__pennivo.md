...
| :------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------: |
|    ![Light theme](https://github.com/Payaeb/pennivo/blob/main/assets/screenshots/01-light-default.png)    |       ![Dark theme](https://github.com/Payaeb/pennivo/blob/main/assets/screenshots/02-dark-default.png)       |
|                                      **Command palette**                                     |                                        **Settings panel**                                        |
| ![Command palette](https://github.com/Payaeb/pennivo/blob/main/assets/screenshots/03-command-palette.png) |          ![Settings](https://github.com/Payaeb/pennivo/blob/main/assets/screenshots/04-settings.png)          |
|                                     **Mermaid diagrams**                                     |                                     **Customizable toolbar**                                     |
|     ![Mermaid diagrams](https://github.com/Payaeb/pennivo/blob/main/assets/screenshots/05-mermaid.png)    | ![Customize toolbar](https://github.com/Payaeb/pennivo/blob/main/assets/screenshots/06-customize-toolbar.png) |
...
The warning is expected and unavoidable until a code-signing certificate is in place. The installer is built directly from this repository by [GitHub Actions](https://github.com/Payaeb/pennivo/blob/main/.github/workflows/release.yml) — you can verify the source for each release against the published artifacts.
...
* The workspace uses pnpm with `node-linker=hoisted` (see [.npmrc](https://github.com/Payaeb/pennivo/blob/main/.npmrc)). This is required for electron-builder to trace transitive dependencies into the packed `app.asar`. Don't change it.

* `electron` is pinned to an exact version in [packages/desktop/package.json](https://github.com/Payaeb/pennivo/blob/main/packages/desktop/package.json) — electron-builder requires a fixed version under hoisted layouts.

* Issues and pull requests are welcome. For larger changes, please open an issue first so we can discuss the approach.

## License

[MIT](https://github.com/Payaeb/pennivo/blob/main/LICENSE) © 2026 Paya Ebrahimi
