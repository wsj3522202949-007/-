...
area: 库
status: active
tags: [大纲规划, Python, 协议传染, 需API密钥, 中文友好]
title: AINovelStudio
summary: 搭大纲/分卷/节拍
source: https://github.com/wsly2006/ainovelstudio
created: 2026-07-18
updated: 2026-07-18
no: 29
category: 二、网文 / 长篇 AI 写作系统 库
repo: wsly2006/AINovelStudio
stars: 1
url: https://github.com/wsly2006/ainovelstudio
tier: "B"
use_case: "搭大纲/分卷/节拍"
pitfalls:
...
content_hash: 8c4359dd0ba6f091
  - methods/最强写作方法论_全球最强综合版.md
---

# wsly2006/AINovelStudio

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/wsly2006/ainovelstudio
- **Stars**：1
- **语言**：Python
- **License**：AGPL-3.0
- **Topics**：—
- **GitHub 描述**：Open-source AI writing studio for novelists. One-click book outlines, streaming chapter drafting, AI-suggested titles and synopses, and auto-extraction of characters, items, world settings, and plot threads from your text — keeping your novel consistent across hundreds of chapters.
- **本地描述**：Open-source AI writing studio for novelists. One-click book outlines, streaming chapter drafting, AI-suggested titles and synopses, and auto-extraction of characters, items, world settings, and plot threads from your text — keeping your novel consistent across hundreds of chapters.
- **拉取时间**：2026-07-23 22:39:42
...
更详细的配置说明在 [`backend/app/mcp/README.md`](https://github.com/wsly2006/AINovelStudio/blob/main/backend/app/mcp/README.md)。
...
前端用 [vue-i18n](https://vue-i18n.intlify.dev/) 管文案,右上角内置语言切换器,当前登记的语种在 [`frontend/src/i18n/index.js`](https://github.com/wsly2006/AINovelStudio/blob/main/frontend/src/i18n/index.js) 的 `SUPPORTED_LOCALES`。
...
2. 在 [`frontend/src/i18n/index.js`](https://github.com/wsly2006/AINovelStudio/blob/main/frontend/src/i18n/index.js) `import` 进来,加进 `messages` 和 `SUPPORTED_LOCALES`
3. 在 [`frontend/src/components/LocaleSwitcher.vue`](https://github.com/wsly2006/AINovelStudio/blob/main/frontend/src/components/LocaleSwitcher.vue) 的 `LABELS` 加一条 `'ja-JP': '日本語'`
4. 如果新语种在 Element Plus 也有对应 locale,在 [`frontend/src/App.vue`](https://github.com/wsly2006/AINovelStudio/blob/main/frontend/src/App.vue) 里补一个映射(否则 Element Plus 弹窗/分页文案不会跟着切)
...
- Phase 12:作者声音 + 客观风格信号(工程级语癖 / 风格描述自动注入 prompt;
  文风检查附 6 维统计信号,详见 [docs/author-voice-and-style-signals.md](https://github.com/wsly2006/AINovelStudio/blob/main/docs/author-voice-and-style-signals.md))
...
[AGPL-3.0](https://github.com/wsly2006/AINovelStudio/blob/main/LICENSE)
