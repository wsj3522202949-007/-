...
source: https://github.com/moc67331/easynovelassistant
created: 2026-07-18
updated: 2026-07-18
no: 7427
category: 画龙补充 / 扩容入库 — 补充源
repo: moc67331/easynovelassistant
stars: 0
url: https://github.com/moc67331/easynovelassistant
tier: "C"
...
content_hash: f1761f1133b86cfa
  - methods/QUICK_START.md
---

# moc67331/easynovelassistant

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/moc67331/easynovelassistant
- **Stars**：0
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：軽量で規制も検閲もない日本語ローカル LLM『LightChatAssistant-TypeB』による、簡単なノベル生成アシスタントです。ローカル特権の永続生成 Generate forever で、当たりガチャを積み上げます。
- **本地描述**：easynovelassistant
- **拉取时间**：2026-07-25 19:21:33
...
このリポジトリの内容は以下を除き [MIT License](https://github.com/moc67331/easynovelassistant/blob/main/LICENSE.txt) です。
