...
source: https://github.com/zxmushroom63/textdoper
created: 2026-07-18
updated: 2026-07-18
no: 5033
category: 一、去 AI 味 / Humanizer 库
repo: ZXMushroom63/TextDoper
stars: 3
url: https://github.com/zxmushroom63/textdoper
tier: "B"
...
content_hash: daf692829c3a0d5b
  - methods/改稿润色指令库.md
---

# ZXMushroom63/TextDoper

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/zxmushroom63/textdoper
- **Stars**：3
- **语言**：HTML
- **License**：None
- **Topics**：—
- **GitHub 描述**：Text Doping is an exploit that allows bypassing almost any AI content detector.
- **本地描述**：Text Doping is an exploit that allows bypassing almost any AI content detector.
- **拉取时间**：2026-07-25 18:03:38
