...
source: https://github.com/krishhhhh05/storycraft
created: 2026-07-18
updated: 2026-07-18
no: 1020
category: 二、网文 / 长篇 AI 写作系统 库
repo: Krishhhhh05/StoryCraft
stars: 3
url: https://github.com/krishhhhh05/storycraft
tier: "B"
...
content_hash: 851b804bb6c5057a
  - methods/最强写作方法论_全球最强综合版.md
---

# Krishhhhh05/StoryCraft

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/krishhhhh05/storycraft
- **Stars**：3
- **语言**：Jupyter Notebook
- **License**：None
- **Topics**：—
- **GitHub 描述**：This project combines the power of Large Language Models (LLMs) with state of the art AI image generator to craft stories suitable for young children and audience. 
- **本地描述**：This project combines the power of Large Language Models (LLMs) with state of the art AI image generator to craft stories suitable for young children and audience.
- **拉取时间**：2026-07-23 23:08:45
