...
source: https://github.com/jasonxudeveloper/writer
created: 2026-07-18
updated: 2026-07-18
no: 7327
category: 画龙补充 / 扩容入库 — 补充源
repo: jasonxudeveloper/writer
stars: 6
url: https://github.com/jasonxudeveloper/writer
tier: "B"
...
content_hash: 851bc106da708bb0
  - methods/QUICK_START.md
---

# jasonxudeveloper/writer

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/jasonxudeveloper/writer
- **Stars**：6
- **语言**：TypeScript
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：一个基于 AI 的智能小说生成系统，使用 Neon/Postgres + pgvector 作为数据库，支持长期记忆和语义搜索。
- **本地描述**：writer
- **拉取时间**：2026-07-25 19:17:58
