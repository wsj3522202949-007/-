...
- **v1.0** — Documented **4 humanization methodologies** as reference implementations (translation chain, multi-turn LLM rewriting, detection-guided feedback loop, mixed-engine translation). See [docs/techniques.md](https://github.com/lynote-ai/humanize-text/blob/main/docs/techniques.md).
...
**See [`examples/showcase/`](https://github.com/lynote-ai/humanize-text/blob/main/examples/showcase/) for 5 real samples with full intermediate-step outputs and AI-detection verdicts.**
...
| n8n Workflow | No-code automation users | Import [`n8n/humanize_standard.json`](https://github.com/lynote-ai/humanize-text/blob/main/n8n/humanize_standard.json) |
...
Override the API endpoint with `base_url` in `[llm]`, or via `LLM_BASE_URL` / `LLM_API_KEY` environment variables. Full reference: [docs/configuration.md](https://github.com/lynote-ai/humanize-text/blob/main/docs/configuration.md).
...
Each example shows: original input → Step 1 (中文改写) → Step 2 (日语改写) → Step 3 (一轮翻译) → Step 4 (二轮翻译, final). See [`examples/showcase/`](https://github.com/lynote-ai/humanize-text/blob/main/examples/showcase/) for full traces.
...
- [Standard Pipeline Technical Details](https://github.com/lynote-ai/humanize-text/blob/main/docs/pipeline.md) — v1.5 production pipeline
- [4 Methodologies Reference](https://github.com/lynote-ai/humanize-text/blob/main/docs/techniques.md) — v1.0 underlying methods
- [Configuration Guide](https://github.com/lynote-ai/humanize-text/blob/main/docs/configuration.md)
- [n8n Workflow Guide](https://github.com/lynote-ai/humanize-text/blob/main/docs/n8n-guide.md)
- [Lynote.ai vs Open Source Comparison](https://github.com/lynote-ai/humanize-text/blob/main/docs/lynote-comparison.md)
- [FAQ](https://github.com/lynote-ai/humanize-text/blob/main/docs/faq.md)
...
MIT License. See [LICENSE](https://github.com/lynote-ai/humanize-text/blob/main/LICENSE) for details.
