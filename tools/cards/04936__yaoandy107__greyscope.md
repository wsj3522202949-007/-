...
title: greyscope
summary: 风格微调/文风迁移
source: https://github.com/yaoandy107/greyscope
created: 2026-07-18
updated: 2026-07-18
no: 4936
category: 一、去 AI 味 / Humanizer 库
repo: yaoandy107/greyscope
stars: 0
url: https://github.com/yaoandy107/greyscope
tier: "C"
use_case: "风格微调/文风迁移"
pitfalls:
...
content_hash: a56435de4d2b3a39
  - methods/改稿润色指令库.md
---

# yaoandy107/greyscope

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/yaoandy107/greyscope
- **Stars**：0
- **语言**：Python
- **License**：NOASSERTION
- **Topics**：—
- **GitHub 描述**：AI-text detector that classifies text as human-written, AI-edited, or AI-generated. Qwen3.5-4B LoRA trained on the EditLens dataset.
- **本地描述**：AI-text detector that classifies text as human-written, AI-edited, or AI-generated. Qwen3.5-4B LoRA trained on the EditLens dataset.
- **拉取时间**：2026-07-25 18:00:03
