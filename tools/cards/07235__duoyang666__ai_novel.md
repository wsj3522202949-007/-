...
area: 库
status: active
tags: [提示词, 大纲规划, Svelte, 协议宽松, 本地优先, 中文友好, 本地写作]
title: ai_novel
summary: 搭大纲/分卷/节拍
source: https://github.com/duoyang666/ai_novel
created: 2026-07-18
updated: 2026-07-18
no: 7235
category: 画龙补充 / 扩容入库 — 补充源
repo: duoyang666/ai_novel
stars: 469
url: https://github.com/duoyang666/ai_novel
tier: "S"
use_case: "搭大纲/分卷/节拍"
pitfalls: []
related:
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/duoyang666/ai_novel
- **Stars**：469
- **语言**：Svelte
- **License**：Apache-2.0
- **Topics**：—
...
- ## 2025-06-26
- 半正式版（本次功能全部无限制开放）
- 图片库-添加在线模型生图，本地模型生图（flux模型，sd模型）
- 添加对接多样子程序（duoyang.child，需占用8881端口）用于本地生图服务，和主程序分割
- 添加后台任务（DDNS，剪切版，剪切版自动OCR图片）
- 添加本机信息展示
- 优化若干问题
- ## 2025-05-27
- 半正式版
...
- 小说创作，自定义接口配置，最大输出字数，温度等
- 小说创作，剧情续写添加情绪法，并支持发送正文
- 优化若干问题
- ## 2025-03-16
- 公测版
- 替换AOT编译，体积小于100MB
- 拆分菜单，小说创作，添加拆解章纲，大纲，爽点，支持拆书库，支持自定义范围
- 优化若干问题
- ## 2025-03-06
- 公测版
- 替换AOT编译，体积小于100MB
- AI对话支持按微调数据集格式导出导入，支持万条数据不卡
- AI对话支持R1的推理过程，用户可自定义控制是否发送推理过程
- 添加AI群聊功能，支持自定义角色设定，并内置破甲词
- 创作库，添加小说人设实时生成，可配合AI群聊使用
- 创作库，添加通过记忆续写剧情功能，只提供灵感
- 导出自动检测txt编码
- 优化若干问题
- ## 2025-02-19
- 公测版
...
- 添加各种提示
- 创作库，添加半自动创作流程，生成简介，大纲，章纲，细纲，正文，润色
- 创作库，添加章节列表
- 自定义指令，支持简介，大纲，章纲，细纲命令
- 内置VIP模型，注册账户后，赠送永久额度
- 添加兑换码功能，可以通过兑换码，获取额度和时间
- 提升限制拆书数据上限，可自由控制到6000条
- 优化若干问题
- ## 2025-02-08
- 公测版
- 替换AOT编译，体积小于100MB
...
- 公测版
- 替换AOT编译，体积小于100MB
- 自定义指令，添加“通用”指令，主要用来区分“扩写”，“润写”
- “扩写”，“润写”指令，默认去除代码中写死的前缀“句子-01”
- “知识库”，添加搜索召回测试，优化在线嵌入模型的量化
- “拆书库”，导出添加“只导出摘要”,“只导出情节”，拆书逻辑优化
- “创作库”，添加全局自定义设定，优化布局，添加“是否使用系统角色指令”
- “特殊平台”，添加自定义openai地址，可轮询多Key请求
- “特殊平台”，支持免费的Key，不稳定，需要联系开发者提供。
- ## 2024-12-30
- 内测版
- 替换AOT编译，体积小于100MB
