...
title: AI_MOVIE_TRAILER_GENERATOR
summary: 小说转语音/有声书
source: https://github.com/shivamshekhar8709-sys/ai_movie_trailer_generator
created: 2026-07-18
updated: 2026-07-18
no: 401
category: 二、网文 / 长篇 AI 写作系统 库
repo: shivamshekhar8709-sys/AI_MOVIE_TRAILER_GENERATOR
stars: 1
url: https://github.com/shivamshekhar8709-sys/ai_movie_trailer_generator
tier: "B"
use_case: "小说转语音/有声书"
pitfalls:
...
# shivamshekhar8709-sys/AI_MOVIE_TRAILER_GENERATOR

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/shivamshekhar8709-sys/ai_movie_trailer_generator
- **Stars**：1
- **语言**：None
- **License**：None
- **Topics**：—
- **GitHub 描述**：Echoes of Silence: An AI Movie Trailer Generator This project uses Gemini 2.5 Flash to script a sci-fi multiverse story, Edge-TTS for cinematic narration, and MoviePy for automated video editing with zoom effects. It demonstrates a complete GenAI pipeline from text to a fully rendered cinematic action trailer.
- **本地描述**：Echoes of Silence: An AI Movie Trailer Generator This project uses Gemini 2.5 Flash to script a sci-fi multiverse story, Edge-TTS for cinematic narration, and MoviePy for automated video editing with zoom effects. It demonstrates a complete GenAI pipeline from text to a fully rendered cinematic action trailer.
- **拉取时间**：2026-07-23 22:50:49
