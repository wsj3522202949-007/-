...
source: https://github.com/iamxiatian/mucgec
created: 2026-07-18
updated: 2026-07-18
no: 7310
category: 画龙补充 / 扩容入库 — 补充源
repo: iamxiatian/mucgec
stars: 0
url: https://github.com/iamxiatian/mucgec
tier: "C"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/iamxiatian/mucgec
- **Stars**：0
- **语言**：None
- **License**：Apache-2.0
- **Topics**：—
- **GitHub 描述**：MuCGEC中文纠错数据集及文本纠错SOTA模型开源；Code & Data for our NAACL 2022 Paper "MuCGEC: a Multi-Reference Multi-Source Evaluation Dataset for Chinese Grammatical Error Correction"
- **本地描述**：mucgec
- **拉取时间**：2026-07-25 19:17:24
...
[English](https://github.com/iamxiatian/mucgec/blob/main/README.en.md) | 简体中文
...
针对MuCGEC数据集的相关指标，可以采用我们提供的[ChERRANT](https://github.com/iamxiatian/mucgec/blob/main/scorers/ChERRANT)工具进行指标计算。
...
+ 语言学级别（仅词粒度）：
  + 我们设计了14种主要的语言学错误类型（基本上是根据词性），除拼写错误(SPELL)和词序错误(W)外，还可以根据替换/删除/冗余操作进一步划分，如`形容词冗余错误`可以表示为：R:ADJ
    ...
    ![error types](https://github.com/iamxiatian/mucgec/blob/main/pics/errors.PNG)
