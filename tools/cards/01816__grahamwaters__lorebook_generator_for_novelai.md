...
title: lorebook_generator_for_novelai
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/grahamwaters/lorebook_generator_for_novelai
created: 2026-07-18
updated: 2026-07-18
no: 1816
category: 二、网文 / 长篇 AI 写作系统 库
repo: grahamwaters/lorebook_generator_for_novelai
stars: 27
...
content_hash: 9626f18ffbbde584
  - methods/最强写作方法论_全球最强综合版.md
---

# grahamwaters/lorebook_generator_for_novelai

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/grahamwaters/lorebook_generator_for_novelai
- **Stars**：27
- **语言**：Jupyter Notebook
- **License**：MIT
- **Topics**：author, history, nlp, novelai, research, writing-tool
- **GitHub 描述**：Generates a lorebook for novelai
- **本地描述**：Generates a lorebook for novelai
- **拉取时间**：2026-07-23 23:32:00
...
![banner](https://github.com/grahamwaters/lorebook_generator_for_novelai/blob/main/images/lorebookbanner.png)
</h1>
...
![](https://github.com/grahamwaters/lorebook_generator_for_novelai/blob/main/images/main_concept.png)
...
- Then run the python script [scripts/03_lorebook_from_wiki_withpulls.py](https://github.com/grahamwaters/lorebook_generator_for_novelai/blob/main/scripts/03_lorebook_from_wiki_withpulls.py), and it will generate a lorebook for you. This lorebook will be named `lorebook_generated.lorebook` and will be saved in the `supporting_files` folder.

### Mode 2. Subtopics -> to keywords -> to lorebook
If you're feeling adventurous but not super productive, you can provide one topic (wikipedia page) to the [mode_2](https://github.com/grahamwaters/lorebook_generator_for_novelai/blob/main/scripts/04_get_relevant_subtopics.py) script and it will generate a list of keywords that are relevant to that topic. Then it will generate a lorebook for you based on those keywords. This is a good way to get a quick lorebook for a topic that you don't know much about. It does currently have limitations in that it will provide WAY more information than you may need for a lorebook. So you may need to do some editing to get it to a place where you're happy with it.



![](https://github.com/grahamwaters/lorebook_generator_for_novelai/blob/main/images/greatpyramid.png)
...
## Included Files -
- [year_specific_lorebook.py](https://github.com/grahamwaters/lorebook_generator_for_novelai/blob/main/scripts/01_lorebook_from_year.py)
...
- [Lorebook From Articles](https://github.com/grahamwaters/lorebook_generator_for_novelai/blob/main/scripts/02_lorebook_from_downloaded_wiki_articles.py)
...
- [characters.csv](https://github.com/grahamwaters/lorebook_generator_for_novelai/blob/main/characters.csv)
...
- [place_specific_lorebook.py](https://github.com/grahamwaters/lorebook_generator_for_novelai/blob/main/scripts/02_lorebook_from_place.py) - This script will be used to generate lorebooks from a specific place. We will do this by using the Wikipedia library to search for a place and then using the article text as the lorebook entry.
