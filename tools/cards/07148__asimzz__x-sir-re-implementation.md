...
title: x-sir-re-implementation
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/asimzz/x-sir-re-implementation
created: 2026-07-18
updated: 2026-07-18
no: 7148
category: 画龙补充 / 扩容入库 — 补充源
repo: asimzz/x-sir-re-implementation
stars: 0
url: https://github.com/asimzz/x-sir-re-implementation
tier: "C"
...
content_hash: 5a05e9f95624991b
  - methods/QUICK_START.md
---

# asimzz/x-sir-re-implementation

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/asimzz/x-sir-re-implementation
- **Stars**：0
- **语言**：Python
- **License**：None
- **Topics**：—
- **GitHub 描述**：[ACL 2024] Can Watermarks Survive Translation? On the Cross-lingual Consistency of Text Watermark for Large Language Models
- **本地描述**：x-sir-re-implementation
- **拉取时间**：2026-07-25 19:12:19
...
* You can learn how to extend model and language in [from-scratch.md](https://github.com/asimzz/x-sir-re-implementation/blob/main/from-scratch.md).
