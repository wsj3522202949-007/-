...
source: https://github.com/netlify-templates/gatsby-ecommerce-theme
created: 2026-07-18
updated: 2026-07-18
no: 9579
category: 画龙补充 / 扩容入库 — 补充源
repo: netlify-templates/gatsby-ecommerce-theme
stars: 188
...
content_hash: 2468c28ec784f60e
  - methods/QUICK_START.md
---

# netlify-templates/gatsby-ecommerce-theme

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/netlify-templates/gatsby-ecommerce-theme
- **Stars**：188
- **语言**：JavaScript
- **License**：None
- **Topics**：ecommerce, gatsby, netlify, template
- **GitHub 描述**：A Gatsby-based starter theme with e-commerce styled components
- **本地描述**：gatsby-ecommerce-theme
- **拉取时间**：2026-07-25 20:01:44
...
## Regular Setup
 ...
 ### Cloning + Installing Packages
  ...
  After installing and customizing your new e-commerce theme it's now time to deploy! 
   ...
   It will use the information from the included Netlify configuration file, [`netlify.toml`](https://github.com/netlify-templates/gatsby-ecommerce-theme/blob/main/netlify.toml), to set up the build command as `gatsby build` to create a static project and locate the build project in the `public` directory.
...
You can see it in action under [`src/pages/index.js`](https://github.com/netlify-templates/gatsby-ecommerce-theme/blob/main/src/pages/index.js) or see the component in [`src/components/Hero/Hero.js`](https://github.com/netlify-templates/gatsby-ecommerce-theme/blob/main/src/components/Hero/Hero.js).
