...
source: https://github.com/coreyo-git/emoji-story
created: 2026-07-18
updated: 2026-07-18
no: 1727
category: 二、网文 / 长篇 AI 写作系统 库
repo: Coreyo-git/emoji-story
stars: 1
url: https://github.com/coreyo-git/emoji-story
tier: "B"
...
content_hash: a873cdbe6c02c7d7
  - methods/最强写作方法论_全球最强综合版.md
---

# Coreyo-git/emoji-story

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/coreyo-git/emoji-story
- **Stars**：1
- **语言**：JavaScript
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：An AI based short story generator that uses a key word and three emojis to generate interesting short stoires
- **本地描述**：An AI based short story generator that uses a key word and three emojis to generate interesting short stoires
- **拉取时间**：2026-07-23 23:29:23
...
![Emoji-story-network-diagram](https://github.com/Coreyo-git/emoji-story/blob/main/emoji-story-network-diagram.png)
...
Emoji-Story is licensed under the [MIT License](https://github.com/Coreyo-git/emoji-story/blob/main/LICENSE), which means it's open source and free to use, modify, and distribute.
