...
title: MyNovelAssistant
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/campbellinoz/mynovelassistant
created: 2026-07-18
updated: 2026-07-18
no: 721
category: 二、网文 / 长篇 AI 写作系统 库
repo: campbellinoz/MyNovelAssistant
stars: 0
url: https://github.com/campbellinoz/mynovelassistant
tier: "C"
...
# campbellinoz/MyNovelAssistant

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/campbellinoz/mynovelassistant
- **Stars**：0
- **语言**：TypeScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：Your AI writing companion for crafting compelling novels with professional-grade assistance. Features intelligent project management, character development, plot outlining, and AI-powered writing tools including Literary Editor, Writer Consultant, and Ghostwriter to help authors bring their stories to life. Written by writers for writers.
- **本地描述**：Your AI writing companion for crafting compelling novels with professional-grade assistance. Features intelligent project management, character development, plot outlining, and AI-powered writing tools including Literary Editor, Writer Consultant, and Ghostwriter to help authors bring their stories to life. Written by writers for writers.
- **拉取时间**：2026-07-23 23:00:03
