...
[Roadmap](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/ROADMAP.md) •
[Changelog](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/CHANGELOG.md) •
[Release Notes](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/RELEASE_NOTES.md) •
[Schema Validation](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/SCHEMA_VALIDATION.md)
...
See [docs/GOVERNANCE.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/GOVERNANCE.md) for the artifact contract and
policy checks.
...
Full specification: [docs/HOW_IT_WORKS.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/HOW_IT_WORKS.md) · [docs/MATH_MODELS.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/MATH_MODELS.md)
Agent usage: [docs/AGENT_WORKFLOW.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/AGENT_WORKFLOW.md)
...
**Core behavior**
- [docs/ARCHITECTURE.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/ARCHITECTURE.md)
- [docs/HOW_IT_WORKS.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/HOW_IT_WORKS.md)
- [docs/MATH_MODELS.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/MATH_MODELS.md)
- [docs/PATTERNS.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/PATTERNS.md)

**Verification and operations**
- [docs/CI_CD.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/CI_CD.md)
- [docs/VALIDATION.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/VALIDATION.md)
- [docs/SCHEMA_VALIDATION.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/SCHEMA_VALIDATION.md)
- [docs/DEVELOPMENT.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/DEVELOPMENT.md)
- [ROADMAP.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/ROADMAP.md)

**Calibration and history**
- [docs/SELF_CALIBRATION.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/SELF_CALIBRATION.md)
- [docs/LEDA_CALIBRATION.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/LEDA_CALIBRATION.md)
- [docs/LEDA_TURBO_PROTOCOL_DOGFOODING.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/LEDA_TURBO_PROTOCOL_DOGFOODING.md)
- [docs/HISTORY_TRACKING.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/HISTORY_TRACKING.md)
- [docs/GOVERNANCE.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/GOVERNANCE.md)

**Interfaces**
- [docs/CLI_USAGE.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/CLI_USAGE.md)
- [docs/CONFIGURATION.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/CONFIGURATION.md)
- [docs/CONFIG_EXAMPLES.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/CONFIG_EXAMPLES.md)
- [docs/CLAUDE_CODE_SKILL.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/CLAUDE_CODE_SKILL.md)

---

## What It Detects

**27 patterns across 5 categories.** Full catalog: [docs/PATTERNS.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/PATTERNS.md)
...
Full specification: [docs/MATH_MODELS.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/MATH_MODELS.md)
...
[docs/SELF_CALIBRATION.md →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/SELF_CALIBRATION.md) · [Validation boundary →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/VALIDATION.md)
...
[Skill source →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/claude-skills/slop-detector/SKILL.md) · [Full docs →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/CLAUDE_CODE_SKILL.md)
...
single externally validated latent condition. See [docs/VALIDATION.md](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/VALIDATION.md)
for the current validation boundary.

[LEDA Calibration Docs →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/LEDA_CALIBRATION.md) · [Turbo Protocol →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/LEDA_TURBO_PROTOCOL_DOGFOODING.md)
...
`coherence_level = "vr_structural_approx"`. [docs/ARCHITECTURE.md →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/ARCHITECTURE.md)
...
[Full CI/CD Integration Guide →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/CI_CD.md)
...
[Full Configuration Guide →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/CONFIGURATION.md) · [Config Examples →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/CONFIG_EXAMPLES.md)
...
[Full Release Notes →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/RELEASE_NOTES.md) · [Changelog →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/CHANGELOG.md)
...
[Development Guide →](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/docs/DEVELOPMENT.md)
...
*Chart updated weekly via [GitHub Actions](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/.github/workflows/download-chart.yml). Monthly installs: [pypistats.org](https://pypistats.org/packages/ai-slop-detector) (mirrors excluded). Total: [pepy.tech](https://pepy.tech/project/ai-slop-detector) (incl. mirrors)*

---

## License

MIT — see [LICENSE](https://github.com/flamehaven01/AI-SLOP-Detector/blob/main/LICENSE).
