...
title: GPT-Telegramus
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/f33rni/gpt-telegramus
created: 2026-07-18
updated: 2026-07-18
no: 1553
...
- **链接**：https://github.com/f33rni/gpt-telegramus
- **Stars**：352
- **语言**：Python
- **License**：AGPL-3.0
...
- **GitHub 描述**：💜 The best free Telegram bot for ChatGPT, Microsoft Copilot (aka Bing AI / Sidney / EdgeGPT), Microsoft Copilot Designer (aka BingImageCreator), Gemini and Groq with stream writing, requests with images, multiple languages, admin control, data logging and more!
- **本地描述**：💜 The best free Telegram bot for ChatGPT, Microsoft Copilot (aka Bing AI / Sidney / EdgeGPT), Microsoft Copilot Designer (aka BingImageCreator), Gemini and Groq with stream writing, requests with images, multiple languages, admin control, data logging and more!
- **拉取时间**：2026-07-23 23:24:22

---

# 🤖 GPT-Telegramus v5

| ![GPT-Telegramus logo](https://github.com/F33RNI/GPT-Telegramus/blob/main/logo.png) | <h3>The best free Telegram bot for ChatGPT, Microsoft Copilot (aka Bing AI / Sidney / EdgeGPT), Microsoft Copilot Designer (aka BingImageCreator), Gemini and Groq with stream writing, requests with images, multiple languages, admin control, data logging and more!</h3> |
| -------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
...
![Project banner](https://github.com/F33RNI/GPT-Telegramus/blob/main/banner.png)
...
1. Clone repo or download [`config.json`](https://github.com/F33RNI/GPT-Telegramus/blob/main/config.json) and [`module_configs`](https://github.com/F33RNI/GPT-Telegramus/blob/main/module_configs) and [`langs`](https://github.com/F33RNI/GPT-Telegramus/blob/main/langs)
