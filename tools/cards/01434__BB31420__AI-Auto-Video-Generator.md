...
summary: 小说转语音/有声书
source: https://github.com/bb31420/ai-auto-video-generator
created: 2026-07-18
updated: 2026-07-18
no: 1434
category: 二、网文 / 长篇 AI 写作系统 库
repo: BB31420/AI-Auto-Video-Generator
stars: 223
url: https://github.com/bb31420/ai-auto-video-generator
tier: "S"
use_case: "小说转语音/有声书"
pitfalls:
...
- **链接**：https://github.com/bb31420/ai-auto-video-generator
- **Stars**：223
- **语言**：Python
- **License**：GPL-3.0
- **Topics**：ai, artificial-intelligence, dall-e, editing-videos, openai, openai-api, video, voice
- **GitHub 描述**：An AI-powered storytelling video generator that takes user input as a story prompt, generates a story using OpenAI's GPT-3, creates images using OpenAI's DALL-E, adds voiceover using ElevenLabs API, and combines the elements into a video.
- **本地描述**：An AI-powered storytelling video generator that takes user input as a story prompt, generates a story using OpenAI's GPT-3, creates images using OpenAI's DALL-E, adds voiceover using ElevenLabs API, and combines the elements into a video.
- **拉取时间**：2026-07-23 23:20:55
