...
title: DSR-Research-Flow-Template
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/aaradhya2001/dsr-research-flow-template
created: 2026-07-18
updated: 2026-07-18
no: 866
category: 二、网文 / 长篇 AI 写作系统 库
repo: Aaradhya2001/DSR-Research-Flow-Template
stars: 0
url: https://github.com/aaradhya2001/dsr-research-flow-template
tier: "C"
...
content_hash: b7677f9e250b98eb
  - methods/最强写作方法论_全球最强综合版.md
---

# Aaradhya2001/DSR-Research-Flow-Template

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/aaradhya2001/dsr-research-flow-template
- **Stars**：0
- **语言**：None
- **License**：Apache-2.0
- **Topics**：analysis, automation, collaboration, data-science, documentation, dsr, github-actions, open-source, project-management, reproducibility, research, software-development, template, version-control, workflow
- **GitHub 描述**：📚 Streamline your doctoral research with the DSR Research Flow Template, covering all stages from problem identification to writing.
- **本地描述**：📚 Streamline your doctoral research with the DSR Research Flow Template, covering all stages from problem identification to writing.
- **拉取时间**：2026-07-23 23:04:15
