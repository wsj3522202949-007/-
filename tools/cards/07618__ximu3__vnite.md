...
source: https://github.com/ximu3/vnite
created: 2026-07-18
updated: 2026-07-18
no: 7618
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/ximu3/vnite
- **Stars**：1314
- **语言**：TypeScript
- **License**：GPL-3.0
- **Topics**：electron, galgame, gaming, launcher, react, visual-novel, vnite
- **GitHub 描述**：A unified platform to organize your game collection, track gameplay, with real-time cloud sync across devices and detailed gameplay reports.
- **本地描述**：vnite
- **拉取时间**：2026-07-25 19:27:53
