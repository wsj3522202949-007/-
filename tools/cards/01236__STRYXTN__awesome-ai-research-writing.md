...
area: 库
status: active
tags: [Claude插件, HTML, 协议未明, 需API密钥, 中文友好]
title: awesome-ai-research-writing
summary: Claude Code 插件式写作流
source: https://github.com/stryxtn/awesome-ai-research-writing
created: 2026-07-18
updated: 2026-07-18
no: 1236
category: 二、网文 / 长篇 AI 写作系统 库
repo: STRYXTN/awesome-ai-research-writing
stars: 125
url: https://github.com/stryxtn/awesome-ai-research-writing
tier: "A"
...
# STRYXTN/awesome-ai-research-writing

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/stryxtn/awesome-ai-research-writing
- **Stars**：125
- **语言**：HTML
- **License**：None
- **Topics**：—
- **GitHub 描述**：来自顶尖研究机构的 AI 论文写作 Prompt 模板库与 Agent Skills 集合 ✨
- **本地描述**：来自顶尖研究机构的 AI 论文写作 Prompt 模板库与 Agent Skills 集合 ✨
- **拉取时间**：2026-07-23 23:15:09
...
````
![由上述prompt生成的效果图](https://github.com/STRYXTN/awesome-ai-research-writing/blob/main/images/nano-banana.png)
...
![模型排名](https://github.com/STRYXTN/awesome-ai-research-writing/blob/main/images/model-rank.png)
...
![Skills 配置与触发示意](https://github.com/STRYXTN/awesome-ai-research-writing/blob/main/images/example.png)
