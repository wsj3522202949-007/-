...
title: AIChildrensBookGen
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/krishnaadithya/aichildrensbookgen
created: 2026-07-18
updated: 2026-07-18
no: 953
category: 二、网文 / 长篇 AI 写作系统 库
repo: krishnaadithya/AIChildrensBookGen
stars: 6
url: https://github.com/krishnaadithya/aichildrensbookgen
tier: "B"
...
content_hash: 2ecbf35d97418157
  - methods/最强写作方法论_全球最强综合版.md
---

# krishnaadithya/AIChildrensBookGen

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/krishnaadithya/aichildrensbookgen
- **Stars**：6
- **语言**：Jupyter Notebook
- **License**：NOASSERTION
- **Topics**：book, gen-ai, genai, generator, gradio, llama, seed-story, stable-diffusion, story, storybook
- **GitHub 描述**：Welcome to the future of storytelling with the Curious George Adventure Creator! Dive into the playful and adventurous world of Curious George like never before. Our innovative AI model, designed for children and fans of the lovable monkey, brings George's stories to life with just a starting image and a chosen theme.
- **本地描述**：Welcome to the future of storytelling with the Curious George Adventure Creator! Dive into the playful and adventurous world of Curious George like never before. Our innovative AI model, designed for children and fans of the lovable monkey, brings George's stories to life with just a starting image and a chosen theme.
- **拉取时间**：2026-07-23 23:06:51

---

# Curious George Adventure Creator: AI Children's Book Generator

![Curious George Adventure Creator Logo](https://github.com/krishnaadithya/AIChildrensBookGen/blob/main/assets/logo.png)
...
- [PyTorch >=2.0.1](https://github.com/krishnaadithya/AIChildrensBookGen/tree/main/Recommend%20to%20use%20torch==2.1.2+cu121)(https://pytorch.org/) / (AMD GPU: Recomended torch=2.4.1:rocm6.1)  
- GPU Vram > 40 GB
