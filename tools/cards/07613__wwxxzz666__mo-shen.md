...
source: https://github.com/wwxxzz666/mo-shen
created: 2026-07-18
updated: 2026-07-18
no: 7613
category: 画龙补充 / 扩容入库 — 补充源
repo: wwxxzz666/mo-shen
stars: 5
url: https://github.com/wwxxzz666/mo-shen
tier: "B"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/wwxxzz666/mo-shen
- **Stars**：5
- **语言**：Python
- **License**：MIT
- **Topics**：ai-agent, creative-writing, llm, multi-agent, novel-generation, python
- **GitHub 描述**：多智能体协作小说生成框架，四个专职AI智能体接力完成从创意到成稿的全流程。
- **本地描述**：mo-shen
- **拉取时间**：2026-07-25 19:27:46
...
项目正在**持续迭代**，以下为近期规划（详见 [PRODUCT_ROADMAP.md](https://github.com/wwxxzz666/mo-shen/blob/main/PRODUCT_ROADMAP.md)）：
...
[MIT License](https://github.com/wwxxzz666/mo-shen/blob/main/LICENSE) © 2026 wwxxzz666
