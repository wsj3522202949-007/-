...
title: ShortStoryGenerator
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/ali-zeynali/shortstorygenerator
created: 2026-07-18
updated: 2026-07-18
no: 533
category: 二、网文 / 长篇 AI 写作系统 库
repo: ali-zeynali/ShortStoryGenerator
stars: 2
url: https://github.com/ali-zeynali/shortstorygenerator
tier: "B"
...
content_hash: 99a05a29c200a464
  - methods/最强写作方法论_全球最强综合版.md
---

# ali-zeynali/ShortStoryGenerator

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/ali-zeynali/shortstorygenerator
- **Stars**：2
- **语言**：Jupyter Notebook
- **License**：None
- **Topics**：—
- **GitHub 描述**：AI-Generated short stories using bidirectional LSTM
- **本地描述**：AI-Generated short stories using bidirectional LSTM
- **拉取时间**：2026-07-23 22:54:35
...
![ModelParams](https://github.com/ali-zeynali/ShortStoryGenerator/blob/main/figs/model.png)
...
## Report
Report is available from [ShortStoryGenerator.pdf](https://github.com/ali-zeynali/ShortStoryGenerator/blob/main/ShortStoryGenerator.pdf) file.
## Code
