...
source: https://github.com/keyvez/ace_plus
created: 2026-07-18
updated: 2026-07-18
no: 7356
category: 画龙补充 / 扩容入库 — 补充源
repo: keyvez/ace_plus
stars: 0
url: https://github.com/keyvez/ace_plus
tier: "C"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/keyvez/ace_plus
- **Stars**：0
- **语言**：None
- **License**：None
- **Topics**：—
...
One issue with this approach is that it changes the input channel number of the FLUX-Fill-Dev model from 384 to 448. The specific configuration can be referenced in the [configuration file](https://github.com/keyvez/ace_plus/blob/main/config/ace_plus_fft.yaml).
