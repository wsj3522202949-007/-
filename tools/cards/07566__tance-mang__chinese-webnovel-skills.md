...
area: 库
status: active
tags: [提示词, 大纲规划, Claude插件, Python, 协议宽松, 本地优先, 中文友好, 本地写作]
title: chinese-webnovel-skills
summary: 搭大纲/分卷/节拍
source: https://github.com/tance-mang/chinese-webnovel-skills
created: 2026-07-18
updated: 2026-07-18
no: 7566
category: 画龙补充 / 扩容入库 — 补充源
repo: tance-mang/chinese-webnovel-skills
stars: 8
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/tance-mang/chinese-webnovel-skills
- **Stars**：8
- **语言**：Python
- **License**：MIT
- **Topics**：chatgpt, chinese-fiction, claude-code, claude-code-plugin, claude-code-skills, deepseek, fiction-writing, prompt-engineering, webnovel, writing-assistant
- **GitHub 描述**：中文网文写作工具包 · Chinese web-novel writing toolkit (23 skills) — a Claude Code plugin, also works in ChatGPT / DeepSeek / Gemini
- **本地描述**：chinese-webnovel-skills
- **拉取时间**：2026-07-25 19:25:49
