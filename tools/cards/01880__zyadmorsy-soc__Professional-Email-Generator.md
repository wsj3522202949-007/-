...
summary: 提示词/写作工作流
source: https://github.com/zyadmorsy-soc/professional-email-generator
created: 2026-07-18
updated: 2026-07-18
no: 1880
category: 二、网文 / 长篇 AI 写作系统 库
repo: zyadmorsy-soc/Professional-Email-Generator
stars: 1
url: https://github.com/zyadmorsy-soc/professional-email-generator
tier: "B"
use_case: "提示词/写作工作流"
pitfalls:
...
content_hash: 94cb0e6a2ee35d4d
  - methods/最强写作方法论_全球最强综合版.md
---

# zyadmorsy-soc/Professional-Email-Generator

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/zyadmorsy-soc/professional-email-generator
- **Stars**：1
- **语言**：Python
- **License**：None
- **Topics**：—
- **GitHub 描述**：AI Writing Assistant GUI | Python, Streamlit, Gemini API  • Developed an AI-powered writing assistant with a Streamlit-based GUI for generating  professional emails, CVs, and cover letters.  • Integrated Gemini API to automate text generation using structured prompts.  • Implemented prompt engineering to improve response quality and formatting.
- **本地描述**：AI Writing Assistant GUI （ Python, Streamlit, Gemini API  • Developed an AI-powered writing assistant with a Streamlit-based GUI for generating  professional emails, CVs, and cover letters.  • Integrated Gemini API to automate text generation using structured prompts.  • Implemented prompt engineering to improve response quality and formatting.
- **拉取时间**：2026-07-23 23:33:48
