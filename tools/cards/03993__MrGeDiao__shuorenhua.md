...
area: 库
status: active
tags: [去AI味, Claude插件, Python, 协议宽松, 本地优先, 中文友好, 本地写作]
title: shuorenhua
...
updated: 2026-07-18
no: 3993
category: 十四、文风迁移 / 风格微调模型 库
repo: MrGeDiao/shuorenhua
stars: 794
url: https://github.com/mrgediao/shuorenhua
tier: "S"
...
- **分类**：十四、文风迁移 / 风格微调模型 库
- **链接**：https://github.com/mrgediao/shuorenhua
- **Stars**：794
- **语言**：Python
- **License**：MIT
- **Topics**：agent-skill, ai-writing, anti-slop, chatgpt, chinese, claude-code, codex, cursor, developer-tools, openclaw, prompt, prompt-engineering, rewriting, skill, text-quality, writing
- **GitHub 描述**：说人话｜中文优先的去 AI 味改写 skill：保事实、分场景、改完可直接发。Chinese-first rewrite skill for Codex / Claude Code / Cursor / ChatGPT — removes AI tone, preserves facts.
- **本地描述**：说人话｜中文优先的去 AI 味改写 skill：保事实、分场景、改完可直接发。Chinese-first rewrite skill for Codex / Claude Code / Cursor / ChatGPT — removes AI tone, preserves facts.
- **拉取时间**：2026-07-24 00:02:03
...
装好后在对话里说「把这段去 AI 味」就会命中。手动安装（cp / 软链跟随更新）见 [install/claude-code.md](https://github.com/MrGeDiao/shuorenhua/blob/main/install/claude-code.md)。
...
项目内长期使用建议把 skill 文件拷进项目并在 `AGENTS.md` 写明触发条件，见 [install/codex.md](https://github.com/MrGeDiao/shuorenhua/blob/main/install/codex.md)。
...
2. 划保护片段：数字、版本、命令、路径、报错、引用原文、人名和责任归属先锁住（完整清单见 [references/protected-spans.md](https://github.com/MrGeDiao/shuorenhua/blob/main/references/protected-spans.md)）
...
可发布文本再按「发到哪里」细分，不是换语气，是按发布目的决定改法：README 第一屏要说清这是什么、给谁用；release note 要列清变更、验证和限制；论坛帖像维护者分享观察和取舍，不像公司公告；issue 回复先确认问题和下一步，不做客服式安抚。每个子场景的目标和常见病灶见 [references/scene-packs.md](https://github.com/MrGeDiao/shuorenhua/blob/main/references/scene-packs.md)。
...
三档的取舍过程和模型实跑数据见 [#4](https://github.com/MrGeDiao/shuorenhua/issues/4) 和 [evals/results-v1.8.6.md](https://github.com/MrGeDiao/shuorenhua/blob/main/evals/results-v1.8.6.md)。
...
---|
| Codex | [install/codex.md](https://github.com/MrGeDiao/shuorenhua/blob/main/install/codex.md) |
| Claude Code | [install/claude-code.md](https://github.com/MrGeDiao/shuorenhua/blob/main/install/claude-code.md) |
| Cursor / Windsurf | [install/cursor.md](https://github.com/MrGeDiao/shuorenhua/blob/main/install/cursor.md) |
| OpenClaw | [install/openclaw.md](https://github.com/MrGeDiao/shuorenhua/blob/main/install/openclaw.md) |
| ChatGPT / Custom GPT | [install/chatgpt.md](https://github.com/MrGeDiao/shuorenhua/blob/main/install/chatgpt.md) |
...
如果你遇到“改完还是像 AI”的具体文本，可以用 [bad case 模板](https://github.com/MrGeDiao/shuorenhua/blob/main/.github/ISSUE_TEMPLATE/bad-case.md) 提交。请先脱敏，不要贴未授权私聊全文、密钥、内部链接或真实个人身份信息。也可以直接贴到[征集 issue](https://github.com/MrGeDiao/shuorenhua/issues/5)。

在提交新词之前，先想一件事：

> 这是一个“新模式”，还是只是“现有模式的变体”？

详细规则见 [CONTRIBUTING.md](https://github.com/MrGeDiao/shuorenhua/blob/main/CONTRIBUTING.md)。
...
[MIT](https://github.com/MrGeDiao/shuorenhua/blob/main/LICENSE)
