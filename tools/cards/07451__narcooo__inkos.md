...
area: 库
status: active
tags: [TypeScript, 协议传染, 需API密钥, 中文友好]
title: inkos
...
- **语言**：TypeScript
- **License**：AGPL-3.0
- **Topics**：ai, ai-agent, ai-game, ai-writing, chinese-novel, creative-writing-ai, generative-ai, novel-ai, novel-generation, short-drama, storyboard
- **GitHub 描述**：Story Creation AI Agent for novel, scripts, translation, interactive games, and IP content
- **本地描述**：inkos
- **拉取时间**：2026-07-25 19:22:17
...
**Native English novel writing now supported！** Set `--lang en` to write in English. See [English README](https://github.com/narcooo/inkos/blob/main/README.en.md) for details.
...
[AGPL-3.0](https://github.com/narcooo/inkos/blob/main/LICENSE)
