...
title: layoutsegmentation
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/phyboy/layoutsegmentation
created: 2026-07-18
updated: 2026-07-18
no: 7488
category: 画龙补充 / 扩容入库 — 补充源
repo: phyboy/layoutsegmentation
stars: 0
url: https://github.com/phyboy/layoutsegmentation
tier: "C"
...
content_hash: 277572a3a88b9b4a
  - methods/QUICK_START.md
---

# phyboy/layoutsegmentation

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/phyboy/layoutsegmentation
- **Stars**：0
- **语言**：None
- **License**：None
- **Topics**：—
- **GitHub 描述**：版面划分和字切分
- **本地描述**：layoutsegmentation
- **拉取时间**：2026-07-25 19:23:26
