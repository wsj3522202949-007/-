...
|---|-------|------|----------|-----------|------------------|---------------|
| 1 | [**fool-em-once**](https://github.com/nawagner/fool-em-once/tree/main/studies/01-original/) | Jan 2026 | Pangram 3.0 (3‑way: AI / AI‑assisted / human) | WriteHuman.ai | Gemini 3 Flash, GPT‑5.2 | **89%** |
| 2 | [**fool-em-twice**](https://github.com/nawagner/fool-em-once/tree/main/studies/02-sequel/) | Jul 2026 | **Pangram 3.3.2** (3‑way, improved recall on humanized text) | **Walter Writes** | **Claude (Claude Code), GPT‑5.5 (Codex)** | **40%** |
...
stay independently reproducible. The top-level [`index.html`](https://github.com/nawagner/fool-em-once/blob/main/index.html) links out to both.
