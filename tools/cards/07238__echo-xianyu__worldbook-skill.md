...
title: worldbook-skill
summary: 提示词/写作工作流
source: https://github.com/echo-xianyu/worldbook-skill
created: 2026-07-18
updated: 2026-07-18
no: 7238
category: 画龙补充 / 扩容入库 — 补充源
repo: echo-xianyu/worldbook-skill
stars: 172
...
content_hash: e612b7536b192c37
  - methods/QUICK_START.md
---

# echo-xianyu/worldbook-skill

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/echo-xianyu/worldbook-skill
- **Stars**：172
- **语言**：Python
- **License**：NOASSERTION
- **Topics**：—
- **GitHub 描述**：A skill for Agent to write Worldbook for SillyTavern
- **本地描述**：worldbook-skill
- **拉取时间**：2026-07-25 19:15:08
