...
source: https://github.com/onepointai/onepoint
created: 2026-07-18
updated: 2026-07-18
no: 888
category: 二、网文 / 长篇 AI 写作系统 库
repo: onepointAI/onepoint
stars: 316
...
- **链接**：https://github.com/onepointai/onepoint
- **Stars**：316
- **语言**：TypeScript
- **License**：MIT
- **Topics**：ai, all-in-one, chatgpt, coding, electron, gpt-35-turbo, macos, react, reading, toolkit, webscraper, xiaoai-tts
- **GitHub 描述**：An AI assistant tool that integrates coding, writing, and reading functions. For better alternatives see https://monica.im/desktop
- **本地描述**：An AI assistant tool that integrates coding, writing, and reading functions. For better alternatives see https://monica.im/desktop
- **拉取时间**：2026-07-23 23:04:56
