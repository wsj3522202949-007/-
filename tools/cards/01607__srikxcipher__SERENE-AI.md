...
title: SERENE-AI
summary: 互动叙事/聊天写故事
source: https://github.com/srikxcipher/serene-ai
created: 2026-07-18
updated: 2026-07-18
no: 1607
category: 二、网文 / 长篇 AI 写作系统 库
repo: srikxcipher/SERENE-AI
stars: 7
url: https://github.com/srikxcipher/serene-ai
tier: "B"
use_case: "互动叙事/聊天写故事"
pitfalls: []
related:
...
# srikxcipher/SERENE-AI

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/srikxcipher/serene-ai
- **Stars**：7
- **语言**：Python
- **License**：MIT
- **Topics**：ai-wellness, flask, machine-learning, mental-health, mobile-app, personal-assistant, react-native
- **GitHub 描述**：A powerful AI-driven wellness assistant designed to improve mental and physical health through personalized recommendations, mood-based music, therapeutic writing prompts, and sentiment-aware chat, you’ll have all the tools you need to feel more balanced, energized, and in tune with yourself.
- **本地描述**：A powerful AI-driven wellness assistant designed to improve mental and physical health through personalized recommendations, mood-based music, therapeutic writing prompts, and sentiment-aware chat, you’ll have all the tools you need to feel more balanced, energized, and in tune with yourself.
- **拉取时间**：2026-07-23 23:25:55
