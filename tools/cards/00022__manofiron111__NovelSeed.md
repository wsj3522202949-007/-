...
欢迎 PR！开始前请阅读：
- [CONTRIBUTING.md](https://github.com/manofiron111/NovelSeed/blob/main/CONTRIBUTING.md) — 如何贡献
- [AGENTS.md](https://github.com/manofiron111/NovelSeed/blob/main/AGENTS.md) — AI Agent 编辑本仓库的规则
...
[AGPL-3.0](https://github.com/manofiron111/NovelSeed/blob/main/LICENSE) — 自由使用、修改、分发，但修改后必须以相同许可证开源。
