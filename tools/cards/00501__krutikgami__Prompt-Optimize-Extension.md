...
title: Prompt-Optimize-Extension
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/krutikgami/prompt-optimize-extension
created: 2026-07-18
updated: 2026-07-18
no: 501
category: 二、网文 / 长篇 AI 写作系统 库
repo: krutikgami/Prompt-Optimize-Extension
stars: 0
url: https://github.com/krutikgami/prompt-optimize-extension
tier: "C"
...
# krutikgami/Prompt-Optimize-Extension

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/krutikgami/prompt-optimize-extension
- **Stars**：0
- **语言**：JavaScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：Enhance your writing experience with AI-powered prompt optimization!
- **本地描述**：Enhance your writing experience with AI-powered prompt optimization!
- **拉取时间**：2026-07-23 22:53:40

---

# ✨ ChatGPT Prompt Optimizer – Chrome Extension
