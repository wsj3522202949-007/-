...
- **Code** (`humanizer.jsx`, anything not in `profiles/`): MIT. See [LICENSE](https://github.com/NaeMyoAungKhing/humanizer/blob/main/LICENSE).
- **Voice profiles** (`profiles/*.md`): Creative Commons Attribution-ShareAlike 4.0.
  See [LICENSE-profiles](https://github.com/NaeMyoAungKhing/humanizer/blob/main/LICENSE-profiles).
