...
area: 库
status: active
tags: [Claude插件, 校对, Rust, 协议宽松, 本地优先, 英文文档, 改稿润色, 本地写作]
title: harper
summary: 错别字/语法/风格校对
...
- **GitHub 描述**：Offline, privacy-first grammar checker. Fast, open-source, Rust-powered
- **本地描述**：harper
- **拉取时间**：2026-07-25 19:12:22
