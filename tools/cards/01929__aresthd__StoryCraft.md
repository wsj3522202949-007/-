...
## Preview Project
![Preview StoryCraft](https://github.com/aresthd/StoryCraft/blob/main//docs/preview-storycraft.jpg)
...
## License
The project is licensed under the MIT license - see the [LICENSE](https://github.com/aresthd/StoryCraft/blob/main/LICENSE) file for more details.
