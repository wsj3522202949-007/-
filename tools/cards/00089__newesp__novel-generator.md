...
[English](https://github.com/newesp/novel-generator/blob/main/README.en.md)
...
| 檔案 | 模組 | Phase | 依賴 |
|------|------|------|------|
| [00-book.md](https://github.com/newesp/novel-generator/blob/main/modules/00-book.md) | 書本管理（所有資料根容器） | 1 | — |
| [01-outline.md](https://github.com/newesp/novel-generator/blob/main/modules/01-outline.md) | 大綱生成系統 | 1 | 00, 02, 07, 08 |
| [02-characters.md](https://github.com/newesp/novel-generator/blob/main/modules/02-characters.md) | 角色系統 | 2 | 00, 04 |
| [03-chapters.md](https://github.com/newesp/novel-generator/blob/main/modules/03-chapters.md) | 章節管理器 | 1 | 00, 04, 05, 07 |
| [04-knowledge.md](https://github.com/newesp/novel-generator/blob/main/modules/04-knowledge.md) | 知識管理（Wiki、FTS5、Lint、Graph、問 Wiki） | 2 / 2.5 | 00, 07 |
| [05-versions.md](https://github.com/newesp/novel-generator/blob/main/modules/05-versions.md) | 章節版本管理 | 1 | 00 |
| [06-polish.md](https://github.com/newesp/novel-generator/blob/main/modules/06-polish.md) | 內容潤色器（未實作） | 3 | 00, 08 |
| [07-context-budget.md](https://github.com/newesp/novel-generator/blob/main/modules/07-context-budget.md) | Context Budget Manager（Wiki 摘要 + pick-pages + 摘要品質 ✅） | 1 / 2.5 | 04 |
| [08-llm-adapter.md](https://github.com/newesp/novel-generator/blob/main/modules/08-llm-adapter.md) | LLM 適配層 | 1 / 2 | tech-stack |
| [09-multi-agent.md](https://github.com/newesp/novel-generator/blob/main/modules/09-multi-agent.md) | Multi-Agent 協作引擎（未實作） | 4（選做） | 04, 07 |
| [10-multimedia.md](https://github.com/newesp/novel-generator/blob/main/modules/10-multimedia.md) | 多媒體生成（漫畫圖片、TTS、MP4、SRT、motion effects 與章節內影片庫） | 6 / 4（選做） | 00, tech-stack |
...
| 檔案 | 內容 |
|------|------|
| [tech-stack.md](https://github.com/newesp/novel-generator/blob/main/specs/tech-stack.md) | 技術選型（版本以 `package.json` 為準） |
| [roadmap.md](https://github.com/newesp/novel-generator/blob/main/specs/roadmap.md) | Phase 1–7 開發階段與未完成項 |
| [UI.md](https://github.com/newesp/novel-generator/blob/main/specs/UI.md) | 視覺規範（色彩/字體/元件/動效） |
| [UI-layout.md](https://github.com/newesp/novel-generator/blob/main/specs/UI-layout.md) | 主編輯介面佈局 |
| [output-formats.md](https://github.com/newesp/novel-generator/blob/main/specs/output-formats.md) | 輸出格式規格 |
| [deployment.md](https://github.com/newesp/novel-generator/blob/main/specs/deployment.md) | 部署方式 |
...
詳細狀態以 [specs/roadmap.md](https://github.com/newesp/novel-generator/blob/main/specs/roadmap.md) 為準。

---

## 授權

本專案採用 GNU Affero General Public License v3.0 only（SPDX：`AGPL-3.0-only`）。完整授權摘要見 [LICENSE](https://github.com/newesp/novel-generator/blob/main/LICENSE)。
