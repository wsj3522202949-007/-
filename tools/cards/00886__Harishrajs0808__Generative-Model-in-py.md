...
title: Generative-Model-in-py
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/harishrajs0808/generative-model-in-py
created: 2026-07-18
updated: 2026-07-18
no: 886
category: 二、网文 / 长篇 AI 写作系统 库
repo: Harishrajs0808/Generative-Model-in-py
stars: 0
url: https://github.com/harishrajs0808/generative-model-in-py
tier: "C"
...
content_hash: 28e90f2db7bb1490
  - methods/最强写作方法论_全球最强综合版.md
---

# Harishrajs0808/Generative-Model-in-py

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/harishrajs0808/generative-model-in-py
- **Stars**：0
- **语言**：Python
- **License**：None
- **Topics**：—
- **GitHub 描述**：Creative Writing Assistant Unleash your creativity! A simple yet powerful tool that generates creative writing prompts based on your input using the g4f language model and a user-friendly interface built with Gradio.
- **本地描述**：Creative Writing Assistant Unleash your creativity! A simple yet powerful tool that generates creative writing prompts based on your input using the g4f language model and a user-friendly interface built with Gradio.
- **拉取时间**：2026-07-23 23:04:52
