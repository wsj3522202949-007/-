...
- **License**：Apache-2.0
- **Topics**：—
- **GitHub 描述**：InstantID: Zero-shot Identity-Preserving Generation in Seconds 🔥
- **本地描述**：instantid
- **拉取时间**：2026-07-25 19:17:45
...
If you want to reproduce results in the paper, please refer to the code in [infer_full.py](https://github.com/instantid/instantid/blob/main/infer_full.py). If you want to compare the results with other methods, even without using depth-controlnet, it is recommended that you use this code. 
...
The following code👇 comes from [infer.py](https://github.com/instantid/instantid/blob/main/infer.py). If you want to quickly experience InstantID, please refer to the code in [infer.py](https://github.com/instantid/instantid/blob/main/infer.py). 
