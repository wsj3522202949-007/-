...
title: AI-Prompt-Converter-Pro
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/harsh-trivedi78/ai-prompt-converter-pro
created: 2026-07-18
updated: 2026-07-18
no: 619
category: 二、网文 / 长篇 AI 写作系统 库
repo: Harsh-Trivedi78/AI-Prompt-Converter-Pro
stars: 0
url: https://github.com/harsh-trivedi78/ai-prompt-converter-pro
tier: "C"
...
# Harsh-Trivedi78/AI-Prompt-Converter-Pro

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/harsh-trivedi78/ai-prompt-converter-pro
- **Stars**：0
- **语言**：JavaScript
- **License**：None
- **Topics**：—
- **GitHub 描述**：AI Prompt Converter  ProAI Prompt Converter Pro is a web-based tool that transforms casual user input into professional AI prompts. This tool supports multiple styles of prompts such as ChatGPT-optimized, Midjourney, detailed, professional business, creative writing, and custom templates. 
- **本地描述**：AI Prompt Converter  ProAI Prompt Converter Pro is a web-based tool that transforms casual user input into professional AI prompts. This tool supports multiple styles of prompts such as ChatGPT-optimized, Midjourney, detailed, professional business, creative writing, and custom templates.
- **拉取时间**：2026-07-23 22:57:07
