...
repo: hanmin0822/misakatranslator
stars: 5730
url: https://github.com/hanmin0822/misakatranslator
tier: "S"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/hanmin0822/misakatranslator
- **Stars**：5730
- **语言**：C#
- **License**：GPL-3.0
- **Topics**：comic, csharp, galgame, manga, manga-reader, translate, translator, visual-novel
- **GitHub 描述**：御坂翻译器—Galgame/文字游戏/漫画多语种实时机翻工具
- **本地描述**：misakatranslator
- **拉取时间**：2026-07-25 19:16:41
