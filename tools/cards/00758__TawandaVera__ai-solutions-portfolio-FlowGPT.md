...
area: 库
status: active
tags: [提示词, TTS, 校对, 协议未明, 本地优先, 英文文档, 改稿润色, 本地写作]
title: ai-solutions-portfolio-FlowGPT
summary: 小说转语音/有声书
source: https://github.com/tawandavera/ai-solutions-portfolio-flowgpt
created: 2026-07-18
updated: 2026-07-18
no: 758
category: 二、网文 / 长篇 AI 写作系统 库
repo: TawandaVera/ai-solutions-portfolio-FlowGPT
stars: 1
url: https://github.com/tawandavera/ai-solutions-portfolio-flowgpt
tier: "B"
use_case: "小说转语音/有声书"
pitfalls:
...
# TawandaVera/ai-solutions-portfolio-FlowGPT

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/tawandavera/ai-solutions-portfolio-flowgpt
- **Stars**：1
- **语言**：None
- **License**：None
- **Topics**：—
- **GitHub 描述**：A portfolio showcasing Tawanda Vera's prompt engineering projects, demonstrating the use of AI for research, writing, and data analysis. Projects include ResearchBot, Growth Tracker, Research Data Analyser, SmartDraft, ConfPlanPro, and Refiner GPT.
- **本地描述**：A portfolio showcasing Tawanda Vera's prompt engineering projects, demonstrating the use of AI for research, writing, and data analysis. Projects include ResearchBot, Growth Tracker, Research Data Analyser, SmartDraft, ConfPlanPro, and Refiner GPT.
- **拉取时间**：2026-07-23 23:01:08
