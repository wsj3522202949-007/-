...
area: 库
status: active
tags: [Vue, 协议未明, 需API密钥, 英文文档, 大纲规划, 多Agent, 灵感创意]
title: nativephp-ai-story-generator
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/flowbridge/nativephp-ai-story-generator
created: 2026-07-18
updated: 2026-07-18
no: 894
category: 二、网文 / 长篇 AI 写作系统 库
repo: FlowBridge/nativephp-ai-story-generator
stars: 1
url: https://github.com/flowbridge/nativephp-ai-story-generator
tier: "B"
...
# FlowBridge/nativephp-ai-story-generator

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/flowbridge/nativephp-ai-story-generator
- **Stars**：1
- **语言**：Vue
- **License**：None
- **Topics**：—
- **GitHub 描述**：A project for NativePHP allowing AI story generation and Audio
- **本地描述**：A project for NativePHP allowing AI story generation and Audio
- **拉取时间**：2026-07-23 23:05:07
...
![Demo](https://github.com/FlowBridge/nativephp-ai-story-generator/blob/main//docs/demo.gif)

[View full demo video (With Audio)](https://github.com/FlowBridge/nativephp-ai-story-generator/blob/main/docs/demo.mp4)
