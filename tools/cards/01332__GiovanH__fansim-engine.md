...
source: https://github.com/giovanh/fansim-engine
created: 2026-07-18
updated: 2026-07-18
no: 1332
category: 二、网文 / 长篇 AI 写作系统 库
repo: GiovanH/fansim-engine
stars: 20
url: https://github.com/giovanh/fansim-engine
tier: "B"
...
content_hash: 6f4f5efe31be2081
  - methods/最强写作方法论_全球最强综合版.md
---

# GiovanH/fansim-engine

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/giovanh/fansim-engine
- **Stars**：20
- **语言**：Python
- **License**：None
- **Topics**：—
- **GitHub 描述**：Tools for writing homestuck based visual novels in ren'py
- **本地描述**：Tools for writing homestuck based visual novels in ren'py
- **拉取时间**：2026-07-23 23:17:57
...
Further, packages are better for users: You don't want to force people to download a large, standalone renpy game for every small fanroute (although you are able to distribute a standalone version, see [here.](https://github.com/GiovanH/fansim-engine/blob/main/doc/pqlite.md))
...
**A:** Great! See the [Developer Quickstart](https://github.com/GiovanH/fansim-engine/blob/main/doc/developer_quickstart.md)
...
**A:** Yes, but this is not recommended. Use `dist_standalone.py`. [Read this document for more details.](https://github.com/GiovanH/fansim-engine/blob/main/doc/pqlite.md)
