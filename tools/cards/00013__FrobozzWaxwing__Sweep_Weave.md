...
area: 库
status: active
tags: [互动叙事, GDScript, 协议宽松, 本地优先, 英文文档, 本地写作]
title: Sweep_Weave
summary: 互动叙事/聊天写故事
source: https://github.com/frobozzwaxwing/sweep_weave
created: 2026-07-18
updated: 2026-07-18
no: 13
category: 二、网文 / 长篇 AI 写作系统 库
repo: FrobozzWaxwing/Sweep_Weave
stars: 7
url: https://github.com/frobozzwaxwing/sweep_weave
tier: "B"
use_case: "互动叙事/聊天写故事"
pitfalls: []
related:
...
# FrobozzWaxwing/Sweep_Weave

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/frobozzwaxwing/sweep_weave
- **Stars**：7
- **语言**：GDScript
- **License**：MIT
- **Topics**：computer-games, game-development, game-engine, godot, hypertext, interactive-fiction, interactive-storytelling, storylets, text-adventure
- **GitHub 描述**：SweepWeave is a tool for authoring interactive storyworlds, or works of interactive fiction wherein character interaction is a central game mechanic.
- **本地描述**：SweepWeave is a tool for authoring interactive storyworlds, or works of interactive fiction wherein character interaction is a central game mechanic.
- **拉取时间**：2026-07-23 22:39:14
