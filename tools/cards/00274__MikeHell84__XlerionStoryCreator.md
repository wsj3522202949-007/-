...
title: XlerionStoryCreator
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/mikehell84/xlerionstorycreator
created: 2026-07-18
updated: 2026-07-18
no: 274
category: 二、网文 / 长篇 AI 写作系统 库
repo: MikeHell84/XlerionStoryCreator
stars: 1
url: https://github.com/mikehell84/xlerionstorycreator
tier: "B"
...
# MikeHell84/XlerionStoryCreator

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/mikehell84/xlerionstorycreator
- **Stars**：1
- **语言**：HTML
- **License**：None
- **Topics**：—
- **GitHub 描述**：Xlerion Story Creator is a modular storytelling tool for designing characters, worlds and interactive plots with mythological and emotional depth. Ideal for self-taught and emerging studios, it allows to document and scale stories in a self-sufficient, professional and adaptable way to any engine.
- **本地描述**：Xlerion Story Creator is a modular storytelling tool for designing characters, worlds and interactive plots with mythological and emotional depth. Ideal for self-taught and emerging studios, it allows to document and scale stories in a self-sufficient, professional and adaptable way to any engine.
- **拉取时间**：2026-07-23 22:47:04
