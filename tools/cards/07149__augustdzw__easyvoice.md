...
area: 库
status: active
tags: [TTS, 协议未明, 需API密钥, 中文友好]
title: easyvoice
summary: 小说转语音/有声书
source: https://github.com/augustdzw/easyvoice
created: 2026-07-18
updated: 2026-07-18
no: 7149
category: 画龙补充 / 扩容入库 — 补充源
repo: augustdzw/easyvoice
stars: 0
url: https://github.com/augustdzw/easyvoice
tier: "C"
use_case: "小说转语音/有声书"
pitfalls:
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/augustdzw/easyvoice
- **Stars**：0
- **语言**：None
- **License**：None
- **Topics**：—
...
![Home](https://github.com/augustdzw/easyvoice/blob/main/images/readme.home.jpg)
![Generate](https://github.com/augustdzw/easyvoice/blob/main/images/readme.generate.jpg)
...
- text: 你需要转语音的文字。
- voice: 你需要用到的声音，参考：[支持的声音列表](https://github.com/augustdzw/easyvoice/blob/main/packages/backend/src/llm/prompt/voiceList.json)
