...
title: AI-Detector
summary: 风格微调/文风迁移
source: https://github.com/revanthkrishnamg/ai-detector
created: 2026-07-18
updated: 2026-07-18
no: 5722
category: 一、去 AI 味 / Humanizer 库
repo: revanthkrishnamg/AI-Detector
stars: 1
url: https://github.com/revanthkrishnamg/ai-detector
tier: "B"
use_case: "风格微调/文风迁移"
pitfalls:
...
content_hash: 432d542bb7c7af87
  - methods/改稿润色指令库.md
---

# revanthkrishnamg/AI-Detector

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/revanthkrishnamg/ai-detector
- **Stars**：1
- **语言**：Jupyter Notebook
- **License**：None
- **Topics**：—
- **GitHub 描述**：The AI-Detector project is designed to differentiate between AI-generated and human-written texts, addressing the challenges posed by advanced text-generating AI models in fields like academic integrity, content verification, and information quality. 
- **本地描述**：The AI-Detector project is designed to differentiate between AI-generated and human-written texts, addressing the challenges posed by advanced text-generating AI models in fields like academic integrity, content verification, and information quality.
- **拉取时间**：2026-07-25 18:29:12
