...
title: The-Crucible-Writing-System-For-Claude
summary: 从灵感→大纲→正文的全流程写作辅助（搭框架/续写/多Agent生产）
source: https://github.com/forsonny/the-crucible-writing-system-for-claude
created: 2026-07-18
updated: 2026-07-18
no: 2
category: 二、网文 / 长篇 AI 写作系统 库
repo: forsonny/The-Crucible-Writing-System-For-Claude
stars: 56
...
- **链接**：https://github.com/forsonny/the-crucible-writing-system-for-claude
- **Stars**：56
- **语言**：Python
- **License**：MIT
- **Topics**：—
- **GitHub 描述**：The Crucible Writing System is an integrated suite of three Claude skills designed to guide writers from initial story concept to completed first draft. Built around the Crucible Structure—a 36-beat narrative framework with three interwoven story strands.
- **本地描述**：The Crucible Writing System is an integrated suite of three Claude skills designed to guide writers from initial story concept to completed first draft. Built around the Crucible Structure—a 36-beat narrative framework with three interwoven story strands.
- **拉取时间**：2026-07-23 22:38:55
...
|----------|-------------|
| [Introduction](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/The-Crucible-Structure/00-introduction.md) | Overview and philosophy |
| [Quick Start](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/The-Crucible-Structure/01-quick-start.md) | Five-minute overview |
| [Tutorial Walkthrough](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/The-Crucible-Structure/13-tutorial-walkthrough.md) | Step-by-step planning guide |
| [Visual Diagrams](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/The-Crucible-Structure/15-visual-diagrams.md) | ASCII diagrams of the structure |
| [FAQ & Troubleshooting](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/The-Crucible-Structure/14-faq-and-troubleshooting.md) | Common questions and solutions |

**Core Concepts:**
- [The Three Strands](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/The-Crucible-Structure/02-the-three-strands.md) - Quest, Fire, Constellation
- [The 36 Beats](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/The-Crucible-Structure/03-the-36-beats.md) - Complete beat breakdown
- [Forge Points](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/The-Crucible-Structure/05-forge-points.md) - The five crisis moments
...
MIT License - See [LICENSE](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/LICENSE) for details.
...
- **Changelog**: See [CHANGELOG.md](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/CHANGELOG.md) for version history
...
*Version 1.0.18 -- [Changelog](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/CHANGELOG.md) -- [License](https://github.com/forsonny/The-Crucible-Writing-System-For-Claude/blob/main/LICENSE)*
