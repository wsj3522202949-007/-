...
summary: 搭大纲/分卷/节拍
source: https://github.com/lewis1996/long-novel-gpt
created: 2026-07-18
updated: 2026-07-18
no: 7380
category: 画龙补充 / 扩容入库 — 补充源
repo: lewis1996/long-novel-gpt
stars: 0
url: https://github.com/lewis1996/long-novel-gpt
tier: "C"
use_case: "搭大纲/分卷/节拍"
pitfalls:
...
# lewis1996/long-novel-gpt

- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/lewis1996/long-novel-gpt
- **Stars**：0
- **语言**：None
- **License**：None
- **Topics**：—
...
下载或复制[.env.example](https://github.com/lewis1996/long-novel-gpt/tree/main/.env.example)文件，将其放在你的任意一个目录下，将其改名为 **.env**, 并根据文件中提示填写API设置。
...
第二，将本地的大模型服务暴露为OpenAI格式接口，在[.env.example](https://github.com/lewis1996/long-novel-gpt/tree/main/.env.example)文件中进行配置，同时GPT_BASE_URL中localhost或127.0.0.1需要替换为：**host.docker.internal**
例如
```
...
在2.1版本中，你需要部署在本地并采用自己的API-Key，在[.env.example](https://github.com/lewis1996/long-novel-gpt/tree/main/.env.example)文件中配置生成时采用的最大线程数。
```
