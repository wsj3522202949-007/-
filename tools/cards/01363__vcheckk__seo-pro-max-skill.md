...
Full protocol and all 23 surfaces: [`SKILL.md`](https://github.com/vcheckk/seo-pro-max-skill/blob/main/SKILL.md).

## Supported platforms

| Platform              | File                                                                                       |
|-----------------------|--------------------------------------------------------------------------------------------|
| Claude Code           | [`platforms/claude-code/seo-pro-max/SKILL.md`](https://github.com/vcheckk/seo-pro-max-skill/blob/main/platforms/claude-code/seo-pro-max/SKILL.md) |
| Cursor                | [`platforms/cursor/seo-pro-max.mdc`](https://github.com/vcheckk/seo-pro-max-skill/tree/main/platforms/cursor/seo-pro-max.mdc)                     |
| Windsurf              | [`platforms/windsurf/.windsurfrules`](https://github.com/vcheckk/seo-pro-max-skill/blob/main/platforms/windsurf/.windsurfrules) (short form)      |
| Cline                 | [`platforms/cline/.clinerules`](https://github.com/vcheckk/seo-pro-max-skill/blob/main/platforms/cline/.clinerules)                               |
| Roo Code              | [`platforms/roo/.roo/rules/seo-pro-max.md`](https://github.com/vcheckk/seo-pro-max-skill/blob/main/platforms/roo/.roo/rules/seo-pro-max.md)       |
| GitHub Copilot Chat   | [`platforms/copilot/.github/copilot-instructions.md`](https://github.com/vcheckk/seo-pro-max-skill/blob/main/platforms/copilot/.github/copilot-instructions.md) |
| Aider                 | [`platforms/aider/CONVENTIONS.md`](https://github.com/vcheckk/seo-pro-max-skill/blob/main/platforms/aider/CONVENTIONS.md)                         |
| Continue.dev          | [`platforms/continue/config-snippet.json`](https://github.com/vcheckk/seo-pro-max-skill/blob/main/platforms/continue/config-snippet.json)         |
| Zed AI                | [`platforms/zed/settings-snippet.json`](https://github.com/vcheckk/seo-pro-max-skill/blob/main/platforms/zed/settings-snippet.json)               |
| Plain LLM / Custom GPT| [`platforms/plain-llm/system-prompt.md`](https://github.com/vcheckk/seo-pro-max-skill/blob/main/platforms/plain-llm/system-prompt.md)             |

All platform files are auto-generated from [`SKILL.md`](https://github.com/vcheckk/seo-pro-max-skill/blob/main/SKILL.md) by [`scripts/build-platforms.mjs`](https://github.com/vcheckk/seo-pro-max-skill/tree/main/scripts/build-platforms.mjs). Edit `SKILL.md` only.
...
Edit `SKILL.md`, run `node scripts/build-platforms.mjs`, open a PR. See [CONTRIBUTING.md](https://github.com/vcheckk/seo-pro-max-skill/blob/main/CONTRIBUTING.md).
...
See [CONTRIBUTING.md](https://github.com/vcheckk/seo-pro-max-skill/blob/main/CONTRIBUTING.md). Short version: edit `SKILL.md` (the single source of truth), regenerate platform files with `node scripts/build-platforms.mjs`, open a PR. Framework corrections, Google / Bing policy updates, and new Schema.org types are especially welcome.
...
MIT — see [LICENSE](https://github.com/vcheckk/seo-pro-max-skill/blob/main/LICENSE).
