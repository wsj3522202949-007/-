...
![Novel Architect](https://github.com/zhougz520/novel-architect/blob/main/docs/assets/novel-architect-hero.png)
...
English | [简体中文](https://github.com/zhougz520/novel-architect/blob/main/README.zh-CN.md)
...
See [Production Validation](https://github.com/zhougz520/novel-architect/blob/main/docs/case-studies/production-validation.md) for the public case-study notes.
...
More examples: [Prompt Recipes](https://github.com/zhougz520/novel-architect/blob/main/docs/guides/prompt-recipes.md).

## 🧭 Typical Workflows

| Scenario | Start here | Main docs |
|---|---|---|
| First-time setup | Install the skill and create a test project | [Getting Started](https://github.com/zhougz520/novel-architect/blob/main/docs/guides/getting-started.md) |
| New book | Market pack, character voices, first-ten retention, first-three trial production | [New Book Workflow](https://github.com/zhougz520/novel-architect/blob/main/docs/guides/new-book-workflow.md) |
| Continue writing | prepare -> beat -> write -> review -> repair -> commit | [Chapter Workflow](https://github.com/zhougz520/novel-architect/blob/main/docs/guides/chapter-workflow.md) |
| First three chapters fail | first3 review, review hash, score requirements, entry rewrite | [First 3 and First 10](https://github.com/zhougz520/novel-architect/blob/main/docs/guides/first3-first10.md) |
| Chapter gate fails | Read gate/repair output, revise, rerun signals | [Repair and Feedback](https://github.com/zhougz520/novel-architect/blob/main/docs/guides/repair-feedback.md) |
| Migrate old projects | Move from `volumes.json + gen-prompt` to the agent workflow | [Migration Guide](https://github.com/zhougz520/novel-architect/blob/main/docs/guides/migration-from-gen-prompt.md) |
| Contribute | Environment, tests, release, documentation sync | [Development Guide](https://github.com/zhougz520/novel-architect/blob/main/docs/development/README.md) |
...
See [Signals and Gates](https://github.com/zhougz520/novel-architect/blob/main/docs/reference/signals-and-gates.md).
...
Documentation index: [docs/README.md](https://github.com/zhougz520/novel-architect/blob/main/docs/README.md).

- Users: start with [Getting Started](https://github.com/zhougz520/novel-architect/blob/main/docs/guides/getting-started.md).
- Existing projects: see [Migration from gen-prompt](https://github.com/zhougz520/novel-architect/blob/main/docs/guides/migration-from-gen-prompt.md).
- Contributors: see [Development Guide](https://github.com/zhougz520/novel-architect/blob/main/docs/development/README.md), [CONTRIBUTING.md](https://github.com/zhougz520/novel-architect/blob/main/CONTRIBUTING.md), and [AGENTS.md](https://github.com/zhougz520/novel-architect/blob/main/AGENTS.md).
- Architecture: see [System Architecture](https://github.com/zhougz520/novel-architect/blob/main/docs/architecture/README.md).
- CLI/files/signals: see [Reference](https://github.com/zhougz520/novel-architect/blob/main/docs/reference/cli.md).
- Marketplace listing draft: see [Skill Listing](https://github.com/zhougz520/novel-architect/blob/main/docs/marketplace/skill-listing.md).

## 🤝 Contributing

Read [CONTRIBUTING.md](https://github.com/zhougz520/novel-architect/blob/main/CONTRIBUTING.md) before opening an issue or pull request.
...
Novel Architect is licensed under the [Apache License 2.0](https://github.com/zhougz520/novel-architect/blob/main/LICENSE).
