...
area: 库
status: active
tags: [Claude插件, Vim Script, 协议宽松, 本地优先, 英文文档, 本地写作]
title: llama.vim
...
- **语言**：Vim Script
- **License**：MIT
- **Topics**：copilot, developer-tool, llama, llm, vim, vim-plugin
- **GitHub 描述**：Vim plugin for LLM-assisted code/text completion
- **本地描述**：llama.vim
- **拉取时间**：2026-07-25 19:16:06
