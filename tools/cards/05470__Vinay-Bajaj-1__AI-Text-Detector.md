...
source: https://github.com/vinay-bajaj-1/ai-text-detector
created: 2026-07-18
updated: 2026-07-18
no: 5470
category: 一、去 AI 味 / Humanizer 库
repo: Vinay-Bajaj-1/AI-Text-Detector
stars: 0
url: https://github.com/vinay-bajaj-1/ai-text-detector
tier: "C"
...
# Vinay-Bajaj-1/AI-Text-Detector

- **分类**：一、去 AI 味 / Humanizer 库
- **链接**：https://github.com/vinay-bajaj-1/ai-text-detector
- **Stars**：0
- **语言**：Jupyter Notebook
- **License**：None
- **Topics**：—
- **GitHub 描述**：Checks whether the essay written by students is AI generated or self written
- **本地描述**：Checks whether the essay written by students is AI generated or self written
- **拉取时间**：2026-07-25 18:19:53
