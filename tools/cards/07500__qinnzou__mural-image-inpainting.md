...
title: mural-image-inpainting
summary: 上述两类主题的补充源，按子主题二次筛选
source: https://github.com/qinnzou/mural-image-inpainting
created: 2026-07-18
updated: 2026-07-18
no: 7500
category: 画龙补充 / 扩容入库 — 补充源
repo: qinnzou/mural-image-inpainting
stars: 84
url: https://github.com/qinnzou/mural-image-inpainting
tier: "A"
...
- **分类**：画龙补充 / 扩容入库 — 补充源
- **链接**：https://github.com/qinnzou/mural-image-inpainting
- **Stars**：84
- **语言**：Python
- **License**：None
- **Topics**：cnn, deep-learning, deep-neural-networks, dunhuang, edge-connect, edge-detection, edge-guided, gan, image-inpainting, line-detection, line-drawing, mural, mural-damage, mural-inpainting, mural-repair, murals, painting, paintings, structure-guided, style-transfer
- **GitHub 描述**：Mural image inpainting, Mural damage repair, Line drawing guided image inpainting
- **本地描述**：mural-image-inpainting
- **拉取时间**：2026-07-25 19:23:46
