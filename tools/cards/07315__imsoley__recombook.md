...
The dataset contains 278858 users, 1149780 ratings and 271360 books. It might take some time to load the search bar as it is using a large dataset _(it sits on my economic server)_. All the trained models are saved in the [`models`](https://github.com/imsoley/recombook/blob/main/model/) folder. The [`data`](https://github.com/imsoley/recombook/blob/main/data/) folder contains the dataset and the [`recommender.ipynb`](https://github.com/imsoley/recombook/blob/main/recommender.ipynb)  Jupyter notebooks used for data exploration and visualization.
