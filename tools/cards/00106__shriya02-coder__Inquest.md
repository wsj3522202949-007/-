...
source: https://github.com/shriya02-coder/inquest
created: 2026-07-18
updated: 2026-07-18
no: 106
category: 二、网文 / 长篇 AI 写作系统 库
repo: shriya02-coder/Inquest
stars: 0
url: https://github.com/shriya02-coder/inquest
tier: "C"
...
content_hash: aca51fcde9b9591e
  - methods/最强写作方法论_全球最强综合版.md
---

# shriya02-coder/Inquest

- **分类**：二、网文 / 长篇 AI 写作系统 库
- **链接**：https://github.com/shriya02-coder/inquest
- **Stars**：0
- **语言**：CSS
- **License**：None
- **Topics**：assistant, research, women
- **GitHub 描述**：A research assistant catering to the unique challenges faced by women in academia by providing comprehensive tools for literature search, reference management, collaborative writing, and task management.
- **本地描述**：A research assistant catering to the unique challenges faced by women in academia by providing comprehensive tools for literature search, reference management, collaborative writing, and task management.
- **拉取时间**：2026-07-23 22:42:04
