...
title: QuakeAI
summary: 小说转语音/有声书
source: https://github.com/tyemalshara/quakeai
created: 2026-07-18
updated: 2026-07-18
no: 781
category: 二、网文 / 长篇 AI 写作系统 库
repo: tyemalshara/QuakeAI
stars: 11
url: https://github.com/tyemalshara/quakeai
tier: "B"
use_case: "小说转语音/有声书"
pitfalls:
...
- **链接**：https://github.com/tyemalshara/quakeai
- **Stars**：11
- **语言**：Python
- **License**：None
- **Topics**：audiocraft, elevenlabs, llama2, moviepy-library, streamlit
- **GitHub 描述**：QuakeAI is an Audiobook Generator (made for the Llama2 Hackathon hosted by Lablab.ai) that enables Authors, Writers and live Streamers/Broadcasters to generate Spoken stories with AI generated background music that brings life to it
- **本地描述**：QuakeAI is an Audiobook Generator (made for the Llama2 Hackathon hosted by Lablab.ai) that enables Authors, Writers and live Streamers/Broadcasters to generate Spoken stories with AI generated background music that brings life to it
- **拉取时间**：2026-07-23 23:01:48
