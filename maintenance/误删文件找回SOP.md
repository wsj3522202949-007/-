...
# 示例：
git checkout -- projects/（已删除项目）/chapters/第011章.md

# 3. 或恢复所有未提交的更改
git checkout .

# 4. 验证恢复
dir projects\（已删除项目）\chapters\第011章.md
```
...
# 2. 查看文件历史（找到删除前的最后版本）
git log --all --full-history -- projects/（已删除项目）/chapters/第011章.md
...
# 3. 恢复文件到指定版本
git checkout e4f5g6h -- projects/（已删除项目）/chapters/第011章.md

# 4. 验证恢复
dir projects\（已删除项目）\chapters\第011章.md

# 5. 提交恢复
git add projects/（已删除项目）/chapters/第011章.md
...
# 示例：
git checkout HEAD -- projects/（已删除项目）/chapters/第011章.md
