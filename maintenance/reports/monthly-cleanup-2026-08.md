...
8. `references\原始来源包\oh-story-claudecode-main\oh-story-claudecode-main\skills\story-long-analyze\references\output-templates.md`
   - 原因: 文件名包含关键词: temp
   - 建议: 考虑删除或重命名

9. `references\原始来源包\oh-story-claudecode-main\oh-story-claudecode-main\skills\story-short-analyze\references\output-templates.md`
   - 原因: 文件名包含关键词: temp
   - 建议: 考虑删除或重命名

10. `references\原始来源包\shuorenhua-main\shuorenhua-main\CLAUDE.md`
   - 原因: 文件过小 (9 字节)
   - 建议: 考虑删除

11. `tools\cards\00036__sudesrcyr__Avansas-Automation-Test.md`
   - 原因: 文件名包含关键词: test
   - 建议: 考虑删除或重命名

12. `tools\cards\00054__ShakhawatHassan__E-Commerce_Website_Testing.md`
   - 原因: 文件名包含关键词: test
   - 建议: 考虑删除或重命名

13. `tools\cards\00082__cvk__nacelle-drafter.md`
   - 原因: 文件名包含关键词: draft
   - 建议: 考虑删除或重命名

14. `tools\cards\00111__Vivek-9129__QUICK_DRAFT.md`
   - 原因: 文件名包含关键词: draft
   - 建议: 考虑删除或重命名

15. `tools\cards\00119__mabalderramav__python-auto-test.md`
   - 原因: 文件名包含关键词: test
   - 建议: 考虑删除或重命名

16. `tools\cards\00129__alexandreroman__temporal-bedtime-agent.md`
   - 原因: 文件名包含关键词: temp
   - 建议: 考虑删除或重命名

17. `tools\cards\00193__hanu-tayal__linkedin-draft-publish-workflow.md`
   - 原因: 文件名包含关键词: draft
   - 建议: 考虑删除或重命名

18. `tools\cards\00214__tejasveesaini__rag-AI-eval-testcase-generator.md`
   - 原因: 文件名包含关键词: test
   - 建议: 考虑删除或重命名

19. `tools\cards\00232__Manesshakumar__AITestCodeGenerator.md`
   - 原因: 文件名包含关键词: test
   - 建议: 考虑删除或重命名

20. `tools\cards\00294__wgwtest__Novel-writing-tools.md`
   - 原因: 文件名包含关键词: test
   - 建议: 考虑删除或重命名
...
1. `goals\daily\TEMPLATE.md` - 文件名包含关键词: temp
2. `goals\monthly\TEMPLATE.md` - 文件名包含关键词: temp
3. `goals\weekly\TEMPLATE.md` - 文件名包含关键词: temp
4. `goals\yearly\TEMPLATE.md` - 文件名包含关键词: temp
5. `references\原始来源包\nuwa-skill-main\nuwa-skill-main\references\skill-template.md` - 文件名包含关键词: temp
6. `references\原始来源包\oh-story-claudecode-main\oh-story-claudecode-main\skills\story-long-analyze\references\output-templates.md` - 文件名包含关键词: temp
7. `references\原始来源包\oh-story-claudecode-main\oh-story-claudecode-main\skills\story-short-analyze\references\output-templates.md` - 文件名包含关键词: temp
8. `tools\cards\00129__alexandreroman__temporal-bedtime-agent.md` - 文件名包含关键词: temp
9. `tools\cards\00678__hottweelz__writing-template-for-ai.md` - 文件名包含关键词: temp
10. `tools\cards\00743__Grow-Online-Digital__awesome-aipromptlibrary-templates.md` - 文件名包含关键词: temp
